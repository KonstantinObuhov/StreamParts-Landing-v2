...
var M=/([\0-\x1f\x7f]|^-?\d)|^-$|[^\x80-\uFFFF\w-]/g;function O(e,t){return t?// U+0000 NULL becomes U+FFFD REPLACEMENT CHARACTER
"\x00"===e?"�":e.slice(0,-1)+"\\"+e.charCodeAt(e.length-1).toString(16)+" ":"\\"+e}T.escapeSelector=function(e){return(e+"").replace(M,O)},function(){var t,n,r,s,c,u,p,h,g,m,y=a,b=T.expando,w=0,S=0,x=et(),E=et(),M=et(),O=et(),P=function(e,t){return e===t&&(c=!0),0},j="checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",// https://www.w3.org/TR/css-syntax-3/#ident-token-diagram
...
needsContext:RegExp("^"+k+"*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\("+k+"*((?:-\\d)?\\d*)"+k+"*\\)|)(?=[^-]|$)","i")},U=/^(?:input|select|textarea|button)$/i,V=/^h\d$/i,X=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,Y=/[+~]/,// https://www.w3.org/TR/CSS21/syndata.html#escaped-characters
...
(c=ec(e)).length;o--;)c[o]=(a?"#"+a:":scope")+" "+eu(c[o]);d=c.join(",")}try{return y.apply(n,p.querySelectorAll(d)),n}catch(t){O(e,!0)}finally{a===b&&t.removeAttribute("id")}}}// All others
...
for(t in ee.matches=function(e,t){return ee(e,null,null,t)},ee.matchesSelector=function(e,t){if(ea(e),h&&!O[t+" "]&&(!g||!g.test(t)))try{var n=m.call(e,t);// IE 9's matchesSelector returns false on disconnected nodes
if(n||f.disconnectedMatch||// As well, disconnected nodes are said to be in a document
// fragment in IE 9
e.document&&11!==e.document.nodeType)return n}catch(e){O(t,!0)}return ee(t,u,null,[e]).length>0},ee.contains=function(e,t){return(e.ownerDocument||e)!=u&&ea(e),T.contains(e,t)},ee.attr=function(e,t){// Set document vars if needed
// Support: IE 11+, Edge 17 - 18+
// IE/Edge sometimes throw a "Permission denied" error when strict-comparing
// two documents; shallow comparisons work.
// eslint-disable-next-line eqeqeq
...
(p=M(e,(i=c.length>0,o=d.length>0,s=function(e,t,s,a,l){var p,f,g,m=0,v="0",b=e&&[],S=[],x=r,E=e||o&&n.find.TAG("*",l),C=w+=null==x?1:Math.random()||.1,L=E.length;// Add elements passing elementMatchers directly to results
...
for(o=0;o<s;o++)null!=r[o]&&(e[o].style.display=r[o]);return e}T.fn.extend({show:function(){return ey(this,!0)},hide:function(){return ey(this)},toggle:function(e){return"boolean"==typeof e?e?this.show():this.hide():this.each(function(){eg(this)?T(this).show():T(this).hide()})}});var eb=/^(?:checkbox|radio)$/i,ew=/<([a-z][^\/\0>\x20\t\r\n\f]*)/i,eS=/^$|^module$|\/(?:java|ecma)script/i;e9=v.createDocumentFragment().appendChild(v.createElement("div")),// Support: Android 4.0 - 4.3 only
// Check state lost if the name is set (trac-11217)
// Support: Windows Web Apps (WWA)
// `name` and `type` must use .setAttribute for WWA (trac-14901)
(e6=v.createElement("input")).setAttribute("type","radio"),e6.setAttribute("checked","checked"),e6.setAttribute("name","t"),e9.appendChild(e6),// Support: Android <=4.1 only
// Older WebKit doesn't clone checked state correctly in fragments
f.checkClone=e9.cloneNode(!0).cloneNode(!0).lastChild.checked,// Support: IE <=11 only
// Make sure textarea (and checkbox) defaultValue is properly cloned
e9.innerHTML="<textarea>x</textarea>",f.noCloneChecked=!!e9.cloneNode(!0).lastChild.defaultValue,// Support: IE <=9 only
// IE <=9 replaces <option> tags with their contents when inserted outside of
// the select element.
e9.innerHTML="<option></option>",f.option=!!e9.lastChild;// We have to close these tags to support XHTML (trac-13200)
...
eM=/<script|<style|<link/i,eO=/checked\s*(?:[^=]|=\s*.checked.)/i,eP=/^\s*<!\[CDATA\[|\]\]>\s*$/g;// Prefer a tbody over its parent table for containing new rows
...
if(v||p>1&&"string"==typeof m&&!f.checkClone&&eO.test(m))return e.each(function(r){var o=e.eq(r);v&&(t[0]=m.call(this,r,o.html())),eq(o,t,n,i)});if(p&&(o=(r=eA(t,e[0].ownerDocument,!1,e,i)).firstChild,1===r.childNodes.length&&(r=o),o||i)){// Use the original fragment for the last item
...
if("string"==typeof e&&!eM.test(e)&&!ex[(ew.exec(e)||["",""])[1].toLowerCase()]){e=T.htmlPrefilter(e);try{for(;n<i;n++)t=this[n]||{},1===t.nodeType&&(T.cleanData(eT(t,!1)),t.innerHTML=e);t=0;// If using innerHTML throws an exception, use the fallback method
...
T.fx.step={};var e9,e6,e7,e8,e5=/^(?:toggle|show|hide)$/,te=/queueHooks$/;// Animations created synchronously will run synchronously
...
return this.name&&!T(this).is(":disabled")&&tT.test(this.nodeName)&&!tx.test(e)&&(this.checked||!eb.test(e))}).map(function(e,t){var n=T(this).val();return null==n?null:Array.isArray(n)?T.map(n,function(e){return{name:t.name,value:e.replace(tS,"\r\n")}}):{name:t.name,value:n.replace(tS,"\r\n")}}).get()}});var tE=/%20/g,tC=/#.*$/,tA=/([?&])_=[^&]*/,tL=/^(.*?):[ \t]*([^\r\n]*)$/mg,t$=/^(?:GET|HEAD)$/,t_=/^\/\//,/* Prefilters
	 ...
	 */tD={},tM="*/".concat("*"),tO=v.createElement("a");// Base "constructor" for jQuery.ajaxPrefilter and jQuery.ajaxTransport
...
// Fixes trac-9887
function tI(e,t){var n,i,r=T.ajaxSettings.flatOptions||{};for(n in t)void 0!==t[n]&&((r[n]?e:i||(i={}))[n]=t[n]);return i&&T.extend(!0,e,i),e}tO.href=tg.href,T.extend({// Counter for holding the number of active queries
...
ajaxSetup:function(e,t){return t?tI(tI(e,T.ajaxSettings),t):tI(T.ajaxSettings,e)},ajaxPrefilter:tP(tk),ajaxTransport:tP(tD),// Main method
...
E.setRequestHeader("Accept",h.dataTypes[0]&&h.accepts[h.dataTypes[0]]?h.accepts[h.dataTypes[0]]+("*"!==h.dataTypes[0]?", "+tM+"; q=0.01":""):h.accepts["*"]),h.headers)E.setRequestHeader(d,h.headers[d]);// Allow custom headers/mimetypes and early abort
...
e.exports=n.document?i(n,!0):function(e){if(!e.document)throw Error("jQuery requires a window with a document");return i(e)}:i(n)});class c{constructor(e="menu-burger",t="menu"){this.menuBurger=document.getElementById(e),this.menu=document.getElementById(t),this.menuBurger.addEventListener("click",e=>{this.menuBurger.classList.toggle("open"),this.menu.classList.toggle("open")})}}class u{handleClickOnTabs(){for(let e of this.tabsNavItems)e.addEventListener("click",e=>{this.switchTab(e.target);// console.log(event.target);
})}switchTab(e){let t=e.getAttribute("data-tab");for(let e of this.tabsNavItems)e.classList.remove("active");for(let e of this.tabsContentItems)e.id===t?e.classList.add("current"):e.classList.remove("current");e.classList.add("active"),this.tabNavList[0].classList.toggle("expanded")}constructor(e="tab-nav-item",t="tab-nav-items",n="tab-content"){this.tabsNavItems=document.getElementsByClassName(e),this.tabNavList=document.getElementsByClassName(t),this.tabsContentItems=document.getElementsByClassName(n),this.handleClickOnTabs()}}var d={};/**
 * Swiper 7.4.1
...
if("[object Object]"===Object.prototype.toString.call(i[r])){e[r]=F(e[r],i[r]);continue}e[r]=i[r]}}}return e}/**
    ...
    */function G(){return"innerHeight"in M?M.innerHeight:O.documentElement.offsetHeight}/**
    * Gets the window width.
    */function U(){return M.innerWidth}/**
    ...
    */function eo(e,t,n){var i;t=t||O.createElement("div");for(var r=0;r<e.length;r++){var o=e[r];(!n||r)&&n||(i=t.cloneNode(!0),o.parentNode.insertBefore(i,o)),i.appendChild(o)}return e}/**
    Usage:
    var wrapper = document.createElement('div');
    wrapper.className = 'fp-slides';
    wrap($('.slide'), wrapper);
    ...
    *
    */function el(e){for(var t=O.createDocumentFragment();e.firstChild;)t.appendChild(e.firstChild);e.parentNode.replaceChild(t,e)}/**
...
function eh(){var e=O.documentElement;return(M.pageYOffset||e.scrollTop)-(e.clientTop||0)}/**
    * Gets the siblings of the passed element
    */function ef(e){return Array.prototype.filter.call(e.parentNode.children,function(t){return t!==e})}function eg(e){e.preventDefault()}function em(e,t){return e.getAttribute(t)}function ev(e,t,n){O.addEventListener(e,t,"undefined"===n?null:n)}function ey(e,t,n){M.addEventListener(e,t,"undefined"===n?null:n)}function eb(e,t,n){O.removeEventListener(e,t,"undefined"===n?null:n)}function ew(e,t,n){M.removeEventListener(e,t,"undefined"===n?null:n)}/**
    ...
    */function ex(e,t,n){var i;n=void 0===n?{}:n,"function"==typeof M.CustomEvent?i=new CustomEvent(t,{detail:n}):(i=O.createEvent("CustomEvent")).initCustomEvent(t,!0,!0,n),e.dispatchEvent(i)}/**
    * Polyfill of .matches()
...
return e}/**
    ...
    */function eC(e){var t=O.createElement("div");return t.innerHTML=e.trim(),t.firstChild}/**
...
function eL(e,t,n){for(var i=e[n],r=[];i;)(eT(i,t)||null==t)&&r.push(i),i=i[n];return r}/**
    ...
    */function ek(e){return Object.keys(e).map(function(t){return e[t]})}function eD(e){return e[e.length-1]}/**
    * Gets the average of the last `number` elements of the given array.
    */function eM(e,t){for(var n=0,i=e.slice(Math.max(e.length-t,1)),r=0;r<i.length;r++)n+=i[r];return Math.ceil(n/t)}/**
    * Sets the value for the given attribute from the `data-` attribute with the same suffix
    * ie: data-srcset ==> srcset  |  data-src ==> src
    */function eO(e,t){e.setAttribute(t,em(e,"data-"+t)),e.removeAttribute("data-"+t)}function eP(e,t){var n=[e];do n.push(e=e.parentNode);while(!eT(e,t))return n}function ej(){var e=O.activeElement;return eT(e,"textarea")||eT(e,"input")||eT(e,"select")||"true"==em(e,"contentEditable")||""==em(e,"contentEditable")}//utils are public, so we can use it wherever we want
M.NodeList&&!NodeList.prototype.forEach&&(NodeList.prototype.forEach=function(e,t){t=t||window;for(var n=0;n<this.length;n++)e.call(t,this[n],n,this)}),"function"!=typeof Object.assign&&Object.defineProperty(Object,"assign",{value:function(e,t){if(null==e)throw TypeError("Cannot convert undefined or null to object");for(var n=Object(e),i=1;i<arguments.length;i++){var r=arguments[i];if(null!=r)// Skip over if undefined or null
...
if(!t_().navigationTooltips.length){var n="[data-tooltip]",i=B(t_().sectionSelector.split(",").join(n+",")+n,tC);i.length&&i.forEach(function(e){t_().navigationTooltips.push(em(e,"data-tooltip").toString())})}}var tM=function(e){this.anchor=e.anchor,this.item=e.item,this.index=e.index(),this.isLast=this.index===e.item.parentElement.querySelectorAll(e.selector).length-1,this.isFirst=!this.index,this.isActive=e.isActive},tO=function(e,t){this.parent=this.parent||null,this.selector=t,this.anchor=em(e,"data-anchor")||t_().anchors[Q(e,t_().sectionSelector)],this.item=e,this.isVisible=R(e),this.isActive=W(e,eZ),this.hasScroll=W(e,td)||null!=B(tp,e)[0],this.isSection=t===t_().sectionSelector,this.container=ec(e,tc)||ec(e,eU),this.index=function(){return this.siblings().indexOf(this)}};function tP(e){return e.map(function(e){return e.item})}function tj(e,t){return e.find(function(e){return e.item===t})}tO.prototype.siblings=function(){return this.isSection?this.isVisible?eq.sections:eq.sectionsIncludingHidden:this.parent?this.parent.slides:0},tO.prototype.prev=function(){var e=this.siblings(),t=(this.isSection?e.indexOf(this):this.parent.slides.indexOf(this))-1;return t>=0?e[t]:null},tO.prototype.next=function(){var e=this.siblings(),t=(this.isSection?e.indexOf(this):this.parent.slides.indexOf(this))+1;return t<e.length?e[t]:null},tO.prototype.prevPanel=function(){return this.prev()||(this.parent?this.parent.prev():null)},tO.prototype.nextPanel=function(){return this.next()||(this.parent?this.parent.next():null)},tO.prototype.getSiblings=function(){return this.isSection?eq.sections:eq.panels};var tI=function(e){tM.call(this,e)},tN=function(e){tM.call(this,e)};/**
    ...
    */function tB(e){var t="transform "+t_().scrollingSpeed+"ms "+t_().easingcss3;return ei(e,eX),V(e,{"-webkit-transition":t,transition:t})}/**
...
var t=Math.round(e);if(t_().css3&&t_().autoScrolling&&!t_().scrollBar)tG("translate3d(0px, -"+t+"px, 0px)",!1);else if(t_().autoScrolling&&!t_().scrollBar)V(tC,{top:-t+"px"}),H.test.top=-t+"px";else{var n=tR(t);tz(n.element,n.options)}}/**
    ...
    */function tV(e,t){tk("scrollingSpeed",e,t)}H.setScrollingSpeed=tV;var tX=null,tY=null,tK=null;/**
    * Simulates the animated scrollTop of jQuery. Used when css3:false or scrollBar:true or autoScrolling:false
    * http://stackoverflow.com/a/16136789/1081396
    */function tQ(e,t,n,i){var r,o=e.self!=M&&W(e,ts)?e.scrollLeft:!t_().autoScrolling||t_().scrollBar?eh():e.offsetTop,s=t-o,a=!1,l=eq.activeAnimation;eR({activeAnimation:!0}),y&&window.cancelAnimationFrame(y),y=function(c){r||(r=c);var u=Math.floor(c-r);if(eq.activeAnimation){//in order to stope it from other function whenever we want
var d=t;n&&(d=M.fp_easings[t_().easing](u,o,s,n)),u<=n&&tz(e,d),u<n?window.requestAnimationFrame(y):void 0===i||a||(i(),eR({activeAnimation:!1}),a=!0)}else a||l||(i(),eR({activeAnimation:!1}),a=!0)},window.requestAnimationFrame(y)}/**
...
B("video, audio",t).forEach(function(e){e.hasAttribute("data-keepplaying")||"function"!=typeof e.pause||e.pause()}),B('iframe[src*="youtube.com/embed/"]',t).forEach(function(e){/youtube\.com\/embed\//.test(em(e,"src"))&&!e.hasAttribute("data-keepplaying")&&e.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}',"*")})}/**
    ...
    */function t4(e){t_().lazyLoading&&B("img[data-src], img[data-srcset], source[data-src], source[data-srcset], video[data-src], audio[data-src], iframe[data-src]",tH(e)).forEach(function(e){if(["src","srcset"].forEach(function(t){var n=em(e,"data-"+t);null!=n&&n&&(eO(e,t),e.addEventListener("load",function(){}))}),eT(e,"source")){var t=ec(e,"video, audio");t&&(t.load(),t.onloadeddata=function(){})}})}/**
    * Sets a class for the body of the page depending on the active section / slide
    */function t9(){var e=eq.activeSection.item,t=eq.activeSection.activeSlide,n=String(t6(e));t&&(n=n+"-"+t6(t.item)),n=n.replace("/","-").replace("#","");var i=RegExp("\\b\\s?"+eQ+"-[^\\s]+\\b","g");tX.className=tX.className.replace(i,""),en(tX,eQ+"-"+n)}/**
    * Gets the anchor for the given slide / section. Its index will be used if there's none.
    */function t6(e){if(!e)return null;var t=em(e,"data-anchor"),n=Q(e);return null==t&&(t=n),t}/**
    * Sets the state of the website depending on the active section/slide.
    * It changes the URL hash when needed and updates the body class.
    */function t7(e,t,n){var i="";t_().anchors.length&&!t_().lockAnchors&&(e?(null!=n&&(i=n),null==t&&(t=e),eR({lastScrolledSlide:t}),t8(i+"/"+t)):(null!=e&&eR({lastScrolledSlide:t}),t8(n))),t9()}/**
    * Sets the URL hash.
    */function t8(e){if(t_().recordHistory)location.hash=e;else if(P||I)M.history.replaceState(void 0,void 0,"#"+e);else{var t=M.location.href.split("#")[0];M.location.replace(t+"#"+e)}}/**
...
var t=Q(ec(this,te+" li"));eH.emit(ez.scrollPage,{destination:eq.sections[t]})}/**
    ...
    */function nu(e,t){var n;t_().menu&&t_().menu.length&&B(t_().menu).forEach(function(t){null!=t&&(ei(B(eJ,t),eZ),en(B('[data-menuanchor="'+e+'"]',t),eZ))}),n=B(te)[0],t_().navigation&&null!=n&&"none"!==n.style.display&&(ei(B(eJ,n),eZ),e?en(B('a[href="#'+e+'"]',n),eZ):en(B("a",B("li",n)[t]),eZ))}nt.m={up:!0,down:!0,left:!0,right:!0},nt.k=F({},nt.m),eH.on(ez.onClickOrTouch,function(e){var t=e.target;(eT(t,tb)||ec(t,tb))&&ni.call(t,e)}//Scrolling horizontally when clicking on the slider controls.
     ...
     */var nd=(n=!0,i=new Date().getTime(),r=!M.fullpage_api,function(e,o){var s=new Date().getTime(),a="wheel"===e?t_().scrollingSpeed:100;return n=r||s-i>=a,r=!M.fullpage_api,n&&(t=o(),i=s),void 0===t||t});/**
...
var s=(l=o.offsetHeight,u=c=o.offsetTop,d=c>eq.previousDestTop,p=u-G()+l,h=t_().bigSectionsDestination,l>G()?(d||h)&&"bottom"!==h||(u=p):(d||eq.isResizing&&null==Y(o))&&(u=p),/*
...
localIsResizing:eq.isResizing,items:{origin:eq.activeSection,destination:e},direction:null};if((eq.activeSection.item!=o||eq.isResizing)&&(!t_().scrollBar||eh()!==a.dtop||W(o,e9))){if(null!=a.activeSlide&&(i=em(a.activeSlide,"data-anchor"),r=Q(a.activeSlide,null)),!a.localIsResizing){var l,c,u,d,p,h,f,g,m=a.yMovement;//required for continousVertical
...
tU(eq.activeSection.item.offsetTop),/**
    ...
    */function(){for(var e=B(to),t=0;t<e.length;t++)n_(e[t],"internal")}(),f.wrapAroundElements=g,f.dtop=f.element.offsetTop,f.yMovement=tF(eq.activeSection,f.element),a=f),a.localIsResizing||t3(eq.activeSection.item),en(o,eZ),ei(ef(o),eZ),nM(),t4(o),//more than once if the page is scrolling
...
/**
    * Maintains the active slides in the viewport
    * (Because the `scroll` animation might get lost with some actions, such as when using continuousVertical)
    */function(){for(var e=B(to),t=0;t<e.length;t++)n_(e[t],"internal")}(),eR({isDoingContinousVertical:!1})),eS(t_().afterLoad)&&!e.localIsResizing&&t0("afterLoad",e),nM(),e.localIsResizing||t1(e.element),en(e.element,e0),ei(ef(e.element),e0),ns(),eR({canScroll:!0}),eH.emit(ez.afterSectionLoads,e),eS(e.callback)&&e.callback()}/**
    * Sets fitToSection
...
eR({isResizing:!0}),nh(eq.activeSection),eR({isResizing:!1}))}/**
    ...
    */function nv(){var e=t_().responsive||t_().responsiveWidth,t=t_().responsiveHeight,n=e&&M.innerWidth<e,i=t&&M.innerHeight<t;//backwards compatiblity
e&&t?ny(n||i):e?ny(n):t&&ny(i)}/**
    * Turns fullPage.js to normal scrolling mode when the viewport `width` or `height`
    * are smaller than the set limit values.
    */function ny(e){var t=W(tX,eV);e?!t&&(no(!1,"internal"),ng(!1,"internal"),J(B(te)),en(tX,eV),eS(t_().afterResponsive))&&t_().afterResponsive.call(tC,e):t&&(no(tL.autoScrolling,"internal"),ng(tL.autoScrolling,"internal"),ee(B(te)),ei(tX,eV),eS(t_().afterResponsive))&&t_().afterResponsive.call(tC,e)}function nb(e){t_().verticalCentered&&(!t_().scrollOverflow&&nE.shouldBeScrollable(e.item)||nE.isScrollable(e)||W(e.item,tu)||en(e.item,tu))}H.moveTo=moveTo,H.getScrollY=function(){return eq.scrollY},eH.on(ez.onDestroy,function(){clearTimeout(b),clearTimeout(w)}),H.setFitToSection=ng,H.fitToSection=nm,H.setResponsive=ny;var nw=null;/**
    * Styling vertical sections
    */function nS(e){var t=e.item,n=e.allSlidesItems.length,i=e.index();!eq.activeSection&&e.isVisible&&(en(t,eZ),nM(),nw=eq.activeSection.item),t_().paddingTop&&V(t,{"padding-top":t_().paddingTop}),t_().paddingBottom&&V(t,{"padding-bottom":t_().paddingBottom}),void 0!==t_().sectionsColor[i]&&V(t,{"background-color":t_().sectionsColor[i]}),void 0!==t_().anchors[i]&&t.setAttribute("data-anchor",e.anchor),n||nb(e)}function nx(){t_().scrollOverflow&&!t_().scrollBar&&(nE.makeScrollable(),nE.focusScrollable())}function nT(){eH.removeListener(ez.onAfterRenderNoAnchor,nx),eb("keyup",nE.keyUpHandler)}H.getActiveSection=/**
...
unfocusScrollable:function(){O.activeElement===this.focusedElem&&(// @ts-ignore
...
eR({canScroll:!0}),t1(e.destiny),eH.emit(ez.afterSlideLoads,e)),eR({slideMoving:!1})}/**
    ...
    */function n_(e,t){tV(0,"internal"),void 0!==t&&eR({isResizing:!0}),nA(ec(e,ta),e),void 0!==t&&eR({isResizing:!1}),tV(tL.scrollingSpeed,"internal")}H.landscapeScroll=nA,eH.on(ez.bindEvents,function(){eH.on(ez.onPerformMovement,nC)});var nk=null,nD=null;/** 
     * Updates the state of the app.
     */function nM(){eq.activeSection=null,eq.sections.map(function(e){var t=W(e.item,eZ);e.isActive=t,e.hasScroll=nE.hasScroll(e.item),t&&(eq.activeSection=e),e.slides.length&&(e.activeSlide=null,e.slides.map(function(t){var n=W(t.item,eZ);t.hasScroll=nE.hasScroll(e.item),t.isActive=n,n&&(e.activeSlide=t)}))}),/**
     * When changes in the DOM take place there's a change 
     * the active section is now hidden or removed. 
     * fullPage.js will scroll to the closest section nearby.
     */function(){var e=eq.activeSection,t=!!eq.activeSection&&eq.activeSection.slides.length,n=eq.activeSection?eq.activeSection.activeSlide:null;if(!e&&eq.sections.length&&!eq.isBeyondFullpage&&nk){var i=nj(nk,eq.sections);i&&(eq.activeSection=i,eq.activeSection.isActive=!0,en(eq.activeSection.item,eZ)),eq.activeSection&&tU(eq.activeSection.item.offsetTop)}if(t&&!n&&nD){var r=nj(nD,eq.activeSection.slides);r&&(eq.activeSection.activeSlide=r,eq.activeSection.activeSlide.isActive=!0,en(eq.activeSection.activeSlide.item,eZ)),eq.activeSection.activeSlide&&n_(eq.activeSection.activeSlide.item,"internal")}}()}function nO(){var e=B(t_().sectionSelector,tC),t=z(e),n=Array.from(e).map(function(e){return new nI(e)}),i=n.filter(function(e){return e.isVisible}),r=i.reduce(function(e,t){return e.concat(t.slides)},[]);nk=nP(eq.activeSection),nD=nP(eq.activeSection?eq.activeSection.activeSlide:null),eq.numSections=t.length,eq.numSlides=i.reduce(function(e,t){return e+t.slides.length},0),eq.sections=i,eq.sectionsIncludingHidden=n,eq.slides=r,eq.panels=eq.sections.concat(eq.slides)}function nP(e){if(!e)return null;var t=e?e.item:null,n=e.isSection?eq.sectionsIncludingHidden:eq.activeSection.slidesIncludingHidden;if(t){var i=tj(n,t);return i?i.index():null}return null}function nj(e,t){var n,i=e-1,r=e;do{if(n=t[i]||t[r])break;i-=1,r+=1}while(i>=0||r<t.length)return n}/**
    * Section object
    */var nI=function(e){var t=this;[].push.call(arguments,t_().sectionSelector),tO.apply(this,arguments),this.allSlidesItems=B(t_().slideSelector,e),this.slidesIncludingHidden=Array.from(this.allSlidesItems).map(function(e){return new nN(e,t)}),this.slides=this.slidesIncludingHidden.filter(function(e){return e.isVisible}),this.activeSlide=this.slides.length?this.slides.filter(function(e){return e.isActive})[0]||this.slides[0]:null};nI.prototype=tO.prototype,nI.prototype.constructor=nI;/**
    * Slide object
    */var nN=function(e,t){this.parent=t,tO.call(this,e,t_().slideSelector)};/**
    * Adds internal classes to be able to provide customizable selectors
    * keeping the link with the style sheet.
    */function nH(){en(B(t_().sectionSelector,tC),e2),en(B(t_().slideSelector,tC),ti)}/**
    * Styles the horizontal slides for a section.
    */function nq(e){var t,n,i=e.slides.length,r=e.allSlidesItems,o=e.slides,s=100/i;if(!B(ta,e.item)[0]){var a=O.createElement("div");a.className=ts,es(r,a);var l=O.createElement("div");l.className=tl,es(r,l)}V(B(tc,e.item),{width:100*i+"%"}),i>1&&(t_().controlArrows&&(t=e.item,n=[eC(t_().controlArrowsHTML[0]),eC(t_().controlArrowsHTML[1])],eu(B(ta,t)[0],n),en(n,ty),en(n[0],tw),en(n[1],tx),"#fff"!==t_().controlArrowColor&&(V(B(tT,t),{"border-color":"transparent transparent transparent "+t_().controlArrowColor}),V(B(tS,t),{"border-color":"transparent "+t_().controlArrowColor+" transparent transparent"})),t_().loopHorizontal||J(B(tS,t))),t_().slidesNavigation&&/**
...
null!=c&&eq.activeSection&&(0!==eq.activeSection.index()||0===eq.activeSection.index()&&0!==c.index())?n_(c.item,"internal"):en(r[0],eZ)}nN.prototype=tO.prototype,nN.prototype.constructor=nI;var nR={attributes:!1,subtree:!0,childList:!0,characterData:!0};function nz(){return z(B(t_().slideSelector,tC)).length!==eq.numSlides}/**
...
T.disconnect(),nO(),nM(),t_().anchors=[],eA(B(te)),nH(),tD(),t_().navigation&&nl(),t&&(eA(B(tg)),eA(B(tb))),eq.sections.forEach(function(e){e.slides.length?t&&nq(e):nS(e)})),t_().observer&&T&&B(eU)[0]&&T.observe(B(eU)[0],nR)}eH.on(ez.bindEvents,function(){var e,t;t_().observer&&"MutationObserver"in window&&B(eU)[0]&&(e=B(eU)[0],(t=new MutationObserver(nB)).observe(e,nR),T=t),eH.on(ez.contentChanged,nB)}),H.render=nB;var nF=function(){//cheks for passive event support
var e=!1;try{var t=Object.defineProperty({},"passive",{get:function(){e=!0}});ey("testPassive",null,t),ew("testPassive",null,t)}catch(e){}return function(){return e}}();function nW(){return!!nF()&&{passive:!1}}var nG=(l=new Date().getTime(),c=[],{registerEvent:function(e){var t=(e=e||M.event).wheelDelta||-e.deltaY||-e.detail,n=void 0!==e.wheelDeltaX||void 0!==e.deltaX;s=Math.abs(e.wheelDeltaX)<Math.abs(e.wheelDelta)||Math.abs(e.deltaX)<Math.abs(e.deltaY)||!n;var i=new Date().getTime();a=0>Math.max(-1,Math.min(1,t))?"down":"up",c.length>149&&c.shift(),//keeping record of the previous scrollings
c.push(Math.abs(t));var r=i-l;l=i,r>200&&(c=[])},isAccelerating:function(){var e=eM(c,10),t=eM(c,70);return!!c.length&&e>=t&&s},getDirection:function(){return a}});function nU(){var e=t_().css3?eh()+G():eD(eq.sections).item.offsetTop+eD(eq.sections).item.offsetHeight,t=tR(e);H.test.top=-e+"px",eR({canScroll:!1}),tQ(t.element,t.options,t_().scrollingSpeed,function(){setTimeout(function(){eR({isBeyondFullpage:!0}),eR({canScroll:!0})},30)})}function nV(){tC.getBoundingClientRect().bottom>=0&&nX()}function nX(){var e=tR(eD(eq.sections).item.offsetTop);eR({canScroll:!1}),tQ(e.element,e.options,t_().scrollingSpeed,function(){eR({canScroll:!0}),eR({isBeyondFullpage:!1}),eR({isAboutToScrollToFullPage:!1})})}var nY=(u=!1,d={},p={},function(e,t,n){switch(e){case"set":d[t]=new Date().getTime(),p[t]=n;break;case"isNewKeyframe":u=new Date().getTime()-d[t]>p[t]}return u});/**
    * Moves the page down one section.
    */function nK(){var e=eq.activeSection.next();//looping to the top if there's no more sections below
!e&&(t_().loopBottom||t_().continuousVertical)&&(e=eq.sections[0]),null!=e?nh(e,null,!1):tC.scrollHeight<tX.scrollHeight&&t_().scrollBar&&t_().scrollBeyondFullpage&&eH.emit(ez.scrollBeyondFullpage)}/**
    * Moves the page up one section.
    */function nQ(){var e=eq.activeSection.prev();//looping to the bottom if there's no more sections above
!e&&(t_().loopTop||t_().continuousVertical)&&(e=eD(eq.sections)),null!=e&&nh(e,null,!0)}H.moveSectionDown=nK,H.moveSectionUp=nQ;var nZ=0;/**
    ...
    */function n0(e){if(nt.m[e]){var t="down"===e?nK:nQ;t_().scrollOverflow&&nE.isScrollable(eq.activeSection)?nE.isScrolled(e,eq.activeSection.item)&&nE.shouldMovePage()&&t():t()}}var n1=0,n2=0,n3=0,n4=0,n9=(M.PointerEvent&&(e={down:"pointerdown",move:"pointermove"}),e),n6={touchmove:"ontouchmove"in window?"touchmove":n9?n9.move:null,touchstart:"ontouchstart"in window?"touchstart":n9?n9.down:null};/* Detecting touch events

    * As we are changing the top property of the page on scrolling, we can not use the traditional way to detect it.
    * This way, the touchstart and the touch moves shows an small difference between them which is the
    * used one to determine the direction.
    */function n7(e){var t=ec(e.target,e3)||eq.activeSection.item,n=nE.isScrollable(eq.activeSection);if(n8(e)){eR({isGrabbing:!0,isUsingWheel:!1}),t_().autoScrolling&&(n&&!eq.canScroll||t_().scrollBar)&&eg(e);var i=it(e);n3=i.y,n4=i.x;var r=Math.abs(n1-n3)>M.innerHeight/100*t_().touchSensitivity,o=Math.abs(n2-n4)>U()/100*t_().touchSensitivity,s=B(ta,t).length&&Math.abs(n2-n4)>Math.abs(n1-n3),a=n2>n4?"right":"left",l=n1>n3?"down":"up";eR({touchDirection:s?a:l}),s?!eq.slideMoving&&o&&(n2>n4?nt.m.right&&eH.emit(ez.moveSlideRight,{section:t}):nt.m.left&&eH.emit(ez.moveSlideLeft,{section:t})):t_().autoScrolling&&eq.canScroll&&r&&n0(l)}}/**
...
if(!t_().loopHorizontal)return;s="left"===e?eD(i.slides):i.slides[0]}eR({slideMoving:!H.test.isTesting}),nA(r,s.item,e)}}/**
...
function ip(e){clearTimeout(C);var t=e.keyCode,n=[37,39].indexOf(t)>-1,i=t_().autoScrolling||t_().fitToSection||n;9===t?/**
    ...
    */function(e){var t,n,i,r,o,s=e.shiftKey,a=O.activeElement,l=ib(tH(eq.activeSection.item));function c(e){return eg(e),l[0]?l[0].focus():null}// deactivating tab while scrolling #4550
if(!eq.canScroll){eg(e);return}//outside any section or slide? Let's not hijack the tab!
if(n=(t=ib(O)).indexOf(O.activeElement),r=ec(i=t[e.shiftKey?n-1:n+1],tr),o=ec(i,e3),r||o){//is there an element with focus?
...
var u=a==l[0],d=a==l[l.length-1],p=s&&u;if(p||!s&&d){eg(e);var h=/**
    ...
    * Keydown event
    */(function(e){var t=e.shiftKey,n=O.activeElement,i=eT(n,"video")||eT(n,"audio"),r={up:nE.isScrolled("up",eq.activeSection.item),down:nE.isScrolled("down",eq.activeSection.item)},o=[37,39].indexOf(e.keyCode)>-1;if(!([40,38,32,33,34].indexOf(e.keyCode)>-1)||eq.isBeyondFullpage||ec(e.target,tp)||e.preventDefault(),eq.canScroll||o)switch(eR({scrollTrigger:"keydown"}),e.keyCode){//up
...
ey("blur",ig),ev("keydown",ip),ev("keyup",ih),eH.on(ez.onDestroy,id),eH.on(ez.afterSlideLoads,im),eH.on(ez.afterSectionLoads,iv)});var iw=new Date().getTime(),iS=[];/**
    ...
    */function ix(e){var t,n,i,r;e?(n="",M.addEventListener?t="addEventListener":(t="attachEvent",n="on"),i="onwheel"in O.createElement("div")?"wheel":void 0!==O.onmousewheel?"mousewheel":"DOMMouseScroll",r=nW(),"DOMMouseScroll"==i?O[t](n+"MozMousePixelScroll",iT,r):O[t](n+i,iT,r),tC.addEventListener("mousedown",iE),tC.addEventListener("mouseup",iC)):(O.addEventListener?(eb("mousewheel",iT,!1),eb("wheel",iT,!1),eb("MozMousePixelScroll",iT,!1)):O.detachEvent("onmousewheel",iT),tC.removeEventListener("mousedown",iE),tC.removeEventListener("mouseup",iC))}/**
     * Detecting mousewheel scrolling
     *
     * http://blogs.sitepointstatic.com/examples/tech/mouse-wheel/index.html
     * http://www.sitepoint.com/html5-javascript-mouse-wheel/
     */function iT(e){var t=new Date().getTime(),n=W(B(e1)[0],"fp-normal-scroll"),i=function(e,t){new Date().getTime();var n,i=eq.isBeyondFullpage&&e.getBoundingClientRect().bottom>=0&&"up"===nG.getDirection(),r=eq.isAboutToScrollToFullPage;if(r)return eg(t),!1;if(eq.isBeyondFullpage){if(i){if(!r&&(!nY("isNewKeyframe","beyondFullpage")||!nG.isAccelerating()))return(n=tR(eD(eq.sections).item.offsetTop+eD(eq.sections).item.offsetHeight)).element.scrollTo(0,n.options),eR({isAboutToScrollToFullPage:!1}),eg(t),!1;if(nG.isAccelerating())return i=!1,eR({isAboutToScrollToFullPage:!0}),eR({scrollTrigger:"wheel"}),nX(),eg(t),!1}else nY("set","beyondFullpage",1e3);if(!r&&!i)return!0}}(tC,e);//is scroll allowed?
...
(e=e||M.event).wheelDelta||-e.deltaY||-e.detail,o=Math.max(-1,Math.min(1,r)),s=void 0!==e.wheelDeltaX||void 0!==e.deltaX,a=Math.abs(e.wheelDeltaX)<Math.abs(e.wheelDelta)||Math.abs(e.deltaX)<Math.abs(e.deltaY)||!s;iS.length>149&&iS.shift(),//keeping record of the previous scrollings
iS.push(Math.abs(r)),t_().scrollBar&&eg(e);//time difference between the last scroll and the current one
var l=t-iw;return iw=t,l>200&&(iS=[]),eR({wheelDirection:o<0?"down":o>0?"up":"none"}),eq.canScroll&&eM(iS,10)>=eM(iS,70)&&a&&(eR({scrollTrigger:"wheel"}),o<0?n0("down"):n0("up")),!1}t_().fitToSection&&eR({activeAnimation:!1})}//binding the mousemove when the mouse's middle button is released
...
2==e.which&&tC.removeEventListener("mousemove",nJ)}/**
    ...
    */function(){if(n6.touchmove&&(P||I)){t_().autoScrolling&&(tX.removeEventListener(n6.touchmove,ii,{passive:!1}),tX.addEventListener(n6.touchmove,ii,{passive:!1}));var e=t_().touchWrapper;e.removeEventListener(n6.touchstart,n5),e.removeEventListener(n6.touchmove,n7,{passive:!1}),e.addEventListener(n6.touchstart,n5),e.addEventListener(n6.touchmove,n7,{passive:!1})}}()):(ix(!1),/**
    * Removes the auto scrolling for touch devices.
    */function(){if(n6.touchmove&&(P||I)){t_().autoScrolling&&(tX.removeEventListener(n6.touchmove,n7,{passive:!1}),tX.removeEventListener(n6.touchmove,ii,{passive:!1}));var e=t_().touchWrapper;e.removeEventListener(n6.touchstart,n5),e.removeEventListener(n6.touchmove,n7,{passive:!1})}}())}H.setMouseWheelScrolling=ix;var iL=!0;function i$(){["mouseenter","touchstart","mouseleave","touchend"].forEach(function(e){eb(e,ik,!0);//true is required!
...
t_().autoScrolling&&!t_().scrollBar&&(eR({isResizing:!0}),iD(eq.activeSection.index()+1),eR({isResizing:!1}))})},200*e)}(),iP=!0,//http://stackoverflow.com/questions/4298612/jquery-how-to-call-resize-event-only-once-its-finished-resizing    
...
var e=.01*M.innerHeight;// Then we set the value in the --vh custom property to the root of the document
O.documentElement.style.setProperty("--vh","".concat(e,"px"))}}(),eH.emit(ez.contentChanged),nM(),nv(),P){var e,t,n=O.activeElement;//if the keyboard is NOT visible
...
Math.abs(i-iM)>20*Math.max(iM,i)/100&&(iN(!0),iM=i)}}else e=G(),t=U(),(eq.windowsHeight!==e||iO!==t)&&(eR({windowsHeight:e}),iO=t,iN(!0));eR({isResizing:!1})})(),iP=!1},400)}/**
     * When resizing is finished, we adjust the slides sizes and positions
     */function iN(e){if(!W(tC,eY)){//nothing to do if the plugin was destroyed
//updating global vars
eR({isResizing:!0,windowsHeight:G(),windowsWidth:U()});for(var t=eq.sections,n=0;n<t.length;++n){var i=t[n],r=B(ta,i.item)[0];i.slides.length>1&&nA(r,i.activeSlide.item)}t_().scrollOverflow&&nE.makeScrollable();var o=eq.activeSection.index();!eq.isBeyondFullpage&&o&&iD(o+1),eR({isResizing:!1}),eS(t_().afterResize)&&e&&t_().afterResize.call(tC,M.innerWidth,M.innerHeight),eS(t_().afterReBuild)&&!e&&t_().afterReBuild.call(tC),ex(tC,"afterRebuild")}}function iH(e){var t=""===e?"":e+"px";eq.sections.forEach(function(e){V(e.item,{height:t})})}function iq(){var e,t,n=M.location.hash;if(n.length){//getting the anchor link in the URL and deleting the `#`
...
if(u=(c=eq.activeSection.item.offsetTop)+G(),("up"==n?u>=eh()+G():c<=eh())&&!W(eq.activeSection.item,e0)&&(en(eq.activeSection.item,e0),ei(ef(eq.activeSection.item),e0)),p=(d=s[i]).item,!d.isActive){eR({isScrolling:!0});var l,c,u,d,p,h,f,g=eq.activeSection.item,m=eq.activeSection.index()+1,v=tF(eq.activeSection,p),y=d.anchor,b=d.index()+1,w=d.activeSlide,S={activeSection:g,sectionIndex:b-1,anchorLink:y,element:p,leavingSection:m,direction:v,items:{origin:eq.activeSection,destination:d}};w&&(f=w.anchor,h=w.index()),eq.canScroll&&(en(p,eZ),ei(ef(p),eZ),eS(t_().beforeLeave)&&np("beforeLeave",S),eS(t_().onLeave)&&t0("onLeave",S),eS(t_().afterLoad)&&t0("afterLoad",S),t3(g),t4(p),t1(p),nu(y,b-1),t_().anchors.length&&eR({lastScrolledDestiny:y}),nM(),t7(h,f,y)),clearTimeout(k),k=setTimeout(function(){eR({isScrolling:!1})},100)}t_().fitToSection&&eq.canScroll&&(clearTimeout(D),D=setTimeout(function(){eq.sections.filter(function(e){var t=e.item.getBoundingClientRect();return Math.round(t.bottom)===Math.round(G())||0===Math.round(t.top)}).length||nm()},t_().fitToSectionDelay))}}/**
    ...
    */function iX(){var e,t,n=eq.activeSection,i=eq.activeSection.item;en(i,e0),t4(i),ns(),t1(i),t=ia((e=iq()).section),(!e.section||!t||void 0!==t&&t.index()===Q(nw))&&eS(t_().afterLoad)&&t0("afterLoad",{activeSection:i,element:i,direction:null,//for backwards compatibility callback (to be removed in a future!)
anchorLink:n.anchor,sectionIndex:n.index(),items:{origin:eq.activeSection,destination:eq.activeSection}}),eS(t_().afterRender)&&t0("afterRender")}/**
    ...
    */function iK(){var e=iq(),t=e.section,n=e.slide;t?t_().animateAnchor?ic(t,n):iD(t,n):eH.emit(ez.onAfterRenderNoAnchor,null)}/**
    * Displays warnings
    */function iQ(){var e=t_().licenseKey,t="font-size: 15px;background:yellow;";""===t_().licenseKey.trim()||(t_()&&eq.isValid||O.domain.indexOf("alvarotrigo.com")>-1)&&e&&e.length<20&&(console.warn("%c This website was made using fullPage.js slider. More info on the following website:",t),console.warn("%c https://alvarotrigo.com/fullPage/",t)),W(tY,eK)||(t_().continuousVertical&&(t_().loopTop||t_().loopBottom)&&(t_().continuousVertical=!1),t_().scrollOverflow&&(t_().scrollBar||t_().autoScrolling),t_().continuousVertical&&(t_().scrollBar||!t_().autoScrolling)&&(t_().continuousVertical=!1),//using extensions? Wrong file!
...
imagesToLoad:[],imagesLoaded:0}),o.emit("_swiper"),o.params.init&&o.init(),o}}function X(e=""){return`.${e.trim().replace(/([\.:!\/])/g,"\\$1")// eslint-disable-line
.replace(/ /g,".")}`}function Y({swiper:e,extendParams:t,on:n,emit:i}){let r;let o="swiper-pagination";t({pagination:{el:null,bulletElement:"span",clickable:!1,hideOnClick:!1,renderBullet:null,renderProgressbar:null,renderFraction:null,renderCustom:null,progressbarOpposite:!1,type:"bullets",// 'bullets' or 'progressbar' or 'fraction' or 'custom'
...
s(e.$el[0],{childList:e.params.observeSlideChildren}),s(e.$wrapperEl[0],{attributes:!1})}}),n("destroy",()=>{r.forEach(e=>{e.disconnect()}),r.splice(0,r.length)})}]);var en=l("3oRXo");window.$=window.jQuery=/*@__PURE__*/i(en);var en=l("3oRXo"),ei={};r=function(e){// This is needed so we can catch the AMD loader configuration and use it
...
e.fn.select2.amd=t,n)},"function"==typeof define&&define.amd?define(["jquery"],r):ei?ei=function(e,t){return void 0===t&&(t="undefined"!=typeof window?l("3oRXo"):l("3oRXo")(e)),r(t),t}:r(jQuery),/*@__PURE__*/i(ei)(/*@__PURE__*/i(en)),window.$=window.jQuery=/*@__PURE__*/i(en),window.addEventListener("load",function(){(function(){document.querySelector(".deliverySlides")&&new V(".deliverySlides",{modules:[K,Y,ee,et],loop:!0,centeredSlides:!0,effect:"creative",pagination:{el:".paginationBeliverySlides",clickable:!0},creativeEffect:{limitProgress:2,prev:{translate:["-100%",-60,-60]},next:{translate:["100%",-60,-60]}},breakpoints:{641:{slidesPerView:1.5,spaceBetween:10,creativeEffect:{limitProgress:2,prev:{translate:["-90%",-40,-40]},next:{translate:["90%",-40,-40]}}},769:{spaceBetween:40,slidesPerView:2,creativeEffect:{limitProgress:2,prev:{translate:["-90%",-40,-40]},next:{translate:["90%",-40,-40]}}}}}),document.querySelector(".aboutSlides")&&new V(".aboutSlides",{modules:[K,Y,ee,et],slidesPerView:1,loop:!0,pagination:{el:".aboutSlides__pagination",clickable:!0},breakpoints:{481:{direction:"vertical"}}});let e=new V(".geographySlider",{modules:[K,Y,ee,et],effect:"fade",loop:!0,observer:!0,autoplay:{delay:5e3,disableOnInteraction:!1},pagination:{el:".geographySlider__pagination",bulletClass:"swiper-pagination-bullet-custom",bulletActiveClass:"swiper-pagination-bullet-custom--active",renderBullet:function(e,t){return`<div class="${t}" data-index="${e}">
          ...
          </div>`},clickable:!0},on:{init:function(){var e;this.el.style.setProperty("--delay",this.params.autoplay.delay),document.querySelectorAll(".swiper-pagination-bullet-custom line").forEach(e=>{e.setAttribute("x2","0")}),null===(e=document.querySelector(".swiper-pagination-bullet-custom.swiper-pagination-bullet-custom--active line"))||void 0===e||e.setAttribute("x2","80");// _self.el.addEventListener('mouseenter', function() {
