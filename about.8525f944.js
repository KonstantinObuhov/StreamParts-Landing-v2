...
e.stopPropagation(),e.isImmediatePropagationStopped=E)}})},L=function(e,t){return a(e,"table")&&a(11!==t.nodeType?t:t.firstChild,"tr")&&em(e).children("tbody")[0]||e},k=function(e){return e.type=(null!==e.getAttribute("type"))+"/"+e.type,e},_=function(e){return"true/"===(e.type||"").slice(0,5)?e.type=e.type.slice(5):e.removeAttribute("type"),e},O=function(e,t){var n,i,r,o,s,a;if(1===t.nodeType){// 1. Copy private data: events, handlers, etc.
...
t=t?1:0;i<4;i+=2-t)r["margin"+(n=eV[i])]=r["padding"+n]=e;return t&&(r.opacity=r.width=e),r},F=function(e,t,n){for(var i,r=(tk.tweeners[t]||[]).concat(tk.tweeners["*"]),o=0,s=r.length;o<s;o++)if(i=r[o].call(n,t,e))return i},W=function(e,t){var n,i,r,o,s;// camelCase, specialEasing and expand cssHook pass
...
d[o]=p,p[2]=e(t,n,c))return!0}}return!1}},A=function(e){return e.length>1?function(t,n,i){for(var r=e.length;r--;)if(!e[r](t,n,i))return!1;return!0}:e[0]},L=function(e,t,n){for(var i=0,r=t.length;i<r;i++)eh(e,t[i],n);return n},k=function(e,t,n,i,r){for(var o,s=[],a=0,l=e.length,c=null!=t;a<l;a++)(o=e[a])&&(!n||n(o,i,r))&&(s.push(o),c&&t.push(a));return s},_=function(e,t){var r=t.length>0,o=e.length>0,a=function(a,l,u,d,p){var f,h,v,g=0,m="0",y=a&&[],b=[],w=i,x=a||o&&n.find.TAG("*",p),T=j+=null==w?1:Math.random()||.1,E=x.length;// Add elements passing elementMatchers directly to results
...
s=++u;s<a&&!n.relative[t[s].type];s++);return function e(t,n,i,r,o,s){return r&&!r[P]&&(r=e(r)),o&&!o[P]&&(o=e(o,s)),h(function(e,s,a,l){var c,u,d,p,f=[],h=[],v=s.length,g=e||L(n||"*",a.nodeType?[a]:a,[]),m=t&&(e||!n)?k(g,f,t,a,l):g;// Apply postFilter
if(i?// Find primary matches
i(m,// If we have a postFinder, or filtered seed, or non-seed postFilter
// or preexisting results,
p=o||(e?t:v||r)?[]:s,a,l):p=m,r)for(c=k(p,h),r(c,[],a,l),// Un-match failing elements by moving them back to matcherIn
...
u=p.length;u--;)(d=p[u])&&(c=o?er.call(e,d):f[u])>-1&&(e[c]=!(s[c]=d))}}else p=k(p===s?p.splice(v,p.length):p),o?o(null,s,p,l):D.apply(s,p)})}(u>1&&A(f),u>1&&E(t.slice(0,u-1).concat({value:" "===t[u-2].type?"*":""})).replace(ex,"$1"),o,u<s&&e(t.slice(u,s)),s<a&&e(t=t.slice(s)),s<a&&E(t))}f.push(o)}return A(f)}(t[r]))[P]?o.push(a):s.push(a);// Save selector and tokenization
...
n=n||ek,"string"==typeof e){// Match html or make sure no context is specified for #id
...
em.merge(this,em.parseHTML(i[1],t&&t.nodeType?t.ownerDocument||t:ef,!0)),eL.test(i[1])&&em.isPlainObject(t))for(i in t)ed(this[i])?this[i](t[i]):this.attr(i,t[i]);return this}return!t||t.jquery?(t||n).find(e):this.constructor(t).find(e);// HANDLE: $(DOMElement)
...
em.each({mouseenter:"mouseover",mouseleave:"mouseout",pointerenter:"pointerover",pointerleave:"pointerout"},function(e,t){em.event.special[e]={delegateType:t,bindType:t,handle:function(e){var n,i=e.relatedTarget,r=e.handleObj;return i&&(i===this||em.contains(this,i))||(e.type=r.origType,n=r.handler.apply(this,arguments),e.type=t),n}}}),em.fn.extend({on:function(e,t,n,i){return e9(this,e,t,n,i)},one:function(e,t,n,i){return e9(this,e,t,n,i,1)},off:function(e,t,n){var i,r;if(e&&e.preventDefault&&e.handleObj)return(// ( event )  dispatched jQuery.Event
...
e6=/<script|<style|<link/i,e7=/checked\s*(?:[^=]|=\s*.checked.)/i,e8=/^\s*<!\[CDATA\[|\]\]>\s*$/g;function e5(e,t,n,r){// Flatten any nested arrays
...
for(l=(a=em.map(S(o,"script"),k)).length;d<p;d++)c=o,d!==f&&(c=em.clone(c,!0,!0),l&&// push.apply(_, arraylike) throws on ancient WebKit
...
if("string"==typeof e&&!e6.test(e)&&!e2[(e0.exec(e)||["",""])[1].toLowerCase()]){e=em.htmlPrefilter(e);try{for(;n<i;n++)t=this[n]||{},1===t.nodeType&&(em.cleanData(S(t,!1)),t.innerHTML=e);t=0;// If using innerHTML throws an exception, use the fallback method
...
em.fx.step={};var tp,tf,th,tv,tg,tm,ty,tb,tw,tS,tx,tT,tE,tC,tA=/^(?:toggle|show|hide)$/,tL=/queueHooks$/;function tk(e,t,n){var i,r,o=0,s=tk.prefilters.length,a=em.Deferred().always(function(){// Don't match elem in the :animated selector
...
var t=tk(this,em.extend({},e),o);// Empty animations, or finishing resolves immediately
(r||ez.get(this,"finish"))&&t.stop(!0)};return s.finish=s,r||!1===o.queue?this.each(s):this.queue(o.queue,s)},stop:function(e,t,n){var i=function(e){var t=e.stop;delete e.stop,t(n)};return"string"!=typeof e&&(n=t,t=e,e=void 0),t&&this.queue(e||"fx",[]),this.each(function(){var t=!0,r=null!=e&&e+"queueHooks",o=em.timers,s=ez.get(this);if(r)s[r]&&s[r].stop&&i(s[r]);else for(r in s)s[r]&&s[r].stop&&tL.test(r)&&i(s[r]);for(r=o.length;r--;)o[r].elem===this&&(null==e||o[r].queue===e)&&(o[r].anim.stop(n),t=!1,o.splice(r,1));// Start the next in the queue if the last step wasn't forced.
...
(i=(t=ef.implementation.createHTMLDocument("")).createElement("base")).href=ef.location.href,t.head.appendChild(i)):t=ef),r=eL.exec(e),o=!n&&[],r)?[t.createElement(r[1])]:(r=T([e],t,o),o&&o.length&&em(o).remove(),em.merge([],r.childNodes))},/**
...
var t9=/^[\s\uFEFF\xA0]+|([^\s\uFEFF\xA0])[\s\uFEFF\xA0]+$/g;// Bind a function to a context, optionally partially applying any
// arguments.
 ...
 *//* eslint-disable no-param-reassign */function w(e){return null!==e&&"object"==typeof e&&"constructor"in e&&e.constructor===Object}function S(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};Object.keys(t).forEach(function(n){void 0===e[n]?e[n]=t[n]:w(t[n])&&w(e[n])&&Object.keys(t[n]).length>0&&S(e[n],t[n])})}v=function(){var e,t,n,i,r,o,s,a,l,c,u,d,p,f,h,v,g,m,y,b,w,S,x,T,E,C,A,L,k,_,O,M,D,P,j,I,N,H,R=/**
...
,eE=function(e,t,n){for(var i=e[n],r=[];i;)(ew(i,t)||null==t)&&r.push(i),i=i[n];return r},eC=/**
    ...
    */function(e,t){return eE(e,t,"previousElementSibling")},eL=/**
    * Converts an object to an array.
    */function(e){return Object.keys(e).map(function(t){return e[t]})},ek=function(e){return e[e.length-1]},e_=/**
...
,eH=function(){eP({isWindowFocused:!0})},eR=function(e){rE=e},eq=function(e){return rE},ez=function(){return rL||rT},eB=function(e){rA=Object.assign({},rL=iP({},rT,e))},eF=function(){return rA},eW=function(e,t){rT[e]=t},eG=/*
    * Sets the state for a variable with multiple states (original, and temporal)
    * Some variables such as `autoScrolling` or `recordHistory` might change automatically its state when using `responsive` or `autoScrolling:false`.
    * This function is used to keep track of both states, the original and the temporal one.
    * If type is not 'internal', then we assume the user is globally changing the variable.
    */function(e,t,n){rL[e]=t,"internal"!==n&&(rA[e]=t)},eU=/**
...
var t=Math.round(e);if(ez().css3&&ez().autoScrolling&&!ez().scrollBar)e3("translate3d(0px, -"+t+"px, 0px)",!1);else if(ez().autoScrolling&&!ez().scrollBar)G(eq(),{top:-t+"px"}),iM.test.top=-t+"px";else{var n=eQ(t);eZ(n.element,n.options)}},e9=/**
    * Defines the scrolling speed
    */function(e,t){eG("scrollingSpeed",e,t)},e6=function(){rD=z("body")[0],rP=z("html")[0],r$=z("html, body")},e7=/**
...
return e.self!=iE&&B(e,ro)?e.scrollLeft:!ez().autoScrolling||ez().scrollBar?eu():e.offsetTop},e5=/**
    ...
    */function(e,t){var n=tn(e,t);return eb(eq(),e,n),!1!==ez()[e].apply(n[Object.keys(n)[0]],eL(n))},tn=/**
...
z("video, audio",t).forEach(function(e){e.hasAttribute("data-keepplaying")||"function"!=typeof e.pause||e.pause()}),z('iframe[src*="youtube.com/embed/"]',t).forEach(function(e){/youtube\.com\/embed\//.test(ef(e,"src"))&&!e.hasAttribute("data-keepplaying")&&e.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}',"*")})},ts=/*
    ...
    * Sets the URL hash.
    */function(e){if(ez().recordHistory)location.hash=e;else if(iA||ik)iE.history.replaceState(void 0,void 0,"#"+e);else{var t=iE.location.href.split("#")[0];iE.location.replace(t+"#"+e)}},th=/**
...
null!=e.wrapAroundElements&&(e.isMovementUp?el(z(iJ)[0],e.wrapAroundElements):ea(z(iJ)[e$().sections.length-1],e.wrapAroundElements),e4(e$().activeSection.item.offsetTop),tL(),eP({isDoingContinousVertical:!1}))},t_=/**
    * Makes sure lazyload is done for other sections in the viewport that are not the
    * active one. 
    */function(){var e=z(i3)[0]||tU()&&z(i9)[0];//quitting when it doesn't apply
...
t&&(clearTimeout(L),L=setTimeout(function(){eP({canScroll:!0})},n))},tz=/**
    * Actions to do once the section is loaded.
    */function(e){eP({isBeyondFullpage:!1}),tk(e),ey(ez().afterLoad)&&!e.localIsResizing&&tt("afterLoad",e),t4(),e.localIsResizing||ti(e.element),ee(e.element,iK),et(ed(e.element),iK),t_(),eP({canScroll:!0}),iN.emit(iR.afterSectionLoads,e),ey(e.callback)&&e.callback()},tB=/**
    * Sets fitToSection
...
eP({canScroll:!0}),ti(e.destiny),iN.emit(iR.afterSlideLoads,e)),eP({slideMoving:!1})},t3=/**
    ...
    */function(e,t){e9(0,"internal"),void 0!==t&&eP({isResizing:!0}),tZ(i$(e,rs),e),void 0!==t&&eP({isResizing:!1}),e9(eF().scrollingSpeed,"internal")},t4=/** 
     * Updates the state of the app.
     */function(){iH.activeSection=null,iH.sections.map(function(e){var t=B(e.item,iY);e.isActive=t,e.hasScroll=rH.hasScroll(e.item),t&&(iH.activeSection=e),e.slides.length&&(e.activeSlide=null,e.slides.map(function(t){var n=B(t.item,iY);t.hasScroll=rH.hasScroll(e.item),t.isActive=n,n&&(e.activeSlide=t)}))}),t7()},t9=function(){var e=z(ez().sectionSelector,eq()),t=q(e),n=Array.from(e).map(function(e){return new rz(e)}),i=n.filter(function(e){return e.isVisible}),r=i.reduce(function(e,t){return e.concat(t.slides)},[]);rR=t6(iH.activeSection),rq=t6(iH.activeSection?iH.activeSection.activeSlide:null),iH.numSections=t.length,iH.numSlides=i.reduce(function(e,t){return e+t.slides.length},0),iH.sections=i,iH.sectionsIncludingHidden=n,iH.slides=r,iH.panels=iH.sections.concat(iH.slides)},t6=function(e){if(!e)return null;var t=e?e.item:null,n=e.isSection?iH.sectionsIncludingHidden:iH.activeSection.slidesIncludingHidden;if(t){var i=eY(n,t);return i?i.index():null}return null},t7=/**
...
O.disconnect(),t9(),t4(),ez().anchors=[],eT(z(i8)),t5(),eU(),ez().navigation&&tP(),t&&(eT(z(rh)),eT(z(ry))),e$().sections.forEach(function(e){e.slides.length?t&&ne(e):tY(e)})),ez().observer&&O&&z(iz)[0]&&O.observe(z(iz)[0],rF)},nr=function(){return!!rW()&&{passive:!1}},no=function(){var e=nl(),t=eQ(e);iM.test.top=-e+"px",eP({canScroll:!1}),e7(t.element,t.options,ez().scrollingSpeed,function(){setTimeout(function(){eP({isBeyondFullpage:!0}),eP({canScroll:!0})},30)})},ns=function(){eq().getBoundingClientRect().bottom>=0&&na()},na=function(){var e=eQ(ek(e$().sections).item.offsetTop);eP({canScroll:!1}),e7(e.element,e.options,ez().scrollingSpeed,function(){eP({canScroll:!0}),eP({isBeyondFullpage:!1}),eP({isAboutToScrollToFullPage:!1})})},nl=function(){return ez().css3?eu()+F():ek(e$().sections).item.offsetTop+ek(e$().sections).item.offsetHeight},nc=function(e,t){new Date().getTime();var n,i=e$().isBeyondFullpage&&e.getBoundingClientRect().bottom>=0&&"up"===rG.getDirection(),r=e$().isAboutToScrollToFullPage;if(r)return ep(t),!1;if(e$().isBeyondFullpage){if(i){if(!r&&(!rU("isNewKeyframe","beyondFullpage")||!rG.isAccelerating()))return(n=eQ(ek(e$().sections).item.offsetTop+ek(e$().sections).item.offsetHeight)).element.scrollTo(0,n.options),eP({isAboutToScrollToFullPage:!1}),ep(t),!1;if(rG.isAccelerating())return i=!1,eP({isAboutToScrollToFullPage:!0}),eP({scrollTrigger:"wheel"}),na(),ep(t),!1}else rU("set","beyondFullpage",1e3);if(!r&&!i)return!0}},nu=/**
...
!e&&(ez().loopTop||ez().continuousVertical)&&(e=ek(e$().sections)),null!=e&&tH(e,null,!0)},nf=/**
    ...
    */function(){if(rJ.touchmove&&(iA||ik)){ez().autoScrolling&&(rD.removeEventListener(rJ.touchmove,nx,{passive:!1}),rD.addEventListener(rJ.touchmove,nx,{passive:!1}));var e=ez().touchWrapper;e.removeEventListener(rJ.touchstart,nw),e.removeEventListener(rJ.touchmove,ny,{passive:!1}),e.addEventListener(rJ.touchstart,nw),e.addEventListener(rJ.touchmove,ny,{passive:!1})}},nm=/**
    * Removes the auto scrolling for touch devices.
    */function(){if(rJ.touchmove&&(iA||ik)){ez().autoScrolling&&(rD.removeEventListener(rJ.touchmove,ny,{passive:!1}),rD.removeEventListener(rJ.touchmove,nx,{passive:!1}));var e=ez().touchWrapper;e.removeEventListener(rJ.touchstart,nw),e.removeEventListener(rJ.touchmove,ny,{passive:!1})}},ny=/* Detecting touch events
...
return void 0===e.pointerType||"mouse"!=e.pointerType},nw=/**
    ...
    */function(e){var t={};return t.y=void 0!==e.pageY&&(e.pageY||e.pageX)?e.pageY:e.touches[0].pageY,t.x=void 0!==e.pageX&&(e.pageY||e.pageX)?e.pageX:e.touches[0].pageX,ik&&nb(e)&&ez().scrollBar&&void 0!==e.touches&&(t.y=e.touches[0].pageY,t.x=e.touches[0].pageX),t},nx=/*
...
if(!ez().loopHorizontal)return;s="left"===e?ek(i.slides):i.slides[0]}eP({slideMoving:!iM.test.isTesting}),tZ(r,s.item,e)}},nE=/**
    ...
    */function(e){var t=e$().sections.filter(function(t){return t.anchor===e})[0];return t||(t=e$().sections[void 0!==e?e-1:0]),t},nL=/**
    * Scrolls the slider to the given slide destination for the given section
    */function(e){null!=e&&tZ(i$(e,rs),e)},nk=/**
...
n.anchor&&n.anchor===iH.lastScrolledDestiny||B(n.item,iY)?nL(i):tH(n,function(){nL(i)})}},n_=/**
    ...
    */function(e,t){var n=nA(e);void 0!==t?nk(e,t):null!=n&&tH(n)},nM=function(){clearTimeout(D),eg("keydown",nD),eg("keyup",n$)}//Sliding with arrow keys, both, vertical and horizontal
...
"DOMMouseScroll"==n?iC[e](t+"MozMousePixelScroll",nX,i):iC[e](t+n,nX,i)},nU=/**
    ...
    */function(){eq().removeEventListener("mousedown",nK),eq().removeEventListener("mouseup",nQ)},nX=/**
     ...
     */function(e){var t=new Date().getTime(),n=B(z(iQ)[0],i6),i=nc(eq(),e);//is scroll allowed?
...
(t||r)&&(iM.shared.isNormalScrollElement||nZ(!1),iM.shared.isNormalScrollElement=!0,n=!0)}}),!n&&iM.shared.isNormalScrollElement&&(nZ(!0),iM.shared.isNormalScrollElement=!1))},n2=/**
    ...
    * Anchors or index positions can be used as params.
    */function(e,t){e9(0,"internal"),nO(e,t),e9(eF().scrollingSpeed,"internal")},n3=function(){clearTimeout(j),clearTimeout(I),em("resize",n4)},n4=/*
    * Resize event handler.
    */function(){r6||(!ez().autoScrolling||ez().scrollBar)&&ez().fitToSection||n5(F()),n9(),r6=!0,//http://stackoverflow.com/questions/4298612/jquery-how-to-call-resize-event-only-once-its-finished-resizing    
clearTimeout(j),j=setTimeout(function(){//issue #3336 
//(some apps or browsers, like Chrome/Firefox for Mobile take time to report the real height)
//so we check it 3 times with intervals in that case
// for(var i = 0; i< 4; i++){
n6(),r6=!1},400)},n9=function(){if(iA)// (some apps or browsers, like Chrome/Firefox will delay a bit to scroll 
...
ez().autoScrolling&&!ez().scrollBar&&(eP({isResizing:!0}),n2(iH.activeSection.index()+1),eP({isResizing:!1}))})},200*e)},n6=/**
...
eP({isResizing:!0,windowsHeight:F(),windowsWidth:W()});for(var t=e$().sections,n=0;n<t.length;++n){var i=t[n],r=z(rs,i.item)[0];i.slides.length>1&&tZ(r,i.activeSlide.item)}ez().scrollOverflow&&rH.makeScrollable();var o=e$().activeSection.index();!iH.isBeyondFullpage&&o&&n2(o+1),eP({isResizing:!1}),ey(ez().afterResize)&&e&&ez().afterResize.call(eq(),iE.innerWidth,iE.innerHeight),ey(ez().afterReBuild)&&!e&&ez().afterReBuild.call(eq()),eb(eq(),"afterRebuild")}},n8=/**
    ...
    */function(){var e=F(),t=W();(iH.windowsHeight!==e||r9!==t)&&(eP({windowsHeight:e}),r9=t,n7(!0))},n5=function(e){var t=""===e?"":e+"px";e$().sections.forEach(function(e){G(e.item,{height:t})})},ie=/**
...
,is=function(e){eP({scrollTrigger:"menu"}),z(ez().menu)[0]&&(ez().lockAnchors||!ez().anchors.length)&&(ep(e),/*jshint validthis:true */iN.emit(iR.onMenuClick,{anchor:ef(this,"data-menuanchor")}))},ia=function(e){var t=e.target;t&&i$(t,i8+" a")?t$.call(t,e.e):ew(t,re)?tM.call(t):(ew(t,rv)||null!=i$(t,rv))&&tv.call(t,e.e)},il=function(e){if(!iH.isResizing&&e$().activeSection&&(ek(e$().sections),!e$().isBeyondFullpage&&!e$().isAboutToScrollToFullPage&&(!ez().autoScrolling||ez().scrollBar))){var t=eu(),n=ic(t),i=0,r=t+F()/2,o=rD.scrollHeight-F()===t,s=e$().sections;if(eP({scrollY:t}),o)i=s.length-1;else if(t)for(var a=0;a<s.length;++a)s[a].item.offsetTop<=r&&(i=a);else i=0;//executing only once the first time we reach the section
...
anchorLink:e.anchor,sectionIndex:e.index(),items:{origin:e$().activeSection,destination:e$().activeSection}}),ey(ez().afterRender)&&tt("afterRender")},ig=/**
    ...
    */function(){var e=it(),t=e.section,n=e.slide;t?ez().animateAnchor?nk(t,n):n2(t,n):iN.emit(iR.onAfterRenderNoAnchor,null)},ib=/*
...
es(e)})}),G(eq(),{"-webkit-transition":"none",transition:"none"}),et(eq(),iq),iE.scrollTo(0,0),[iZ,rn,ra].forEach(function(e){et(z("."+e),e)})},iw=function(){t9(),t4(),ez().scrollBar=ez().scrollBar||ez().hybrid,eU(),ih(),im(!0),nZ(!0),tE(ez().autoScrolling,"internal"),tW(),tu(),"complete"===iC.readyState&&iy(),ev("load",iy),iv(),t9(),t4()},iS=/**
    * Displays warnings
...
onLeave:function(){clearTimeout(k),rH.isInnerScrollAllowed=!1},// Loading sections or slides
afterLoad:function(){rH.isInnerScrollAllowed=!1,clearTimeout(k),k=setTimeout(function(){rH.shouldFocusScrollable=iH.canScroll},200)},// Unfocusing the scrollable element from the orgin section/slide
...
!e||iA||ik||(this.focusedElem=e,// to avoid issue #4484 & #4493 on Safari
requestAnimationFrame(function(){e.focus(),rH.isInnerScrollAllowed=!0})),rH.shouldFocusScrollable=!1}},makeScrollable:function(){ez().scrollOverflowMacStyle&&!iL&&ee(rD,"fp-scroll-mac"),e$().panels.forEach(function(e){if((!e.slides||!e.slides.length)&&!(B(e.item,i4)&&tU())){var t=eX(e.item),n=rH.shouldBeScrollable(e.item),i=e.isSection?e:e.parent;if(i_){var r=n?"addClass":"removeClass";ij[r](i.item,rp),ij[r](e.item,rp)}else ee(i.item,rp),ee(e.item,rp);e.hasScroll||(rH.createWrapper(t),rH.bindEvents(t)),// this is executed on page load (after images load)
...
B(eX(t),"fp-noscroll"))return!0;var i=n.scrollTop,r="down"===e&&n.scrollHeight<=Math.ceil(n.offsetHeight+i)+(i_?1:0),o="up"===e&&i<=0||r;return o||(this.timeBeforeReachingLimit=new Date().getTime()),o},shouldMovePage:function(){this.timeLastScroll=new Date().getTime();var e=this.timeLastScroll-rH.timeBeforeReachingLimit,t=(iA||ik)&&iH.isGrabbing,n=iH.isUsingWheel&&e>600;return t&&e>400||n},onPanelScroll:(a=0,function(e){var t=e.target.scrollTop,n="none"!==iH.touchDirection?iH.touchDirection:a<t?"down":"up";a=t,ey(ez().onScrollOverflow)&&tt("onScrollOverflow",{position:t,direction:n}),B(e.target,ru)&&iH.canScroll&&rH.isScrolled(n,e.target)&&rH.shouldMovePage()&&rH.shouldBeScrollable(e$().activeSection.item)&&iN.emit(iR.onScrollOverflowScrolled,{direction:n})})};iM.landscapeScroll=tZ,iN.on(iR.bindEvents,function(){iN.on(iR.onPerformMovement,tQ)});var rR=null,rq=null,rz=function(e){var t=this;[].push.call(arguments,ez().sectionSelector),r_.apply(this,arguments),this.allSlidesItems=z(ez().slideSelector,e),this.slidesIncludingHidden=Array.from(this.allSlidesItems).map(function(e){return new rB(e,t)}),this.slides=this.slidesIncludingHidden.filter(function(e){return e.isVisible}),this.activeSlide=this.slides.length?this.slides.filter(function(e){return e.isActive})[0]||this.slides[0]:null};rz.prototype=r_.prototype,rz.prototype.constructor=rz;/**
    * Slide object
...
iE.fp_easings=iP(iE.fp_easings,{easeInOutCubic:function(e,t,n,i){return(e/=i/2)<1?n/2*e*e*e+t:n/2*((e-=2)*e*e+2)+t}}),iE.jQuery&&(T=iE.jQuery)&&ix&&(T.fn.fullpage=function(e){e=T.extend({},e,{$:T}),new ix(this[0],e),Object.keys(iM).forEach(function(e){ez().$.fn.fullpage[e]=iM[e]})}),ix)}();var x={body:{},addEventListener:function(){},removeEventListener:function(){},activeElement:{blur:function(){},nodeName:""},querySelector:function(){return null},querySelectorAll:function(){return[]},getElementById:function(){return null},createEvent:function(){return{initEvent:function(){}}},createElement:function(){return{children:[],childNodes:[],style:{},setAttribute:function(){},getElementsByTagName:function(){return[]}}},createElementNS:function(){return{}},importNode:function(){return null},location:{hash:"",host:"",hostname:"",href:"",origin:"",pathname:"",protocol:"",search:""}};function T(){var e="undefined"!=typeof document?document:{};return S(e,x),e}var E={document:x,navigator:{userAgent:""},location:{hash:"",host:"",hostname:"",href:"",origin:"",pathname:"",protocol:"",search:""},history:{replaceState:function(){},pushState:function(){},go:function(){},back:function(){}},CustomEvent:function(){return this},addEventListener:function(){},removeEventListener:function(){},getComputedStyle:function(){return{getPropertyValue:function(){return""}}},Image:function(){},Date:function(){},screen:{},setTimeout:function(){},clearTimeout:function(){},matchMedia:function(){return{}},requestAnimationFrame:function(e){return"undefined"==typeof setTimeout?(e(),null):setTimeout(e,0)},cancelAnimationFrame:function(e){"undefined"!=typeof setTimeout&&clearTimeout(e)}};function C(){var e="undefined"!=typeof window?window:{};return S(e,E),e}/**
 * Dom7 4.0.6
 ...
 */function A(e){if(void 0===e)throw ReferenceError("this hasn't been initialised - super() hasn't been called");return e}function L(e,t){return(L=Object.setPrototypeOf||function(e,t){return e.__proto__=t,e})(e,t)}var k=c("jFPEE");function _(e,t){return t&&("object"===(0,k._type_of)(t)||"function"==typeof t)?t:A(e)}function O(){if("undefined"==typeof Reflect||!Reflect.construct||Reflect.construct.sham)return!1;if("function"==typeof Proxy)return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch(e){return!1}}function M(e,t,n){return(M=O()?Reflect.construct:function(e,t,n){var i=[null];i.push.apply(i,t);var r=new(Function.bind.apply(e,i));return n&&L(r,n.prototype),r}).apply(null,arguments)}function D(e){return(D=Object.setPrototypeOf?Object.getPrototypeOf:function(e){return e.__proto__||Object.getPrototypeOf(e)})(e)}function P(e){var t="function"==typeof Map?new Map:void 0;return(P=function(e){if(null===e||-1===Function.toString.call(e).indexOf("[native code]"))return e;if("function"!=typeof e)throw TypeError("Super expression must either be null or a function");if(void 0!==t){if(t.has(e))return t.get(e);t.set(e,n)}function n(){return M(e,arguments,D(this).constructor)}return n.prototype=Object.create(e.prototype,{constructor:{value:n,enumerable:!1,writable:!0,configurable:!0}}),L(n,e)})(e)}var j=/*#__PURE__*/function(e){!function(e,t){if("function"!=typeof t&&null!==t)throw TypeError("Super expression must either be null or a function");e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),t&&L(e,t)}(i,e);var t,n=(t=O(),function(){var e,n=D(i);if(t){var r=D(this).constructor;e=Reflect.construct(n,arguments,r)}else e=n.apply(this,arguments);return _(this,e)});function i(e){var t,r,o;return(u(this,i),"number"==typeof e)?t=n.call(this,e):(o=(r=A(t=n.call.apply(n,[this].concat(b(e||[]))))).__proto__,Object.defineProperty(r,"__proto__",{get:function(){return o},set:function(e){o.__proto__=e}})),_(t)}return i}(P(Array));function I(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:[],t=[];return e.forEach(function(e){Array.isArray(e)?t.push.apply(t,b(I(e))):t.push(e)}),t}function N(e,t){return Array.prototype.filter.call(e,t)}function H(e,t){var n=C(),i=T(),r=[];if(!t&&e instanceof j)return e;if(!e)return new j(r);if("string"==typeof e){var o=e.trim();if(o.indexOf("<")>=0&&o.indexOf(">")>=0){var s="div";0===o.indexOf("<li")&&(s="ul"),0===o.indexOf("<tr")&&(s="tbody"),(0===o.indexOf("<td")||0===o.indexOf("<th"))&&(s="tr"),0===o.indexOf("<tbody")&&(s="table"),0===o.indexOf("<option")&&(s="select");var a=i.createElement(s);a.innerHTML=o;for(var l=0;l<a.childNodes.length;l+=1)r.push(a.childNodes[l])}else r=// eslint-disable-next-line
...
}else if(e.nodeType||e===n||e===i)r.push(e);else if(Array.isArray(e)){if(e instanceof j)return e;r=e}return new j(function(e){for(var t=[],n=0;n<e.length;n+=1)-1===t.indexOf(e[n])&&t.push(e[n]);return t}(r))}H.fn=j.prototype;var R="resize scroll".split(" ");function q(e){return function(){for(var t=arguments.length,n=Array(t),i=0;i<t;i++)n[i]=arguments[i];if(void 0===n[0]){for(var r=0;r<this.length;r+=1)0>R.indexOf(e)&&(e in this[r]?this[r][e]():H(this[r]).trigger(e));return this}return this.on.apply(this,[e].concat(b(n)))}}q("click"),q("blur"),q("focus"),q("focusin"),q("focusout"),q("keyup"),q("keydown"),q("keypress"),q("submit"),q("change"),q("mousedown"),q("mousemove"),q("mouseup"),q("mouseenter"),q("mouseleave"),q("mouseout"),q("mouseover"),q("touchstart"),q("touchend"),q("touchmove"),q("resize"),q("scroll");var z={addClass:// eslint-disable-next-line
function(){for(var e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n];var i=I(t.map(function(e){return e.split(" ")}));return this.forEach(function(e){var t;(t=e.classList).add.apply(t,b(i))}),this},removeClass:function(){for(var e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n];var i=I(t.map(function(e){return e.split(" ")}));return this.forEach(function(e){var t;(t=e.classList).remove.apply(t,b(i))}),this},hasClass:function(){for(var e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n];var i=I(t.map(function(e){return e.split(" ")}));return N(this,function(e){return i.filter(function(t){return e.classList.contains(t)}).length>0}).length>0},toggleClass:function(){for(var e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n];var i=I(t.map(function(e){return e.split(" ")}));this.forEach(function(e){i.forEach(function(t){e.classList.toggle(t)})})},attr:function(e,t){if(1==arguments.length&&"string"==typeof e)return(// Get attr
this[0]?this[0].getAttribute(e):void 0);// Set attrs
for(var n=0;n<this.length;n+=1)if(2==arguments.length)this[n].setAttribute(e,t);else for(var i in e)this[n][i]=e[i],this[n].setAttribute(i,e[i]);return this},removeAttr:function(e){for(var t=0;t<this.length;t+=1)this[t].removeAttribute(e);return this},transform:function(e){for(var t=0;t<this.length;t+=1)this[t].style.transform=e;return this},transition:function(e){for(var t=0;t<this.length;t+=1)this[t].style.transitionDuration="string"!=typeof e?"".concat(e,"ms"):e;return this},on:function(){for(var e,t,n=arguments.length,i=Array(n),r=0;r<n;r++)i[r]=arguments[r];var o=function(e){var t=e.target;if(t){var n=e.target.dom7EventData||[];if(0>n.indexOf(e)&&n.unshift(e),H(t).is(c))u.apply(t,n);else for(var i=H(t).parents(),r=0;r<i.length;r+=1)H(i[r]).is(c)&&u.apply(i[r],n)}},s=function(e){var t=e&&e.target&&e.target.dom7EventData||[];0>t.indexOf(e)&&t.unshift(e),u.apply(this,t)},a=y(i,4),l=a[0],c=a[1],u=a[2],d=a[3];"function"==typeof i[1]&&(l=(e=y(i,3))[0],u=e[1],d=e[2],c=void 0),d||(d=!1);for(var p=l.split(" "),f=0;f<this.length;f+=1){var h=this[f];if(c)for(t=0;t<p.length;t+=1){var v=p[t];h.dom7LiveListeners||(h.dom7LiveListeners={}),h.dom7LiveListeners[v]||(h.dom7LiveListeners[v]=[]),h.dom7LiveListeners[v].push({listener:u,proxyListener:o}),h.addEventListener(v,o,d)}else for(t=0;t<p.length;t+=1){var g=p[t];h.dom7Listeners||(h.dom7Listeners={}),h.dom7Listeners[g]||(h.dom7Listeners[g]=[]),h.dom7Listeners[g].push({listener:u,proxyListener:s}),h.addEventListener(g,s,d)}}return this},off:function(){for(var e,t=arguments.length,n=Array(t),i=0;i<t;i++)n[i]=arguments[i];var r=y(n,4),o=r[0],s=r[1],a=r[2],l=r[3];"function"==typeof n[1]&&(o=(e=y(n,3))[0],a=e[1],l=e[2],s=void 0),l||(l=!1);for(var c=o.split(" "),u=0;u<c.length;u+=1)for(var d=c[u],p=0;p<this.length;p+=1){var f=this[p],h=void 0;if(!s&&f.dom7Listeners?h=f.dom7Listeners[d]:s&&f.dom7LiveListeners&&(h=f.dom7LiveListeners[d]),h&&h.length)for(var v=h.length-1;v>=0;v-=1){var g=h[v];a&&g.listener===a?(f.removeEventListener(d,g.proxyListener,l),h.splice(v,1)):a&&g.listener&&g.listener.dom7proxy&&g.listener.dom7proxy===a?(f.removeEventListener(d,g.proxyListener,l),h.splice(v,1)):a||(f.removeEventListener(d,g.proxyListener,l),h.splice(v,1))}}return this},trigger:function(){for(var e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n];for(var i=C(),r=t[0].split(" "),o=t[1],s=0;s<r.length;s+=1)for(var a=r[s],l=0;l<this.length;l+=1){var c=this[l];if(i.CustomEvent){var u=new i.CustomEvent(a,{detail:o,bubbles:!0,cancelable:!0});c.dom7EventData=t.filter(function(e,t){return t>0}),c.dispatchEvent(u),c.dom7EventData=[],delete c.dom7EventData}}return this},transitionEnd:function(e){var t=this;return e&&t.on("transitionend",function n(i){i.target===this&&(e.call(this,i),t.off("transitionend",n))}),this},outerWidth:function(e){if(this.length>0){if(e){var t=this.styles();return this[0].offsetWidth+parseFloat(t.getPropertyValue("margin-right"))+parseFloat(t.getPropertyValue("margin-left"))}return this[0].offsetWidth}return null},outerHeight:function(e){if(this.length>0){if(e){var t=this.styles();return this[0].offsetHeight+parseFloat(t.getPropertyValue("margin-top"))+parseFloat(t.getPropertyValue("margin-bottom"))}return this[0].offsetHeight}return null},styles:function(){var e=C();return this[0]?e.getComputedStyle(this[0],null):{}},offset:function(){if(this.length>0){var e=C(),t=T(),n=this[0],i=n.getBoundingClientRect(),r=t.body,o=n.clientTop||r.clientTop||0,s=n.clientLeft||r.clientLeft||0,a=n===e?e.scrollY:n.scrollTop,l=n===e?e.scrollX:n.scrollLeft;return{top:i.top+a-o,left:i.left+l-s}}return null},css:function(e,t){var n,i=C();if(1==arguments.length){if("string"==typeof e)// .css('width')
...
for(n=0;n<this.length;n+=1)this[n].style[e]=t;return this},each:function(e){return e&&this.forEach(function(t,n){e.apply(t,[t,n])}),this},html:function(e){if(void 0===e)return this[0]?this[0].innerHTML:null;for(var t=0;t<this.length;t+=1)this[t].innerHTML=e;return this},text:function(e){if(void 0===e)return this[0]?this[0].textContent.trim():null;for(var t=0;t<this.length;t+=1)this[t].textContent=e;return this},is:function(e){var t,n,i=C(),r=T(),o=this[0];if(!o||void 0===e)return!1;if("string"==typeof e){if(o.matches)return o.matches(e);if(o.webkitMatchesSelector)return o.webkitMatchesSelector(e);if(o.msMatchesSelector)return o.msMatchesSelector(e);for(n=0,t=H(e);n<t.length;n+=1)if(t[n]===o)return!0;return!1}if(e===r)return o===r;if(e===i)return o===i;if(e.nodeType||e instanceof j){for(n=0,t=e.nodeType?[e]:e;n<t.length;n+=1)if(t[n]===o)return!0}return!1},index:function(){var e,t=this[0];if(t){for(e=0;null!==(t=t.previousSibling);)1===t.nodeType&&(e+=1);return e}},eq:function(e){if(void 0===e)return this;var t=this.length;if(e>t-1)return H([]);if(e<0){var n=t+e;return n<0?H([]):H([this[n]])}return H([this[e]])},append:function(){for(var e,t=arguments.length,n=Array(t),i=0;i<t;i++)n[i]=arguments[i];for(var r=T(),o=0;o<n.length;o+=1){e=n[o];for(var s=0;s<this.length;s+=1)if("string"==typeof e){var a=r.createElement("div");for(a.innerHTML=e;a.firstChild;)this[s].appendChild(a.firstChild)}else if(e instanceof j)for(var l=0;l<e.length;l+=1)this[s].appendChild(e[l]);else this[s].appendChild(e)}return this},prepend:function(e){var t,n,i=T();for(t=0;t<this.length;t+=1)if("string"==typeof e){var r=i.createElement("div");for(r.innerHTML=e,n=r.childNodes.length-1;n>=0;n-=1)this[t].insertBefore(r.childNodes[n],this[t].childNodes[0])}else if(e instanceof j)for(n=0;n<e.length;n+=1)this[t].insertBefore(e[n],this[t].childNodes[0]);else this[t].insertBefore(e,this[t].childNodes[0]);return this},next:function(e){if(this.length>0){if(e)return this[0].nextElementSibling&&H(this[0].nextElementSibling).is(e)?H([this[0].nextElementSibling]):H([]);if(this[0].nextElementSibling)return H([this[0].nextElementSibling])}return H([])},nextAll:function(e){var t=[],n=this[0];if(!n)return H([]);for(;n.nextElementSibling;){var i=n.nextElementSibling;// eslint-disable-line
e?H(i).is(e)&&t.push(i):t.push(i),n=i}return H(t)},prev:function(e){if(this.length>0){var t=this[0];if(e)return t.previousElementSibling&&H(t.previousElementSibling).is(e)?H([t.previousElementSibling]):H([]);if(t.previousElementSibling)return H([t.previousElementSibling])}return H([])},prevAll:function(e){var t=[],n=this[0];if(!n)return H([]);for(;n.previousElementSibling;){var i=n.previousElementSibling;// eslint-disable-line
e?H(i).is(e)&&t.push(i):t.push(i),n=i}return H(t)},parent:function(e){for(var t=[],n=0;n<this.length;n+=1)null!==this[n].parentNode&&(e?H(this[n].parentNode).is(e)&&t.push(this[n].parentNode):t.push(this[n].parentNode));return H(t)},parents:function(e){for(var t=[],n=0;n<this.length;n+=1)for(var i=this[n].parentNode;i;)e?H(i).is(e)&&t.push(i):t.push(i),i=i.parentNode;return H(t)},closest:function(e){var t=this;// eslint-disable-line
return void 0===e?H([]):(t.is(e)||(t=t.parents(e).eq(0)),t)},find:function(e){for(var t=[],n=0;n<this.length;n+=1)for(var i=this[n].querySelectorAll(e),r=0;r<i.length;r+=1)t.push(i[r]);return H(t)},children:function(e){for(var t=[],n=0;n<this.length;n+=1)for(var i=this[n].children,r=0;r<i.length;r+=1)(!e||H(i[r]).is(e))&&t.push(i[r]);return H(t)},filter:function(e){return H(N(this,e))},remove:function(){for(var e=0;e<this.length;e+=1)this[e].parentNode&&this[e].parentNode.removeChild(this[e]);return this}};function B(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function F(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0;return setTimeout(e,t)}function W(){return Date.now()}function G(e){return"object"==typeof e&&null!==e&&e.constructor&&"Object"===Object.prototype.toString.call(e).slice(8,-1)}function U(){for(var e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n];for(var i=Object(t[0]),r=["__proto__","constructor","prototype"],o=1;o<t.length;o+=1)!function(e){var n=t[e];if(null!=n&&// eslint-disable-next-line
("undefined"!=typeof window&&void 0!==window.HTMLElement?!(n instanceof HTMLElement):!n||1!==n.nodeType&&11!==n.nodeType))for(var o=Object.keys(Object(n)).filter(function(e){return 0>r.indexOf(e)}),s=0,a=o.length;s<a;s+=1){var l=o[s],c=Object.getOwnPropertyDescriptor(n,l);void 0!==c&&c.enumerable&&(G(i[l])&&G(n[l])?n[l].__swiper__?i[l]=n[l]:U(i[l],n[l]):!G(i[l])&&G(n[l])?(i[l]={},n[l].__swiper__?i[l]=n[l]:U(i[l],n[l])):i[l]=n[l])}}(o);return i}function V(e,t,n){e.style.setProperty(t,n)}function Y(e){var t,n=e.swiper,i=e.targetPosition,r=e.side,o=C(),s=-n.translate,a=null,l=n.params.speed;n.wrapperEl.style.scrollSnapType="none",o.cancelAnimationFrame(n.cssModeFrameID);var c=i>s?"next":"prev",u=function(e,t){return"next"===c&&e>=t||"prev"===c&&e<=t},d=function(){t=new Date().getTime(),null===a&&(a=t);var e=s+(.5-Math.cos(Math.max(Math.min((t-a)/l,1),0)*Math.PI)/2)*(i-s);if(u(e,i)&&(e=i),n.wrapperEl.scrollTo(B({},r,e)),u(e,i)){n.wrapperEl.style.overflow="hidden",n.wrapperEl.style.scrollSnapType="",setTimeout(function(){n.wrapperEl.style.overflow="",n.wrapperEl.scrollTo(B({},r,e))}),o.cancelAnimationFrame(n.cssModeFrameID);return}n.cssModeFrameID=o.requestAnimationFrame(d)};d()}function X(){if(!i){var e,t;e=C(),i={smoothScroll:(t=T()).documentElement&&"scrollBehavior"in t.documentElement.style,touch:!!("ontouchstart"in e||e.DocumentTouch&&t instanceof e.DocumentTouch),passiveListener:function(){var t=!1;try{var n=Object.defineProperty({},"passive",{// eslint-disable-next-line
get:function(){t=!0}});e.addEventListener("testPassiveListener",null,n)}catch(e){}return t}(),gestures:"ongesturestart"in e}}return i}function K(e){var t=e.swiper,n=e.runCallbacks,i=e.direction,r=e.step,o=t.activeIndex,s=t.previousIndex,a=i;if(a||(a=o>s?"next":o<s?"prev":"reset"),t.emit("transition".concat(r)),n&&o!==s){if("reset"===a){t.emit("slideResetTransition".concat(r));return}t.emit("slideChangeTransition".concat(r)),"next"===a?t.emit("slideNextTransition".concat(r)):t.emit("slidePrevTransition".concat(r))}}Object.keys(z).forEach(function(e){Object.defineProperty(H.fn,e,{value:z[e],writable:!0})});var k=c("jFPEE");function Q(e){var t=T(),n=C(),i=this.touchEventsData,r=this.params,o=this.touches;if(this.enabled&&(!this.animating||!r.preventInteractionOnTransition)){!this.animating&&r.cssMode&&r.loop&&this.loopFix();var s=e;s.originalEvent&&(s=s.originalEvent);var a=H(s.target);if(("wrapper"!==r.touchEventsTarget||a.closest(this.wrapperEl).length)&&(i.isTouchEvent="touchstart"===s.type,(i.isTouchEvent||!("which"in s)||3!==s.which)&&(i.isTouchEvent||!("button"in s)||!(s.button>0))&&(!i.isTouched||!i.isMoved))){r.noSwipingClass&&""!==r.noSwipingClass&&s.target&&s.target.shadowRoot&&e.path&&e.path[0]&&(a=H(e.path[0]));var l=r.noSwipingSelector?r.noSwipingSelector:".".concat(r.noSwipingClass),c=!!(s.target&&s.target.shadowRoot);if(r.noSwiping&&(c?function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:this;return function t(n){return n&&n!==T()&&n!==C()?(n.assignedSlot&&(n=n.assignedSlot),n.closest(e)||t(n.getRootNode().host)):null}(t)}(l,s.target):a.closest(l)[0])){this.allowClick=!0;return}if(r.swipeHandler&&!a.closest(r.swipeHandler)[0])return;o.currentX="touchstart"===s.type?s.targetTouches[0].pageX:s.pageX,o.currentY="touchstart"===s.type?s.targetTouches[0].pageY:s.pageY;var u=o.currentX,d=o.currentY,p=r.edgeSwipeDetection||r.iOSEdgeSwipeDetection,f=r.edgeSwipeThreshold||r.iOSEdgeSwipeThreshold;if(p&&(u<=f||u>=n.innerWidth-f)){if("prevent"!==p)return;e.preventDefault()}if(Object.assign(i,{isTouched:!0,isMoved:!1,allowTouchCallbacks:!0,isScrolling:void 0,startMoving:void 0}),o.startX=u,o.startY=d,i.touchStartTime=W(),this.allowClick=!0,this.updateSize(),this.swipeDirection=void 0,r.threshold>0&&(i.allowThresholdMove=!1),"touchstart"!==s.type){var h=!0;a.is(i.focusableElements)&&(h=!1),t.activeElement&&H(t.activeElement).is(i.focusableElements)&&t.activeElement!==a[0]&&t.activeElement.blur();var v=h&&this.allowTouchMove&&r.touchStartPreventDefault;(r.touchStartForcePreventDefault||v)&&!a[0].isContentEditable&&s.preventDefault()}this.emit("touchStart",s)}}}function Z(e){var t,n=T(),i=this.touchEventsData,r=this.params,o=this.touches,s=this.rtlTranslate;if(!!this.enabled){var a=e;if(a.originalEvent&&(a=a.originalEvent),!i.isTouched){i.startMoving&&i.isScrolling&&this.emit("touchMoveOpposite",a);return}if(!i.isTouchEvent||"touchmove"===a.type){var l="touchmove"===a.type&&a.targetTouches&&(a.targetTouches[0]||a.changedTouches[0]),c="touchmove"===a.type?l.pageX:a.pageX,u="touchmove"===a.type?l.pageY:a.pageY;if(a.preventedByNestedSwiper){o.startX=c,o.startY=u;return}if(!this.allowTouchMove){// isMoved = true;
this.allowClick=!1,i.isTouched&&(Object.assign(o,{startX:c,startY:u,currentX:c,currentY:u}),i.touchStartTime=W());return}if(i.isTouchEvent&&r.touchReleaseOnEdges&&!r.loop){if(this.isVertical()){if(u<o.startY&&this.translate<=this.maxTranslate()||u>o.startY&&this.translate>=this.minTranslate()){i.isTouched=!1,i.isMoved=!1;return}}else if(c<o.startX&&this.translate<=this.maxTranslate()||c>o.startX&&this.translate>=this.minTranslate())return}if(i.isTouchEvent&&n.activeElement&&a.target===n.activeElement&&H(a.target).is(i.focusableElements)){i.isMoved=!0,this.allowClick=!1;return}if(i.allowTouchCallbacks&&this.emit("touchMove",a),!a.targetTouches||!(a.targetTouches.length>1)){o.currentX=c,o.currentY=u;var d=o.currentX-o.startX,p=o.currentY-o.startY;if(!(this.params.threshold&&Math.sqrt(Math.pow(d,2)+Math.pow(p,2))<this.params.threshold)){if(void 0===i.isScrolling&&(this.isHorizontal()&&o.currentY===o.startY||this.isVertical()&&o.currentX===o.startX?i.isScrolling=!1:d*d+p*p>=25&&(t=180*Math.atan2(Math.abs(p),Math.abs(d))/Math.PI,i.isScrolling=this.isHorizontal()?t>r.touchAngle:90-t>r.touchAngle)),i.isScrolling&&this.emit("touchMoveOpposite",a),void 0===i.startMoving&&(o.currentX!==o.startX||o.currentY!==o.startY)&&(i.startMoving=!0),i.isScrolling){i.isTouched=!1;return}if(i.startMoving){this.allowClick=!1,!r.cssMode&&a.cancelable&&a.preventDefault(),r.touchMoveStopPropagation&&!r.nested&&a.stopPropagation(),i.isMoved||(r.loop&&!r.cssMode&&this.loopFix(),i.startTranslate=this.getTranslate(),this.setTransition(0),this.animating&&this.$wrapperEl.trigger("webkitTransitionEnd transitionend"),i.allowMomentumBounce=!1,r.grabCursor&&(!0===this.allowSlideNext||!0===this.allowSlidePrev)&&this.setGrabCursor(!0),this.emit("sliderFirstMove",a)),this.emit("sliderMove",a),i.isMoved=!0;var f=this.isHorizontal()?d:p;o.diff=f,f*=r.touchRatio,s&&(f=-f),this.swipeDirection=f>0?"prev":"next",i.currentTranslate=f+i.startTranslate;var h=!0,v=r.resistanceRatio;// Threshold
...
}function et(e){this.enabled&&!this.allowClick&&(this.params.preventClicks&&e.preventDefault(),this.params.preventClicksPropagation&&this.animating&&(e.stopPropagation(),e.stopImmediatePropagation()))}function en(){var e=this.wrapperEl,t=this.rtlTranslate;if(this.enabled){this.previousTranslate=this.translate,this.isHorizontal()?this.translate=-e.scrollLeft:this.translate=-e.scrollTop,-0===this.translate&&(this.translate=0),this.updateActiveIndex(),this.updateSlidesClasses();var n=this.maxTranslate()-this.minTranslate();(0===n?0:(this.translate-this.minTranslate())/n)!==this.progress&&this.updateProgress(t?-this.translate:this.translate),this.emit("setTranslate",this.translate,!1)}}var ei=!1;function er(){}var eo=function(e,t){var n=T(),i=e.params,r=e.touchEvents,o=e.el,s=e.wrapperEl,a=e.device,l=e.support,c=!!i.nested,u="on"===t?"addEventListener":"removeEventListener";if(l.touch){var d="touchstart"===r.start&&!!l.passiveListener&&!!i.passiveListeners&&{passive:!0,capture:!1};o[u](r.start,e.onTouchStart,d),o[u](r.move,e.onTouchMove,l.passiveListener?{passive:!1,capture:c}:c),o[u](r.end,e.onTouchEnd,d),r.cancel&&o[u](r.cancel,e.onTouchEnd,d)}else o[u](r.start,e.onTouchStart,!1),n[u](r.move,e.onTouchMove,c),n[u](r.end,e.onTouchEnd,!1);// Prevent Links Clicks
(i.preventClicks||i.preventClicksPropagation)&&o[u]("click",e.onClick,!0),i.cssMode&&s[u]("scroll",e.onScroll),i.updateOnWindowResize?e[t](a.ios||a.android?"resize orientationchange observerUpdate":"resize observerUpdate",ee,!0):e[t]("observerUpdate",ee,!0)},es=function(e,t){return e.grid&&t.grid&&t.grid.rows>1},ea={init:!0,direction:"horizontal",touchEventsTarget:"wrapper",initialSlide:0,speed:300,cssMode:!1,updateOnWindowResize:!0,resizeObserver:!0,nested:!1,createElements:!1,enabled:!0,focusableElements:"input, select, option, textarea, button, video, label",// Overrides
...
i.push.apply(i,b(c)),s.addClass(b(i).join(" ")),this.emitContainerClasses()},removeClasses:function(){var e=this.$el,t=this.classNames;e.removeClass(t.join(" ")),this.emitContainerClasses()}},images:{loadImage:function(e,t,n,i,r,o){var s,a=function(){o&&o()},l=C();H(e).parent("picture")[0]||e.complete&&r?a():t?((s=new l.Image).onload=a,s.onerror=a,i&&(s.sizes=i),n&&(s.srcset=n),t&&(s.src=t)):a()},preloadImages:function(){var e=function(){null!=t&&t&&!t.destroyed&&(void 0!==t.imagesLoaded&&(t.imagesLoaded+=1),t.imagesLoaded===t.imagesToLoad.length&&(t.params.updateOnImagesReady&&t.update(),t.emit("imagesReady")))},t=this;t.imagesToLoad=t.$el.find("img");for(var n=0;n<t.imagesToLoad.length;n+=1){var i=t.imagesToLoad[n];t.loadImage(i,i.currentSrc||i.getAttribute("src"),i.srcset||i.getAttribute("srcset"),i.sizes||i.getAttribute("sizes"),!0,e)}}}},ec={},eu=/*#__PURE__*/function(){function e(){for(var t,n,i,s,a=arguments.length,l=Array(a),c=0;c<a;c++)l[c]=arguments[c];if(u(this,e),1===l.length&&l[0].constructor&&"Object"===Object.prototype.toString.call(l[0]).slice(8,-1)?i=l[0]:(n=(s=y(l,2))[0],i=s[1]),i||(i={}),i=U({},i),n&&!i.el&&(i.el=n),i.el&&H(i.el).length>1){var d=[];return H(i.el).each(function(t){var n=U({},i,{el:t});d.push(new e(n))}),d}// Swiper Instance
var p=this;p.__swiper__=!0,p.support=X(),p.device=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};return r||(r=function(){var e=(arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}).userAgent,t=X(),n=C(),i=n.navigator.platform,r=e||n.navigator.userAgent,o={ios:!1,android:!1},s=n.screen.width,a=n.screen.height,l=r.match(/(Android);?[\s\/]+([\d.]+)?/),c=r.match(/(iPad).*OS\s([\d_]+)/),u=r.match(/(iPod)(.*OS\s([\d_]+))?/),d=!c&&r.match(/(iPhone\sOS|iOS)\s([\d_]+)/),p="MacIntel"===i;return!c&&p&&t.touch&&["1024x1366","1366x1024","834x1194","1194x834","834x1112","1112x834","768x1024","1024x768","820x1180","1180x820","810x1080","1080x810"].indexOf("".concat(s,"x").concat(a))>=0&&((c=r.match(/(Version)\/([\d.]+)/))||(c=[0,1,"13_0_0"]),p=!1),l&&"Win32"!==i&&(o.os="android",o.android=!0),(c||d||u)&&(o.os="ios",o.ios=!0),o}(e)),r}({userAgent:i.userAgent}),p.browser=function(){if(!o){var e,t;o={isSafari:(t=(e=C()).navigator.userAgent.toLowerCase()).indexOf("safari")>=0&&0>t.indexOf("chrome")&&0>t.indexOf("android"),isWebView:/(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/i.test(e.navigator.userAgent)}}return o}(),p.eventsListeners={},p.eventsAnyListeners=[],p.modules=b(p.__modules__),i.modules&&Array.isArray(i.modules)&&(t=p.modules).push.apply(t,b(i.modules));var f={};p.modules.forEach(function(e){var t;e({swiper:p,extendParams:(t=i,function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},n=Object.keys(e)[0],i=e[n];if("object"!=typeof i||null===i||(["navigation","pagination","scrollbar"].indexOf(n)>=0&&!0===t[n]&&(t[n]={auto:!0}),!(n in t&&"enabled"in i))){U(f,e);return}!0===t[n]&&(t[n]={enabled:!0}),"object"!=typeof t[n]||"enabled"in t[n]||(t[n].enabled=!0),t[n]||(t[n]={enabled:!1}),U(f,e)}),on:p.on.bind(p),once:p.once.bind(p),off:p.off.bind(p),emit:p.emit.bind(p)})});var h=U({},ea,f);// Extend defaults with passed params
// Return app instance
return p.params=U({},h,ec,i),p.originalParams=U({},p.params),p.passedParams=U({},i),p.params&&p.params.on&&Object.keys(p.params.on).forEach(function(e){p.on(e,p.params.on[e])}),p.params&&p.params.onAny&&p.onAny(p.params.onAny),// Save Dom lib
p.$=H,Object.assign(p,{enabled:p.params.enabled,el:n,// Classes
classNames:[],// Slides
slides:H(),slidesGrid:[],snapGrid:[],slidesSizesGrid:[],// isDirection
...
lastClickTime:W(),clickTimeout:void 0,// Velocities
...
var n=H(e||t.params.el);if(!(e=n[0]))return!1;e.swiper=t;var i=function(){return".".concat((t.params.wrapperClass||"").trim().split(" ").join("."))},r=function(){if(e&&e.shadowRoot&&e.shadowRoot.querySelector){var t=H(e.shadowRoot.querySelector(i()));// Children needs to return slot items
return t.children=function(e){return n.children(e)},t}return n.children(i())}();if(0===r.length&&t.params.createElements){var o=T().createElement("div");r=H(o),o.className=t.params.wrapperClass,n.append(o),n.children(".".concat(t.params.slideClass)).each(function(e){r.append(e)})}return Object.assign(t,{$el:n,el:e,$wrapperEl:r,wrapperEl:r[0],mounted:!0,// RTL
...
this.attachEvents(),this.initialized=!0,this.emit("init"),this.emit("afterInit")),this}},{key:"destroy",value:function(){var e=!(arguments.length>0)||void 0===arguments[0]||arguments[0],t=!(arguments.length>1)||void 0===arguments[1]||arguments[1],n=this,i=n.params,r=n.$el,o=n.$wrapperEl,s=n.slides;return void 0===n.params||n.destroyed||(n.emit("beforeDestroy"),n.initialized=!1,n.detachEvents(),i.loop&&n.loopDestroy(),t&&(n.removeClasses(),r.removeAttr("style"),o.removeAttr("style"),s&&s.length&&s.removeClass([i.slideVisibleClass,i.slideActiveClass,i.slideNextClass,i.slidePrevClass].join(" ")).removeAttr("style").removeAttr("data-swiper-slide-index")),n.emit("destroy"),Object.keys(n.eventsListeners).forEach(function(e){n.off(e)}),!1!==e&&(n.$el[0].swiper=null,function(e){Object.keys(e).forEach(function(t){try{e[t]=null}catch(e){}try{delete e[t]}catch(e){}})}(n)),n.destroyed=!0),null}}],[{key:"extendDefaults",value:function(e){U(ec,e)}},{key:"extendedDefaults",get:function(){return ec}},{key:"defaults",get:function(){return ea}},{key:"installModule",value:function(t){e.prototype.__modules__||(e.prototype.__modules__=[]);var n=e.prototype.__modules__;"function"==typeof t&&0>n.indexOf(t)&&n.push(t)}},{key:"use",value:function(t){return Array.isArray(t)?t.forEach(function(t){return e.installModule(t)}):e.installModule(t),e}}]),e}();function ed(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"";return".".concat(e.trim().replace(/([\.:!\/])/g,"\\$1")// eslint-disable-line
.replace(/ /g,"."))}function ep(e){var t,n=e.swiper,i=e.extendParams,r=e.on,o=e.emit,s=function(){return!n.params.pagination.el||!n.pagination.el||!n.pagination.$el||0===n.pagination.$el.length},a=function(e,t){var i=n.params.pagination.bulletActiveClass;e[t]().addClass("".concat(i,"-").concat(t))[t]().addClass("".concat(i,"-").concat(t,"-").concat(t))},l=function(){// Render || Update Pagination bullets/items
...
if(n.params.loop?((u=Math.ceil((n.activeIndex-n.loopedSlides)/n.params.slidesPerGroup))>r-1-2*n.loopedSlides&&(u-=r-2*n.loopedSlides),u>c-1&&(u-=c),u<0&&"bullets"!==n.params.paginationType&&(u=c+u)):u=void 0!==n.snapIndex?n.snapIndex:n.activeIndex||0,"bullets"===i.type&&n.pagination.bullets&&n.pagination.bullets.length>0){var u,d,p,h,v=n.pagination.bullets;if(i.dynamicBullets&&(t=v.eq(0)[n.isHorizontal()?"outerWidth":"outerHeight"](!0),l.css(n.isHorizontal()?"width":"height","".concat(t*(i.dynamicMainBullets+4),"px")),i.dynamicMainBullets>1&&void 0!==n.previousIndex&&((f+=u-(n.previousIndex-n.loopedSlides||0))>i.dynamicMainBullets-1?f=i.dynamicMainBullets-1:f<0&&(f=0)),h=((p=(d=Math.max(u-f,0))+(Math.min(v.length,i.dynamicMainBullets)-1))+d)/2),v.removeClass(["","-next","-next-next","-prev","-prev-prev","-main"].map(function(e){return"".concat(i.bulletActiveClass).concat(e)}).join(" ")),l.length>1)v.each(function(e){var t=H(e),n=t.index();n===u&&t.addClass(i.bulletActiveClass),i.dynamicBullets&&(n>=d&&n<=p&&t.addClass("".concat(i.bulletActiveClass,"-main")),n===d&&a(t,"prev"),n===p&&a(t,"next"))});else{var g=v.eq(u),m=g.index();if(g.addClass(i.bulletActiveClass),i.dynamicBullets){for(var y=v.eq(d),b=v.eq(p),w=d;w<=p;w+=1)v.eq(w).addClass("".concat(i.bulletActiveClass,"-main"));if(n.params.loop){if(m>=v.length){for(var S=i.dynamicMainBullets;S>=0;S-=1)v.eq(v.length-S).addClass("".concat(i.bulletActiveClass,"-main"));v.eq(v.length-i.dynamicMainBullets-1).addClass("".concat(i.bulletActiveClass,"-prev"))}else a(y,"prev"),a(b,"next")}else a(y,"prev"),a(b,"next")}}if(i.dynamicBullets){var x=Math.min(v.length,i.dynamicMainBullets+4),T=(t*x-t)/2-h*t;v.css(n.isHorizontal()?e?"right":"left":"top","".concat(T,"px"))}}if("fraction"===i.type&&(l.find(ed(i.currentClass)).text(i.formatFractionCurrent(u+1)),l.find(ed(i.totalClass)).text(i.formatFractionTotal(c))),"progressbar"===i.type){E=i.progressbarOpposite?n.isHorizontal()?"vertical":"horizontal":n.isHorizontal()?"horizontal":"vertical";var E,C=(u+1)/c,A=1,L=1;"horizontal"===E?A=C:L=C,l.find(ed(i.progressbarFillClass)).transform("translate3d(0,0,0) scaleX(".concat(A,") scaleY(").concat(L,")")).transition(n.params.speed)}"custom"===i.type&&i.renderCustom?(l.html(i.renderCustom(n,u+1,c)),o("paginationRender",l[0])):o("paginationUpdate",l[0]),n.params.watchOverflow&&n.enabled&&l[n.isLocked?"addClass":"removeClass"](i.lockClass)}},c=function(){// Render Container
var e=n.params.pagination;if(!s()){var t=n.virtual&&n.params.virtual.enabled?n.virtual.slides.length:n.slides.length,i=n.pagination.$el,r="";if("bullets"===e.type){var a=n.params.loop?Math.ceil((t-2*n.loopedSlides)/n.params.slidesPerGroup):n.snapGrid.length;n.params.freeMode&&n.params.freeMode.enabled&&!n.params.loop&&a>t&&(a=t);for(var l=0;l<a;l+=1)e.renderBullet?r+=e.renderBullet.call(n,l,e.bulletClass):r+="<".concat(e.bulletElement,' class="').concat(e.bulletClass,'"></').concat(e.bulletElement,">");i.html(r),n.pagination.bullets=i.find(ed(e.bulletClass))}"fraction"===e.type&&(r=e.renderFraction?e.renderFraction.call(n,e.currentClass,e.totalClass):'<span class="'.concat(e.currentClass,'"></span>')+" / "+'<span class="'.concat(e.totalClass,'"></span>'),i.html(r)),"progressbar"===e.type&&(r=e.renderProgressbar?e.renderProgressbar.call(n,e.progressbarFillClass):'<span class="'.concat(e.progressbarFillClass,'"></span>'),i.html(r)),"custom"!==e.type&&o("paginationRender",n.pagination.$el[0])}},u=function(){n.params.pagination=(e=n.originalParams.pagination,t=n.params.pagination,i={el:"swiper-pagination"},r=T(),n.params.createElements&&Object.keys(i).forEach(function(o){if(!t[o]&&!0===t.auto){var s=n.$el.children(".".concat(i[o]))[0];s||((s=r.createElement("div")).className=i[o],n.$el.append(s)),t[o]=s,e[o]=s}}),t);var e,t,i,r,o=n.params.pagination;if(o.el){var s=H(o.el);0===s.length||(n.params.uniqueNavElements&&"string"==typeof o.el&&s.length>1&&(s=n.$el.find(o.el)).length>1&&(s=s.filter(function(e){return H(e).parents(".swiper")[0]===n.el})),"bullets"===o.type&&o.clickable&&s.addClass(o.clickableClass),s.addClass(o.modifierClass+o.type),s.addClass(o.modifierClass+n.params.direction),"bullets"===o.type&&o.dynamicBullets&&(s.addClass("".concat(o.modifierClass).concat(o.type,"-dynamic")),f=0,o.dynamicMainBullets<1&&(o.dynamicMainBullets=1)),"progressbar"===o.type&&o.progressbarOpposite&&s.addClass(o.progressbarOppositeClass),o.clickable&&s.on("click",ed(o.bulletClass),function(e){e.preventDefault();var t=H(this).index()*n.params.slidesPerGroup;n.params.loop&&(t+=n.loopedSlides),n.slideTo(t)}),Object.assign(n.pagination,{$el:s,el:s[0]}),n.enabled||s.addClass(o.lockClass))}},d=function(){var e=n.params.pagination;if(!s()){var t=n.pagination.$el;t.removeClass(e.hiddenClass),t.removeClass(e.modifierClass+e.type),t.removeClass(e.modifierClass+n.params.direction),n.pagination.bullets&&n.pagination.bullets.removeClass&&n.pagination.bullets.removeClass(e.bulletActiveClass),e.clickable&&t.off("click",ed(e.bulletClass))}},p="swiper-pagination";i({pagination:{el:null,bulletElement:"span",clickable:!1,hideOnClick:!1,renderBullet:null,renderProgressbar:null,renderFraction:null,renderCustom:null,progressbarOpposite:!1,type:"bullets",// 'bullets' or 'progressbar' or 'fraction' or 'custom'
dynamicBullets:!1,dynamicMainBullets:1,formatFractionCurrent:function(e){return e},formatFractionTotal:function(e){return e},bulletClass:"".concat(p,"-bullet"),bulletActiveClass:"".concat(p,"-bullet-active"),modifierClass:"".concat(p,"-"),currentClass:"".concat(p,"-current"),totalClass:"".concat(p,"-total"),hiddenClass:"".concat(p,"-hidden"),progressbarFillClass:"".concat(p,"-progressbar-fill"),progressbarOppositeClass:"".concat(p,"-progressbar-opposite"),clickableClass:"".concat(p,"-clickable"),lockClass:"".concat(p,"-lock"),horizontalClass:"".concat(p,"-horizontal"),verticalClass:"".concat(p,"-vertical")}}),n.pagination={el:null,$el:null,bullets:[]};var f=0;r("init",function(){u(),c(),l()}),r("activeIndexChange",function(){n.params.loop?l():void 0===n.snapIndex&&l()}),r("snapIndexChange",function(){n.params.loop||l()}),r("slidesLengthChange",function(){n.params.loop&&(c(),l())}),r("snapGridLengthChange",function(){n.params.loop||(c(),l())}),r("destroy",function(){d()}),r("enable disable",function(){var e=n.pagination.$el;e&&e[n.enabled?"removeClass":"addClass"](n.params.pagination.lockClass)}),r("lock unlock",function(){l()}),r("click",function(e,t){var i=t.target,r=n.pagination.$el;if(n.params.pagination.el&&n.params.pagination.hideOnClick&&r.length>0&&!H(i).hasClass(n.params.pagination.bulletClass)){if(n.navigation&&(n.navigation.nextEl&&i===n.navigation.nextEl||n.navigation.prevEl&&i===n.navigation.prevEl))return;!0===r.hasClass(n.params.pagination.hiddenClass)?o("paginationShow"):o("paginationHide"),r.toggleClass(n.params.pagination.hiddenClass)}}),Object.assign(n.pagination,{render:c,update:l,init:u,destroy:d})}/* eslint no-underscore-dangle: "off" *//* eslint no-use-before-define: "off" */function ef(e){var t,n=e.swiper,i=e.extendParams,r=e.on,o=e.emit,s=function(){return void 0===t&&!n.autoplay.running&&(n.autoplay.running=!0,o("autoplayStart"),h(),!0)},a=function(){return!!n.autoplay.running&&void 0!==t&&(t&&(clearTimeout(t),t=void 0),n.autoplay.running=!1,o("autoplayStop"),!0)},l=function(e){n.autoplay.running&&(n.autoplay.paused||(t&&clearTimeout(t),n.autoplay.paused=!0,0!==e&&n.params.autoplay.waitForTransition?["transitionend","webkitTransitionEnd"].forEach(function(e){n.$wrapperEl[0].addEventListener(e,v)}):(n.autoplay.paused=!1,h())))},c=function(){var e=T();"hidden"===e.visibilityState&&n.autoplay.running&&l(),"visible"===e.visibilityState&&n.autoplay.paused&&(h(),n.autoplay.paused=!1)},u=function(){n.params.autoplay.disableOnInteraction?a():l(),["transitionend","webkitTransitionEnd"].forEach(function(e){n.$wrapperEl[0].removeEventListener(e,v)})},d=function(){n.params.autoplay.disableOnInteraction||(n.autoplay.paused=!1,h())},p=function(){n.params.autoplay.pauseOnMouseEnter&&(n.$el.on("mouseenter",u),n.$el.on("mouseleave",d))},f=function(){n.$el.off("mouseenter",u),n.$el.off("mouseleave",d)};function h(){var e=n.slides.eq(n.activeIndex),i=n.params.autoplay.delay;e.attr("data-swiper-autoplay")&&(i=e.attr("data-swiper-autoplay")||n.params.autoplay.delay),clearTimeout(t),t=F(function(){var e;n.params.autoplay.reverseDirection?n.params.loop?(n.loopFix(),e=n.slidePrev(n.params.speed,!0,!0),o("autoplay")):n.isBeginning?n.params.autoplay.stopOnLastSlide?a():(e=n.slideTo(n.slides.length-1,n.params.speed,!0,!0),o("autoplay")):(e=n.slidePrev(n.params.speed,!0,!0),o("autoplay")):n.params.loop?(n.loopFix(),e=n.slideNext(n.params.speed,!0,!0),o("autoplay")):n.isEnd?n.params.autoplay.stopOnLastSlide?a():(e=n.slideTo(0,n.params.speed,!0,!0),o("autoplay")):(e=n.slideNext(n.params.speed,!0,!0),o("autoplay")),n.params.cssMode&&n.autoplay.running?h():!1===e&&h()},i)}function v(e){n&&!n.destroyed&&n.$wrapperEl&&e.target===n.$wrapperEl[0]&&(["transitionend","webkitTransitionEnd"].forEach(function(e){n.$wrapperEl[0].removeEventListener(e,v)}),n.autoplay.paused=!1,n.autoplay.running?h():a())}n.autoplay={running:!1,paused:!1},i({autoplay:{enabled:!1,delay:3e3,waitForTransition:!0,disableOnInteraction:!0,stopOnLastSlide:!1,reverseDirection:!1,pauseOnMouseEnter:!1}}),r("init",function(){n.params.autoplay.enabled&&(s(),T().addEventListener("visibilitychange",c),p())}),r("beforeTransitionStart",function(e,t,i){n.autoplay.running&&(i||!n.params.autoplay.disableOnInteraction?n.autoplay.pause(t):a())}),r("sliderFirstMove",function(){n.autoplay.running&&(n.params.autoplay.disableOnInteraction?a():l())}),r("touchEnd",function(){n.params.cssMode&&n.autoplay.paused&&!n.params.autoplay.disableOnInteraction&&h()}),r("destroy",function(){f(),n.autoplay.running&&a(),T().removeEventListener("visibilitychange",c)}),Object.assign(n.autoplay,{pause:l,run:h,start:s,stop:a})}function eh(e){var t=e.effect,n=e.swiper,i=e.on,r=e.setTranslate,o=e.setTransition,s=e.overwriteParams,a=e.perspective;i("beforeInit",function(){if(n.params.effect===t){n.classNames.push("".concat(n.params.containerModifierClass).concat(t)),a&&a()&&n.classNames.push("".concat(n.params.containerModifierClass,"3d"));var e=s?s():{};Object.assign(n.params,e),Object.assign(n.originalParams,e)}}),i("setTranslate",function(){n.params.effect===t&&r()}),i("setTransition",function(e,i){n.params.effect===t&&o(i)})}function ev(e,t){return e.transformEl?t.find(e.transformEl).css({"backface-visibility":"hidden","-webkit-backface-visibility":"hidden"}):t}function eg(e){var t=e.swiper,n=e.duration,i=e.transformEl,r=e.allSlides,o=t.slides,s=t.activeIndex,a=t.$wrapperEl;if(t.params.virtualTranslate&&0!==n){var l=!1;(r?i?o.find(i):o:i?o.eq(s).find(i):o.eq(s)).transitionEnd(function(){if(!l&&t&&!t.destroyed){l=!0,t.animating=!1;for(var e=["webkitTransitionEnd","transitionend"],n=0;n<e.length;n+=1)a.trigger(e[n])}})}}function em(e){var t=e.swiper,n=e.extendParams,i=e.on;n({fadeEffect:{crossFade:!1,transformEl:null}}),eh({effect:"fade",swiper:t,on:i,setTranslate:function(){for(var e=t.slides,n=t.params.fadeEffect,i=0;i<e.length;i+=1){var r=t.slides.eq(i),o=-r[0].swiperSlideOffset;t.params.virtualTranslate||(o-=t.translate);var s=0;t.isHorizontal()||(s=o,o=0);var a=t.params.fadeEffect.crossFade?Math.max(1-Math.abs(r[0].progress),0):1+Math.min(Math.max(r[0].progress,-1),0);ev(n,r).css({opacity:a}).transform("translate3d(".concat(o,"px, ").concat(s,"px, 0px)"))}},setTransition:function(e){var n=t.params.fadeEffect.transformEl;(n?t.slides.find(n):t.slides).transition(e),eg({swiper:t,duration:e,transformEl:n,allSlides:!0})},overwriteParams:function(){return{slidesPerView:1,slidesPerGroup:1,watchSlidesProgress:!0,spaceBetween:0,virtualTranslate:!t.params.cssMode}}})}function ey(e){var t=e.swiper,n=e.extendParams,i=e.on;n({creativeEffect:{transformEl:null,limitProgress:1,shadowPerProgress:!1,progressMultiplier:1,perspective:!0,prev:{translate:[0,0,0],rotate:[0,0,0],opacity:1,scale:1},next:{translate:[0,0,0],rotate:[0,0,0],opacity:1,scale:1}}}),eh({effect:"creative",swiper:t,on:i,setTranslate:function(){var e=t.slides,n=t.$wrapperEl,i=t.slidesSizesGrid,r=t.params.creativeEffect,o=r.progressMultiplier,s=t.params.centeredSlides;if(s){var a=i[0]/2-t.params.slidesOffsetBefore||0;n.transform("translateX(calc(50% - ".concat(a,"px))"))}for(var l=0;l<e.length;l+=1)!function(n){var i=e.eq(n),a=i[0].progress,l=Math.min(Math.max(i[0].progress,-r.limitProgress),r.limitProgress),c=l;s||(c=Math.min(Math.max(i[0].originalProgress,-r.limitProgress),r.limitProgress));var u=i[0].swiperSlideOffset,d=[t.params.cssMode?-u-t.translate:-u,0,0],p=[0,0,0],f=!1;t.isHorizontal()||(d[1]=d[0],d[0]=0);var h={translate:[0,0,0],rotate:[0,0,0],scale:1,opacity:1};l<0?(h=r.next,f=!0):l>0&&(h=r.prev,f=!0),d.forEach(function(e,t){var n;d[t]="calc(".concat(e,"px + (").concat("string"==typeof(n=h.translate[t])?n:"".concat(n,"px")," * ").concat(Math.abs(l*o),"))")}),p.forEach(function(e,t){p[t]=h.rotate[t]*Math.abs(l*o)}),i[0].style.zIndex=-Math.abs(Math.round(a))+e.length;var v=d.join(", "),g="rotateX(".concat(p[0],"deg) rotateY(").concat(p[1],"deg) rotateZ(").concat(p[2],"deg)"),m=c<0?"scale(".concat(1+(1-h.scale)*c*o,")"):"scale(".concat(1-(1-h.scale)*c*o,")"),y=c<0?1+(1-h.opacity)*c*o:1-(1-h.opacity)*c*o,b="translate3d(".concat(v,") ").concat(g," ").concat(m);if(f&&h.shadow||!f){var w,S,x,T=i.children(".swiper-slide-shadow");if(0===T.length&&h.shadow&&((x=(S=r.transformEl?i.find(r.transformEl):i).children(".".concat("swiper-slide-shadow".concat(w?"-".concat(w):"")))).length||(x=H('<div class="swiper-slide-shadow'.concat(w?"-".concat(w):"",'"></div>')),S.append(x)),T=x),T.length){var E=r.shadowPerProgress?l*(1/r.limitProgress):l;T[0].style.opacity=Math.min(Math.max(Math.abs(E),0),1)}}var C=ev(r,i);C.transform(b).css({opacity:y}),h.origin&&C.css("transform-origin",h.origin)}(l)},setTransition:function(e){var n=t.params.creativeEffect.transformEl;(n?t.slides.find(n):t.slides).transition(e).find(".swiper-slide-shadow").transition(e),eg({swiper:t,duration:e,transformEl:n,allSlides:!0})},perspective:function(){return t.params.creativeEffect.perspective},overwriteParams:function(){return{watchSlidesProgress:!0,virtualTranslate:!t.params.cssMode}}})}Object.keys(el).forEach(function(e){Object.keys(el[e]).forEach(function(t){eu.prototype[t]=el[e][t]})}),eu.use([function(e){var t=e.swiper,n=e.on,i=e.emit,r=C(),o=null,s=function(){t&&!t.destroyed&&t.initialized&&(i("beforeResize"),i("resize"))},a=function(){t&&!t.destroyed&&t.initialized&&(o=new ResizeObserver(function(e){var n=t.width,i=t.height,r=n,o=i;e.forEach(function(e){var n=e.contentBoxSize,i=e.contentRect,s=e.target;s&&s!==t.el||(r=i?i.width:(n[0]||n).inlineSize,o=i?i.height:(n[0]||n).blockSize)}),(r!==n||o!==i)&&s()})).observe(t.el)},l=function(){o&&o.unobserve&&t.el&&(o.unobserve(t.el),o=null)},c=function(){t&&!t.destroyed&&t.initialized&&i("orientationchange")};n("init",function(){if(t.params.resizeObserver&&void 0!==r.ResizeObserver){a();return}r.addEventListener("resize",s),r.addEventListener("orientationchange",c)}),n("destroy",function(){l(),r.removeEventListener("resize",s),r.removeEventListener("orientationchange",c)})},function(e){var t=e.swiper,n=e.extendParams,i=e.on,r=e.emit,o=[],s=C(),a=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=new(s.MutationObserver||s.WebkitMutationObserver)(function(e){// The observerUpdate event should only be triggered
...
a(t.$el[0],{childList:t.params.observeSlideChildren}),a(t.$wrapperEl[0],{attributes:!1})}}),i("destroy",function(){o.forEach(function(e){e.disconnect()}),o.splice(0,o.length)})}]);var eb=c("jxMcu");window.$=window.jQuery=/*@__PURE__*/t(eb);var eb=c("jxMcu"),ew={},k=c("jFPEE");n=function(e){// This is needed so we can catch the AMD loader configuration and use it
...
return function(){if(!t||!t.requirejs){var e,n,i,r,o,s,a,l,c,u,d,p,f,h,v,g,m,y,b,w,S,x;t?n=t:t={},o=function(e,t){return w.call(e,t)},s=/**
     ...
     */function(e,t){var n,i,r,o,s,a,l,c,u,d,p,f=t&&t.split("/"),h=y.map,v=h&&h["*"]||{};//Adjust any relative paths.
if(e){//start trimDots
for(s=(e=e.split("/")).length-1,y.nodeIdCompat&&x.test(e[s])&&(e[s]=e[s].replace(x,"")),"."===e[0].charAt(0)&&f&&(e=f.slice(0,f.length-1).concat(e)),u=0;u<e.length;u++)if("."===(p=e[u]))e.splice(u,1),u-=1;else if(".."===p){// If at the start, or previous value is still ..,
...
var n=S.call(arguments,0);return"string"!=typeof n[0]&&1===n.length&&n.push(null),f.apply(r,n.concat([e,t]))}},l=function(e){return function(t){g[e]=t}},c=function(e){if(o(m,e)){var t=m[e];delete m[e],b[e]=!0,p.apply(r,t)}if(!o(g,e)&&!o(b,e))throw Error("No "+e);return g[e]},u=//with the plugin being undefined if the name
...
function(e){return e?u(e):[]},g={},m={},y={},b={},w=Object.prototype.hasOwnProperty,S=[].slice,x=/\.js$/,/**
     * Makes a name map, normalizing the name, and using a plugin
     * for normalization if necessary. Grabs a ref to plugin
     * too, as an optimization.
     */h=function(e,t){var n,i=u(e),r=i[0],o=t[1];//Using ridiculous property names for space reasons
return(e=i[1],r&&(n=c(r=s(r,o))),r)?e=n&&n.normalize?n.normalize(e,function(e){return s(e,o)}):s(e,o):(r=(i=u(e=s(e,o)))[0],e=i[1],r&&(n=c(r))),{f:r?r+"!"+e:e,n:e,pr:r,p:n}},v={require:function(e){return a(e)},exports:function(e){var t=g[e];return void 0!==t?t:g[e]={}},module:function(e){return{id:e,uri:"",exports:g[e],config:function(){return y&&y.config&&y.config[e]||{}}}}},p=function(e,t,n,i){var s,u,p,f,y,w,S,x=[],T=void 0===n?"undefined":(0,k._)(n);//Call the callback to define the module, if necessary.
if(w=d(//Use name if no relName
i=i||e),"undefined"===T||"function"===T){for(y=0,//Pull out the defined dependencies and pass the ordered
//values to the callback.
//Default to [require, exports, module] if no deps
t=!t.length&&n.length?["require","exports","module"]:t;y<t.length;y+=1)//Fast path CommonJS standard dependencies.
if("require"===(u=(f=h(t[y],w)).f))x[y]=v.require(e);else if("exports"===u)//CommonJS module spec 1.1
x[y]=v.exports(e),S=!0;else if("module"===u)s=x[y]=v.module(e);else if(o(g,u)||o(m,u)||o(b,u))x[y]=c(u);else if(f.p)f.p.load(f.n,a(i,!0),l(u),{}),x[y]=g[u];else throw Error(e+" missing "+u);p=n?n.apply(g[e],x):void 0,e&&(s&&s.exports!==r&&s.exports!==g[e]?g[e]=s.exports:p===r&&S||(g[e]=p))}else e&&//worry about defining if have a module name.
(g[e]=n)},e=n=f=function(e,t,n,i,o){if("string"==typeof e)return v[e]?v[e](t):c(h(e,d(t)).f);if(!e.splice){if(//deps is a config object, not an array.
(y=e).deps&&f(y.deps,y.callback),!t)return;t.splice?(//callback is an array, which means it is a dependency list.
...
setTimeout(function(){p(r,e,t,n)},4),f)},/**
     ...
     */e._defined=g,(i=function(e,t,n){if("string"!=typeof e)throw Error("See almond README: incorrect module build, no module name");t.splice||(//deps is not an array, so probably means
...
e.fn.select2.amd=t,n)},"function"==typeof define&&define.amd?define(["jquery"],n):ew?ew=function(e,t){return void 0===t&&(t="undefined"!=typeof window?c("jxMcu"):c("jxMcu")(e)),n(t),t}:n(jQuery),/*@__PURE__*/t(ew)(/*@__PURE__*/t(eb)),window.$=window.jQuery=/*@__PURE__*/t(eb),window.addEventListener("load",function(){var e,n,i,r,o=function(e){if(!e.id)return e.text;var n=/*@__PURE__*/t(eb)(e.element).data("image");return /*@__PURE__*/t(eb)('<img src="'+n+'" class="w-[24px] h-[24px] mr-[8px] object-contain pointer-events-none" /> <div class="leading-7 text-left pointer-events-none">'+e.text+"</div>")};document.querySelector(".deliverySlides")&&new eu(".deliverySlides",{modules:[ef,ep,em,ey],loop:!0,centeredSlides:!0,effect:"creative",pagination:{el:".paginationBeliverySlides",clickable:!0},creativeEffect:{limitProgress:2,prev:{translate:["-100%",-60,-60]},next:{translate:["100%",-60,-60]}},breakpoints:{641:{slidesPerView:1.5,spaceBetween:10,creativeEffect:{limitProgress:2,prev:{translate:["-90%",-40,-40]},next:{translate:["90%",-40,-40]}}},769:{spaceBetween:40,slidesPerView:2,creativeEffect:{limitProgress:2,prev:{translate:["-90%",-40,-40]},next:{translate:["90%",-40,-40]}}}}}),document.querySelector(".aboutSlides")&&new eu(".aboutSlides",{modules:[ef,ep,em,ey],slidesPerView:1,loop:!0,pagination:{el:".aboutSlides__pagination",clickable:!0},breakpoints:{481:{direction:"vertical"}}}),e=new eu(".geographySlider",{modules:[ef,ep,em,ey],effect:"fade",loop:!0,observer:!0,autoplay:{delay:5e3,disableOnInteraction:!1},pagination:{el:".geographySlider__pagination",bulletClass:"swiper-pagination-bullet-custom",bulletActiveClass:"swiper-pagination-bullet-custom--active",renderBullet:function(e,t){return'<div class="'.concat(t,'" data-index="').concat(e,'">\n          <svg xmlns="http://www.w3.org/2000/svg" width="80" height="2" viewBox="0 0 80 2" fill="none">\n            <line y1="1" x2="0" y2="1" stroke="white" stroke-width="2"/>\n          </svg>\n          </div>')},clickable:!0},on:{init:function(){var e;this.el.style.setProperty("--delay",this.params.autoplay.delay),document.querySelectorAll(".swiper-pagination-bullet-custom line").forEach(function(e){e.setAttribute("x2","0")}),null===(e=document.querySelector(".swiper-pagination-bullet-custom.swiper-pagination-bullet-custom--active line"))||void 0===e||e.setAttribute("x2","80");// _self.el.addEventListener('mouseenter', function() {
...
// });
},slideChange:function(){var e;document.querySelectorAll(".swiper-pagination-bullet-custom line").forEach(function(e){e.setAttribute("x2","0")}),null===(e=document.querySelector(".swiper-pagination-bullet-custom.swiper-pagination-bullet-custom--active line"))||void 0===e||e.setAttribute("x2","80")}}}),n=document.querySelector(".header"),window.innerWidth>1366&&/*@__PURE__*/t(v)("#fullpage",{navigation:!1,onLeave:function(t,i,r,o,s){!0==i.isLast?n.classList.add("close"):document.querySelector(".header.close")&&n.classList.remove("close"),document.querySelector(".fp-viewing-1")&&document.querySelector(".geographySlider")&&e.slideToLoop(0,0),document.querySelector(".fp-viewing-3")&&document.querySelector(".geographySlider")&&e.slideToLoop(0,0)}}),document.querySelectorAll('a[href^="#"]').forEach(function(e){e.addEventListener("click",function(e){e.preventDefault(),document.querySelector(this.getAttribute("href")).scrollIntoView({behavior:"smooth"})})}),new d,new h;var s=document.querySelector(".containerMin"),a=document.querySelectorAll(".geographySlider__box"),l=document.querySelectorAll(".geographySlider__nav");s&&(i=s.getBoundingClientRect(),r=window.innerWidth>768?i.left+50:window.innerWidth>375?i.left+30:i.left+12),null==a||a.forEach(function(e){e.style.left=""+r+"px"}),null==l||l.forEach(function(e){e.style.left=""+r+"px"}),window.innerWidth<=992&&(null==a||a.forEach(function(e){e.style.right=""+r+"px"}),null==l||l.forEach(function(e){e.style.right=""+r+"px"})),window.addEventListener("resize",function(){null==a||a.forEach(function(e){e.style.left=""+r+"px"}),null==l||l.forEach(function(e){e.style.left=""+r+"px"}),window.innerWidth<=992&&(null==a||a.forEach(function(e){e.style.right=""+r+"px"}),null==l||l.forEach(function(e){e.style.right=""+r+"px"}))}),window.innerWidth<640&&(/*@__PURE__*/t(eb)(".select").select2({minimumResultsForSearch:1/0,templateResult:o,templateSelection:o}),/*@__PURE__*/t(eb)(".select").on("select2:select",function(e){var t=e.target.value;console.log(t),document.querySelectorAll(".tab-content").forEach(function(e){e.getAttribute("id")==t&&(document.querySelector(".tab-content.current").classList.remove("current"),e.classList.add("current"))})})),"Главная"==document.title?(/*@__PURE__*/t(eb)("#index").addClass("active"),/*@__PURE__*/t(eb)("#indexFooter").addClass("active"),/*@__PURE__*/t(eb)("#indexMobile").addClass("active")):"О компании"==document.title&&(/*@__PURE__*/t(eb)("#about").addClass("active"),/*@__PURE__*/t(eb)("#aboutFooter").addClass("active"),/*@__PURE__*/t(eb)("#aboutMobile").addClass("active"))})}();//# sourceMappingURL=about.8525f944.js.map

//# sourceMappingURL=about.8525f944.js.map
