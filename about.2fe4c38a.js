...
"*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|("+I+"))|)"+_+"*\\]",H=":("+I+")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|"+N+")*)|.*)\\)|)",q=RegExp(_+"+","g"),R=RegExp("^"+_+"*,"+_+"*"),z=RegExp("^"+_+"*([>+~]|"+_+")"+_+"*"),B=RegExp(_+"|>"),F=new RegExp(H),W=RegExp("^"+I+"$"),G={ID:RegExp("^#("+I+")"),CLASS:RegExp("^\\.("+I+")"),TAG:RegExp("^("+I+"|[*])"),ATTR:RegExp("^"+N),PSEUDO:RegExp("^"+H),CHILD:RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\("+_+"*(even|odd|(([+-]|)(\\d*)n|)"+_+"*(?:([+-]|)"+_+"*(\\d+)|))"+_+"*\\)|)","i"),bool:RegExp("^(?:"+j+")$","i"),// For use in libraries implementing .is()
...
T.fx.step={};var e9,e6,e7,e5,e8=/^(?:toggle|show|hide)$/,te=/queueHooks$/;// Animations created synchronously will run synchronously
...
// }
function R(e){return"none"!==O.getComputedStyle(e).display}function z(e){return Array.from(e).filter(function(e){return R(e)})}/**
...
if(!tk().navigationTooltips.length){var n="[data-tooltip]",i=B(tk().sectionSelector.split(",").join(n+",")+n,tC);i.length&&i.forEach(function(e){tk().navigationTooltips.push(em(e,"data-tooltip").toString())})}}var tO=function(e){this.anchor=e.anchor,this.item=e.item,this.index=e.index(),this.isLast=this.index===e.item.parentElement.querySelectorAll(e.selector).length-1,this.isFirst=!this.index,this.isActive=e.isActive},tM=function(e,t){this.parent=this.parent||null,this.selector=t,this.anchor=em(e,"data-anchor")||tk().anchors[Q(e,tk().sectionSelector)],this.item=e,this.isVisible=R(e),this.isActive=W(e,eZ),this.hasScroll=W(e,td)||null!=B(tp,e)[0],this.isSection=t===tk().sectionSelector,this.container=ec(e,tc)||ec(e,eU),this.index=function(){return this.siblings().indexOf(this)}};function tP(e){return e.map(function(e){return e.item})}function tj(e,t){return e.find(function(e){return e.item===t})}tM.prototype.siblings=function(){return this.isSection?this.isVisible?eq.sections:eq.sectionsIncludingHidden:this.parent?this.parent.slides:0},tM.prototype.prev=function(){var e=this.siblings(),t=(this.isSection?e.indexOf(this):this.parent.slides.indexOf(this))-1;return t>=0?e[t]:null},tM.prototype.next=function(){var e=this.siblings(),t=(this.isSection?e.indexOf(this):this.parent.slides.indexOf(this))+1;return t<e.length?e[t]:null},tM.prototype.prevPanel=function(){return this.prev()||(this.parent?this.parent.prev():null)},tM.prototype.nextPanel=function(){return this.next()||(this.parent?this.parent.next():null)},tM.prototype.getSiblings=function(){return this.isSection?eq.sections:eq.panels};var tI=function(e){tO.call(this,e)},tN=function(e){tO.call(this,e)};/**
    ...
    */function tR(e){var t,n,i=tk();return i.autoScrolling&&!i.scrollBar?(t=-e,n=B(eU)[0]):(t=e,n=window),{options:t,element:n}}/**
...
var t=Math.round(e);if(tk().css3&&tk().autoScrolling&&!tk().scrollBar)tG("translate3d(0px, -"+t+"px, 0px)",!1);else if(tk().autoScrolling&&!tk().scrollBar)V(tC,{top:-t+"px"}),H.test.top=-t+"px";else{var n=tR(t);tz(n.element,n.options)}}/**
    ...
    */function tQ(e,t,n,i){var r,o=e.self!=O&&W(e,ts)?e.scrollLeft:!tk().autoScrolling||tk().scrollBar?eh():e.offsetTop,s=t-o,a=!1,l=eq.activeAnimation;eR({activeAnimation:!0}),y&&window.cancelAnimationFrame(y),y=function(c){r||(r=c);var u=Math.floor(c-r);if(eq.activeAnimation){//in order to stope it from other function whenever we want
var d=t;n&&(d=O.fp_easings[tk().easing](u,o,s,n)),u<=n&&tz(e,d),u<n?window.requestAnimationFrame(y):void 0===i||a||(i(),eR({activeAnimation:!1}),a=!0)}else a||l||(i(),eR({activeAnimation:!1}),a=!0)},window.requestAnimationFrame(y)}/**
...
B("video, audio",t).forEach(function(e){e.hasAttribute("data-keepplaying")||"function"!=typeof e.pause||e.pause()}),B('iframe[src*="youtube.com/embed/"]',t).forEach(function(e){/youtube\.com\/embed\//.test(em(e,"src"))&&!e.hasAttribute("data-keepplaying")&&e.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}',"*")})}/**
    ...
    */function t7(e,t,n){var i="";tk().anchors.length&&!tk().lockAnchors&&(e?(null!=n&&(i=n),null==t&&(t=e),eR({lastScrolledSlide:t}),t5(i+"/"+t)):(null!=e&&eR({lastScrolledSlide:t}),t5(n))),t9()}/**
    * Sets the URL hash.
    ...
    */function t8(e,t,n){var i="Section"===t?tk().anchors[e]:em(n,"data-anchor");return encodeURI(tk().navigationTooltips[e]||i||t+" "+(e+1))}function ne(e){e.cancelable&&eg(e),eR({scrollTrigger:"horizontalNav"});/*jshint validthis:true */var t=ec(this,e3),n=B(ta,ec(this,e3))[0],i=tj(eq.sections,t).slides[Q(ec(this,"li"))];eH.emit(ez.landscapeScroll,{slides:n,destination:i.item})}var nt={};/**
...
"all"!==t?nt[n][t]=e:Object.keys(nt[n]).forEach(function(t){nt[n][t]=e})}function ni(){/*jshint validthis:true */var e=ec(this,e3);/*jshint validthis:true */W(this,tw)?nt.m.left&&(eR({scrollTrigger:"slideArrow"}),eH.emit(ez.moveSlideLeft,{section:e})):nt.m.right&&(eR({scrollTrigger:"slideArrow"}),eH.emit(ez.moveSlideRight,{section:e}))}/**
    ...
    */function no(e,t){e||tU(0),t_("autoScrolling",e,t);var n=eq.activeSection.item;if(tk().autoScrolling&&!tk().scrollBar)V(tK,{overflow:"hidden",height:"100%"}),ei(tX,"fp-scrollable"),nr(tL.recordHistory,"internal"),V(tC,{"-ms-touch-action":"none","touch-action":"none"}),null!=n&&tU(n.offsetTop);else if(V(tK,{overflow:"visible",height:"initial"}),en(tX,"fp-scrollable"),nr(!!tk().autoScrolling&&tL.recordHistory,"internal"),V(tC,{"-ms-touch-action":"","touch-action":""}),null!=n){var i=tR(n.offsetTop);i.element.scrollTo(0,i.options)}}/**
    * Makes sure lazyload is done for other sections in the viewport that are not the
    * active one. 
    */function ns(){var e=B(e6)[0]||W(tX,eV)&&B(e5)[0];//quitting when it doesn't apply
...
B(e3+":not("+eJ+")").forEach(function(e){var t,n,i,r,o;n=(t=e.getBoundingClientRect()).top,i=t.bottom,r=n+2<eq.windowsHeight&&n>0,o=i>2&&i<eq.windowsHeight,(r||o)&&t4(e)})}function na(){/*jshint validthis:true */ex(X(this),"click")}/**
    ...
    */function nl(){eA(B(te));var e=M.createElement("div");e.setAttribute("id",e8);var t=M.createElement("ul");e.appendChild(t),er(e,tX);var n=B(te)[0];en(n,"fp-"+tk().navigationPosition),tk().showActiveTooltip&&en(n,"fp-show-active");for(var i="",r=0;r<eq.sections.length;r++){var o=eq.sections[r],s="";tk().anchors.length&&(s=o.anchor),i+='<li><a href="#'+encodeURI(s)+'"><span class="fp-sr-only">'+t8(o.index(),"Section")+"</span><span></span></a>";var a=tk().navigationTooltips[o.index()];void 0!==a&&""!==a&&(i+='<div class="'+tt+" fp-"+tk().navigationPosition+'">'+a+"</div>"),i+="</li>"}B("ul",n)[0].innerHTML=i;var l=B("li",B(te)[0])[eq.activeSection.index()];en(B("a",l),eZ)}//Scrolls to the section when clicking the navigation bullet
...
var t=Q(ec(this,te+" li"));eH.emit(ez.scrollPage,{destination:eq.sections[t]})}/**
    ...
    */function np(e,t){if(eS(tk().beforeLeave))return nd(eq.scrollTrigger,function(){return t0(e,t)})}/**
    * Scrolls the site to the given element and scrolls to the slide if a callback is given.
    */function nh(e,t,n){var i,r,o=e.item;if(null!=o){//there's no element to scroll, leaving the function
var s=(l=o.offsetHeight,u=c=o.offsetTop,d=c>eq.previousDestTop,p=u-G()+l,h=tk().bigSectionsDestination,l>G()?(d||h)&&"bottom"!==h||(u=p):(d||eq.isResizing&&null==Y(o))&&(u=p),/*
...
localIsResizing:eq.isResizing,items:{origin:eq.activeSection,destination:e},direction:null};if((eq.activeSection.item!=o||eq.isResizing)&&(!tk().scrollBar||eh()!==a.dtop||W(o,e9))){if(null!=a.activeSlide&&(i=em(a.activeSlide,"data-anchor"),r=Q(a.activeSlide,null)),!a.localIsResizing){var l,c,u,d,p,h,f,g,m=a.yMovement;//required for continousVertical
...
tU(eq.activeSection.item.offsetTop),/**
    ...
    */function(){for(var e=B(to),t=0;t<e.length;t++)nk(e[t],"internal")}(),f.wrapAroundElements=g,f.dtop=f.element.offsetTop,f.yMovement=tF(eq.activeSection,f.element),a=f),a.localIsResizing||t3(eq.activeSection.item),en(o,eZ),ei(ef(o),eZ),nO(),t4(o),//more than once if the page is scrolling
eR({canScroll:H.test.isTesting}),t7(r,i,a.anchorLink),eH.emit(ez.onLeave,a),/**
    * Performs the vertical movement (by CSS3 or by jQuery)
    */function(e){var t=tk().scrollingSpeed<700,n=t?700:tk().scrollingSpeed;if(eR({touchDirection:"none",scrollY:Math.round(e.dtop)}),eH.emit(ez.onPerformMovement),tk().css3&&tk().autoScrolling&&!tk().scrollBar)tG("translate3d(0px, -"+Math.round(e.dtop)+"px, 0px)",!0),tk().scrollingSpeed?(clearTimeout(b),b=setTimeout(function(){nf(e),eR({canScroll:!t||H.test.isTesting})},tk().scrollingSpeed)):nf(e);else{var i=tR(e.dtop);H.test.top=-e.dtop+"px",clearTimeout(b),tQ(i.element,i.options,tk().scrollingSpeed,function(){tk().scrollBar?/* Hack!
...
/**
    * Maintains the active slides in the viewport
    * (Because the `scroll` animation might get lost with some actions, such as when using continuousVertical)
    */function(){for(var e=B(to),t=0;t<e.length;t++)nk(e[t],"internal")}(),eR({isDoingContinousVertical:!1})),eS(tk().afterLoad)&&!e.localIsResizing&&t0("afterLoad",e),nO(),e.localIsResizing||t1(e.element),en(e.element,e0),ei(ef(e.element),e0),ns(),eR({canScroll:!0}),eH.emit(ez.afterSectionLoads,e),eS(e.callback)&&e.callback()}/**
    * Sets fitToSection
...
e&&t?ny(n||i):e?ny(n):t&&ny(i)}/**
    ...
    */function ny(e){var t=W(tX,eV);e?!t&&(no(!1,"internal"),ng(!1,"internal"),J(B(te)),en(tX,eV),eS(tk().afterResponsive))&&tk().afterResponsive.call(tC,e):t&&(no(tL.autoScrolling,"internal"),ng(tL.autoScrolling,"internal"),ee(B(te)),ei(tX,eV),eS(tk().afterResponsive))&&tk().afterResponsive.call(tC,e)}function nb(e){tk().verticalCentered&&(!tk().scrollOverflow&&nE.shouldBeScrollable(e.item)||nE.isScrollable(e)||W(e.item,tu)||en(e.item,tu))}H.moveTo=moveTo,H.getScrollY=function(){return eq.scrollY},eH.on(ez.onDestroy,function(){clearTimeout(b),clearTimeout(w)}),H.setFitToSection=ng,H.fitToSection=nm,H.setResponsive=ny;var nw=null;/**
    * Styling vertical sections
    */function nS(e){var t=e.item,n=e.allSlidesItems.length,i=e.index();!eq.activeSection&&e.isVisible&&(en(t,eZ),nO(),nw=eq.activeSection.item),tk().paddingTop&&V(t,{"padding-top":tk().paddingTop}),tk().paddingBottom&&V(t,{"padding-bottom":tk().paddingBottom}),void 0!==tk().sectionsColor[i]&&V(t,{"background-color":tk().sectionsColor[i]}),void 0!==tk().anchors[i]&&t.setAttribute("data-anchor",e.anchor),n||nb(e)}function nx(){tk().scrollOverflow&&!tk().scrollBar&&(nE.makeScrollable(),nE.focusScrollable())}function nT(){eH.removeListener(ez.onAfterRenderNoAnchor,nx),eb("keyup",nE.keyUpHandler)}H.getActiveSection=/**
...
//because it will be checked later inside a setTimeout and the value might change
localIsResizing:eq.isResizing};if(l.xMovement=(i=l.prevSlideIndex)==(r=l.slideIndex)?"none":i>r?"left":"right",l.direction=l.direction?l.direction:l.xMovement,l.localIsResizing||eR({canScroll:!1}),tk().onSlideLeave&&!l.localIsResizing&&"none"!==l.xMovement&&eS(tk().onSlideLeave)&&!1===t0("onSlideLeave",l)){eR({slideMoving:!1});return}en(t,eZ),ei(ef(t),eZ),nO(),l.localIsResizing||(t3(l.prevSlide),t4(t)),!tk().loopHorizontal&&tk().controlArrows&&(//hidding it for the fist slide, showing for the rest
eE(B(tS,l.section),0!==l.slideIndex),eE(B(tT,l.section),null!=Y(l.destiny))),s.isActive&&!l.localIsResizing&&t7(l.slideIndex,l.slideAnchor,l.anchorLink),eH.emit(ez.onSlideLeave,l),/**
    ...
    */function(e,t,n){var i,r,o=t.destinyPos;if(i=t.slidesNav,r=t.slideIndex,tk().slidesNavigation&&null!=i&&(ei(B(eJ,i),eZ),en(B("a",B("li",i)[r]),eZ)),eR({scrollX:Math.round(o.left)}),tk().css3){var s="translate3d(-"+Math.round(o.left)+"px, 0px, 0px)";H.test.translate3dH[t.sectionIndex]=s,V(tB(B(tc,e)),tW(s)),clearTimeout(x),x=setTimeout(function(){n&&n$(t)},tk().scrollingSpeed)}else H.test.left[t.sectionIndex]=Math.round(o.left),tQ(e,Math.round(o.left),tk().scrollingSpeed,function(){n&&n$(t)})}(e,l,!0)}function nL(){clearTimeout(x)}function n$(e){e.localIsResizing||(eS(tk().afterSlideLoad)&&t0("afterSlideLoad",e),//needs to be inside the condition to prevent problems with continuousVertical and scrollHorizontally
//and to prevent double scroll right after a windows resize
eR({canScroll:!0}),t1(e.destiny),eH.emit(ez.afterSlideLoads,e)),eR({slideMoving:!1})}/**
    * Slides silently (with no animation) the active slider to the given slide.
    * @param noCallback {bool} true or defined -> no callbacks
    */function nk(e,t){tV(0,"internal"),void 0!==t&&eR({isResizing:!0}),nA(ec(e,ta),e),void 0!==t&&eR({isResizing:!1}),tV(tL.scrollingSpeed,"internal")}H.landscapeScroll=nA,eH.on(ez.bindEvents,function(){eH.on(ez.onPerformMovement,nC)});var n_=null,nD=null;/** 
     * Updates the state of the app.
     */function nO(){eq.activeSection=null,eq.sections.map(function(e){var t=W(e.item,eZ);e.isActive=t,e.hasScroll=nE.hasScroll(e.item),t&&(eq.activeSection=e),e.slides.length&&(e.activeSlide=null,e.slides.map(function(t){var n=W(t.item,eZ);t.hasScroll=nE.hasScroll(e.item),t.isActive=n,n&&(e.activeSlide=t)}))}),/**
     * When changes in the DOM take place there's a change 
     * the active section is now hidden or removed. 
     * fullPage.js will scroll to the closest section nearby.
     */function(){var e=eq.activeSection,t=!!eq.activeSection&&eq.activeSection.slides.length,n=eq.activeSection?eq.activeSection.activeSlide:null;if(!e&&eq.sections.length&&!eq.isBeyondFullpage&&n_){var i=nj(n_,eq.sections);i&&(eq.activeSection=i,eq.activeSection.isActive=!0,en(eq.activeSection.item,eZ)),eq.activeSection&&tU(eq.activeSection.item.offsetTop)}if(t&&!n&&nD){var r=nj(nD,eq.activeSection.slides);r&&(eq.activeSection.activeSlide=r,eq.activeSection.activeSlide.isActive=!0,en(eq.activeSection.activeSlide.item,eZ)),eq.activeSection.activeSlide&&nk(eq.activeSection.activeSlide.item,"internal")}}()}function nM(){var e=B(tk().sectionSelector,tC),t=z(e),n=Array.from(e).map(function(e){return new nI(e)}),i=n.filter(function(e){return e.isVisible}),r=i.reduce(function(e,t){return e.concat(t.slides)},[]);n_=nP(eq.activeSection),nD=nP(eq.activeSection?eq.activeSection.activeSlide:null),eq.numSections=t.length,eq.numSlides=i.reduce(function(e,t){return e+t.slides.length},0),eq.sections=i,eq.sectionsIncludingHidden=n,eq.slides=r,eq.panels=eq.sections.concat(eq.slides)}function nP(e){if(!e)return null;var t=e?e.item:null,n=e.isSection?eq.sectionsIncludingHidden:eq.activeSection.slidesIncludingHidden;if(t){var i=tj(n,t);return i?i.index():null}return null}function nj(e,t){var n,i=e-1,r=e;do{if(n=t[i]||t[r])break;i-=1,r+=1}while(i>=0||r<t.length)return n}/**
    * Section object
...
null!=c&&eq.activeSection&&(0!==eq.activeSection.index()||0===eq.activeSection.index()&&0!==c.index())?nk(c.item,"internal"):en(r[0],eZ)}nN.prototype=tM.prototype,nN.prototype.constructor=nI;var nR={attributes:!1,subtree:!0,childList:!0,characterData:!0};function nz(){return z(B(tk().slideSelector,tC)).length!==eq.numSlides}/**
     * Listen to changes on sections and fires reBuild
     * when those changes affect the section height.
     */function nB(e){var t=nz();(nz()||z(B(tk().sectionSelector,tC)).length!==eq.numSections)&&!eq.isDoingContinousVertical&&(tk().observer&&T&&// we modidy the DOM again
T.disconnect(),nM(),nO(),tk().anchors=[],eA(B(te)),nH(),tD(),tk().navigation&&nl(),t&&(eA(B(tg)),eA(B(tb))),eq.sections.forEach(function(e){e.slides.length?t&&nq(e):nS(e)})),tk().observer&&T&&B(eU)[0]&&T.observe(B(eU)[0],nR)}eH.on(ez.bindEvents,function(){var e,t;tk().observer&&"MutationObserver"in window&&B(eU)[0]&&(e=B(eU)[0],(t=new MutationObserver(nB)).observe(e,nR),T=t),eH.on(ez.contentChanged,nB)}),H.render=nB;var nF=function(){//cheks for passive event support
...
c.push(Math.abs(t));var r=i-l;l=i,r>200&&(c=[])},isAccelerating:function(){var e=eO(c,10),t=eO(c,70);return!!c.length&&e>=t&&s},getDirection:function(){return a}});function nU(){var e=tk().css3?eh()+G():eD(eq.sections).item.offsetTop+eD(eq.sections).item.offsetHeight,t=tR(e);H.test.top=-e+"px",eR({canScroll:!1}),tQ(t.element,t.options,tk().scrollingSpeed,function(){setTimeout(function(){eR({isBeyondFullpage:!0}),eR({canScroll:!0})},30)})}function nV(){tC.getBoundingClientRect().bottom>=0&&nX()}function nX(){var e=tR(eD(eq.sections).item.offsetTop);eR({canScroll:!1}),tQ(e.element,e.options,tk().scrollingSpeed,function(){eR({canScroll:!0}),eR({isBeyondFullpage:!1}),eR({isAboutToScrollToFullPage:!1})})}var nY=(u=!1,d={},p={},function(e,t,n){switch(e){case"set":d[t]=new Date().getTime(),p[t]=n;break;case"isNewKeyframe":u=new Date().getTime()-d[t]>p[t]}return u});/**
    * Moves the page down one section.
    */function nK(){var e=eq.activeSection.next();//looping to the top if there's no more sections below
!e&&(tk().loopBottom||tk().continuousVertical)&&(e=eq.sections[0]),null!=e?nh(e,null,!1):tC.scrollHeight<tX.scrollHeight&&tk().scrollBar&&tk().scrollBeyondFullpage&&eH.emit(ez.scrollBeyondFullpage)}/**
    * Moves the page up one section.
    */function nQ(){var e=eq.activeSection.prev();//looping to the bottom if there's no more sections above
!e&&(tk().loopTop||tk().continuousVertical)&&(e=eD(eq.sections)),null!=e&&nh(e,null,!0)}H.moveSectionDown=nK,H.moveSectionUp=nQ;var nZ=0;/**
    * Detecting the direction of the mouse movement.
    * Used only for the middle button of the mouse.
    */function nJ(e){tk().autoScrolling&&(eq.canScroll&&(e.pageY<nZ&&nt.m.up?nQ():e.pageY>nZ&&nt.m.down&&nK()),nZ=e.pageY)}/**
    * Determines the way of scrolling up or down:
    * by 'automatically' scrolling a section or by using the default and normal scrolling.
    */function n0(e){if(nt.m[e]){var t="down"===e?nK:nQ;tk().scrollOverflow&&nE.isScrollable(eq.activeSection)?nE.isScrolled(e,eq.activeSection.item)&&nE.shouldMovePage()&&t():t()}}var n1=0,n2=0,n3=0,n4=0,n9=(O.PointerEvent&&(e={down:"pointerdown",move:"pointermove"}),e),n6={touchmove:"ontouchmove"in window?"touchmove":n9?n9.move:null,touchstart:"ontouchstart"in window?"touchstart":n9?n9.down:null};/* Detecting touch events

    * As we are changing the top property of the page on scrolling, we can not use the traditional way to detect it.
    * This way, the touchstart and the touch moves shows an small difference between them which is the
    * used one to determine the direction.
    */function n7(e){var t=ec(e.target,e3)||eq.activeSection.item,n=nE.isScrollable(eq.activeSection);if(n5(e)){eR({isGrabbing:!0,isUsingWheel:!1}),tk().autoScrolling&&(n&&!eq.canScroll||tk().scrollBar)&&eg(e);var i=it(e);n3=i.y,n4=i.x;var r=Math.abs(n1-n3)>O.innerHeight/100*tk().touchSensitivity,o=Math.abs(n2-n4)>U()/100*tk().touchSensitivity,s=B(ta,t).length&&Math.abs(n2-n4)>Math.abs(n1-n3),a=n2>n4?"right":"left",l=n1>n3?"down":"up";eR({touchDirection:s?a:l}),s?!eq.slideMoving&&o&&(n2>n4?nt.m.right&&eH.emit(ez.moveSlideRight,{section:t}):nt.m.left&&eH.emit(ez.moveSlideLeft,{section:t})):tk().autoScrolling&&eq.canScroll&&r&&n0(l)}}/**
    * As IE >= 10 fires both touch and mouse events when using a mouse in a touchscreen
    * this way we make sure that is really a touch event what IE is detecting.
    */function n5(e){//if is not IE   ||  IE is detecting `touch` or `pen`
return void 0===e.pointerType||"mouse"!=e.pointerType}/**
    * Handler for the touch start event.
    */function n8(e){if(tk().fitToSection&&eR({activeAnimation:!1}),n5(e)){var t=it(e);n1=t.y,n2=t.x}ey("touchend",ie)}/**
    ...
    */function ii(e){tk().autoScrolling&&n5(e)&&nt.m.up&&!eq.canScroll&&eg(e)}/**
...
if(!tk().loopHorizontal)return;s="left"===e?eD(i.slides):i.slides[0]}eR({slideMoving:!H.test.isTesting}),nA(r,s.item,e)}}/**
...
var u=a==l[0],d=a==l[l.length-1],p=s&&u;if(p||!s&&d){eg(e);var h=/**
     ...
     *
     */function(e){var t,n=e?"prevPanel":"nextPanel",i=[],r=tq((eq.activeSection&&eq.activeSection.activeSlide?eq.activeSection.activeSlide:eq.activeSection)[n]());do(i=ib(r.item)).length&&(t={panel:r,itemToFocus:i[e?i.length-1:0]}),r=tq(r[n]());while(r&&0===i.length)return t}(p),f=h?h.panel:null;if(f){var g=f.isSection?f:f.parent;eH.emit(ez.onScrollPageAndSlide,{sectionAnchor:g.index()+1,slideAnchor:f.isSection?0:f.index()}),A=h.itemToFocus,eg(e)}}}}(e):!ej()&&tk().keyboardScrolling&&i&&(E=e.ctrlKey,C=setTimeout(function(){/**
    * Keydown event
...
var l=t-iw;return iw=t,l>200&&(iS=[]),eR({wheelDirection:o<0?"down":o>0?"up":"none"}),eq.canScroll&&eO(iS,10)>=eO(iS,70)&&a&&(eR({scrollTrigger:"wheel"}),o<0?n0("down"):n0("up")),!1}tk().fitToSection&&eR({activeAnimation:!1})}//binding the mousemove when the mouse's middle button is released
...
2==e.which&&tC.removeEventListener("mousemove",nJ)}/**
    ...
    */function(){if(n6.touchmove&&(P||I)){tk().autoScrolling&&(tX.removeEventListener(n6.touchmove,ii,{passive:!1}),tX.addEventListener(n6.touchmove,ii,{passive:!1}));var e=tk().touchWrapper;e.removeEventListener(n6.touchstart,n8),e.removeEventListener(n6.touchmove,n7,{passive:!1}),e.addEventListener(n6.touchstart,n8),e.addEventListener(n6.touchmove,n7,{passive:!1})}}()):(ix(!1),/**
    * Removes the auto scrolling for touch devices.
    */function(){if(n6.touchmove&&(P||I)){tk().autoScrolling&&(tX.removeEventListener(n6.touchmove,n7,{passive:!1}),tX.removeEventListener(n6.touchmove,ii,{passive:!1}));var e=tk().touchWrapper;e.removeEventListener(n6.touchstart,n8),e.removeEventListener(n6.touchmove,n7,{passive:!1})}}())}H.setMouseWheelScrolling=ix;var iL=!0;function i$(){["mouseenter","touchstart","mouseleave","touchend"].forEach(function(e){eb(e,i_,!0);//true is required!
...
tk().autoScrolling&&!tk().scrollBar&&(eR({isResizing:!0}),iD(eq.activeSection.index()+1),eR({isResizing:!1}))})},200*e)}(),iP=!0,//http://stackoverflow.com/questions/4298612/jquery-how-to-call-resize-event-only-once-its-finished-resizing    
...
/**
    ...
    */(function(){if(eR({isResizing:!0}),iH(""),tk().autoScrolling||eq.isBeyondFullpage||/**
...
Math.abs(i-iO)>20*Math.max(iO,i)/100&&(iN(!0),iO=i)}}else e=G(),t=U(),(eq.windowsHeight!==e||iM!==t)&&(eR({windowsHeight:e}),iM=t,iN(!0));eR({isResizing:!1})})(),iP=!1},400)}/**
     * When resizing is finished, we adjust the slides sizes and positions
     */function iN(e){if(!W(tC,eY)){//nothing to do if the plugin was destroyed
//updating global vars
eR({isResizing:!0,windowsHeight:G(),windowsWidth:U()});for(var t=eq.sections,n=0;n<t.length;++n){var i=t[n],r=B(ta,i.item)[0];i.slides.length>1&&nA(r,i.activeSlide.item)}tk().scrollOverflow&&nE.makeScrollable();var o=eq.activeSection.index();!eq.isBeyondFullpage&&o&&iD(o+1),eR({isResizing:!1}),eS(tk().afterResize)&&e&&tk().afterResize.call(tC,O.innerWidth,O.innerHeight),eS(tk().afterReBuild)&&!e&&tk().afterReBuild.call(tC),ex(tC,"afterRebuild")}}function iH(e){var t=""===e?"":e+"px";eq.sections.forEach(function(e){V(e.item,{height:t})})}function iq(){var e,t,n=O.location.hash;if(n.length){//getting the anchor link in the URL and deleting the `#`
...
e=r?"/"+i[1]:decodeURIComponent(i[0]);var o=r?i[2]:i[1];o&&o.length&&(t=decodeURIComponent(o))}return{section:e,slide:t}}function iR(){ew("hashchange",iz)}/**
    ...
    */function iz(){if(!eq.isScrolling&&!tk().lockAnchors){var e=iq(),t=e.section,n=e.slide,i=void 0===eq.lastScrolledDestiny,r=void 0===eq.lastScrolledDestiny&&void 0===n&&!eq.slideMoving;t&&t.length&&(t&&t!==eq.lastScrolledDestiny&&!i||r||!eq.slideMoving&&eq.lastScrolledSlide!=n)&&eH.emit(ez.onScrollPageAndSlide,{sectionAnchor:t,slideAnchor:n})}}function iB(e){var t=e.target;ec(t,tk().menu+" [data-menuanchor]")&&iF.call(t,e)}//Menu item handler when not using anchors or using lockAnchors:true
function iF(e){eR({scrollTrigger:"menu"}),B(tk().menu)[0]&&(tk().lockAnchors||!tk().anchors.length)&&(eg(e),/*jshint validthis:true */eH.emit(ez.onMenuClick,{anchor:em(this,"data-menuanchor")}))}function iW(e){var t=e.target;t&&ec(t,te+" a")?nc.call(t,e.e):eT(t,tn)?na.call(t):(eT(t,tm)||null!=ec(t,tm))&&ne.call(t,e.e)}H.reBuild=iN,eH.on(ez.bindEvents,function(){// Setting VH correctly in mobile devices
...
//(a way to detect back history button as we play with the hashes on the URL)
ey("hashchange",iz),eH.on(ez.onDestroy,iR)}),eH.on(ez.bindEvents,function(){ev("wheel",nG.registerEvent,nW()),eH.on(ez.scrollBeyondFullpage,nU),eH.on(ez.onKeyDown,nV)}),eH.on(ez.bindEvents,function(){eH.on(ez.onClickOrTouch,iB)}),eH.on(ez.bindEvents,function(){eH.on(ez.onClickOrTouch,iW)});var iG=0;function iU(e){if(!eq.isResizing&&eq.activeSection&&(eD(eq.sections),!eq.isBeyondFullpage&&!eq.isAboutToScrollToFullPage&&(!tk().autoScrolling||tk().scrollBar))){var t=eh(),n=(l=t>iG?"down":"up",iG=t,eR({previousDestTop:t}),l),i=0,r=t+G()/2,o=tX.scrollHeight-G()===t,s=eq.sections;if(eR({scrollY:t}),o)i=s.length-1;else if(t)for(var a=0;a<s.length;++a)s[a].item.offsetTop<=r&&(i=a);else i=0;//executing only once the first time we reach the section
if(u=(c=eq.activeSection.item.offsetTop)+G(),("up"==n?u>=eh()+G():c<=eh())&&!W(eq.activeSection.item,e0)&&(en(eq.activeSection.item,e0),ei(ef(eq.activeSection.item),e0)),p=(d=s[i]).item,!d.isActive){eR({isScrolling:!0});var l,c,u,d,p,h,f,g=eq.activeSection.item,m=eq.activeSection.index()+1,v=tF(eq.activeSection,p),y=d.anchor,b=d.index()+1,w=d.activeSlide,S={activeSection:g,sectionIndex:b-1,anchorLink:y,element:p,leavingSection:m,direction:v,items:{origin:eq.activeSection,destination:d}};w&&(f=w.anchor,h=w.index()),eq.canScroll&&(en(p,eZ),ei(ef(p),eZ),eS(tk().beforeLeave)&&np("beforeLeave",S),eS(tk().onLeave)&&t0("onLeave",S),eS(tk().afterLoad)&&t0("afterLoad",S),t3(g),t4(p),t1(p),nu(y,b-1),tk().anchors.length&&eR({lastScrolledDestiny:y}),nO(),t7(h,f,y)),clearTimeout(_),_=setTimeout(function(){eR({isScrolling:!1})},100)}tk().fitToSection&&eq.canScroll&&(clearTimeout(D),D=setTimeout(function(){eq.sections.filter(function(e){var t=e.item.getBoundingClientRect();return Math.round(t.bottom)===Math.round(G())||0===Math.round(t.top)}).length||nm()},tk().fitToSectionDelay))}}/**
    ...
    */function iX(){var e,t,n=eq.activeSection,i=eq.activeSection.item;en(i,e0),t4(i),ns(),t1(i),t=ia((e=iq()).section),(!e.section||!t||void 0!==t&&t.index()===Q(nw))&&eS(tk().afterLoad)&&t0("afterLoad",{activeSection:i,element:i,direction:null,//for backwards compatibility callback (to be removed in a future!)
anchorLink:n.anchor,sectionIndex:n.index(),items:{origin:eq.activeSection,destination:eq.activeSection}}),eS(tk().afterRender)&&t0("afterRender")}/**
...
H.shared=Object.assign(H.shared,{afterRenderActions:null,isNormalScrollElement:!1}),O.fullpage_api=H,tC&&(eH.emit(ez.beforeInit),nM(),nO(),tk().scrollBar=tk().scrollBar||tk().hybrid,tD(),/**
    ...
    */function(e){var t=e.index();void 0!==tk().anchors[t]&&e.isActive&&nu(tk().anchors[t],t),tk().menu&&tk().css3&&null!=ec(B(tk().menu)[0],eU)&&B(tk().menu).forEach(function(e){tX.appendChild(e)})}(n),i.length>0&&nq(n)}//fixed elements need to be moved out of the plugin container due to problems with CSS3.
...
for(let n=0;n<this.length;n+=1){let i=this[n].children;for(let n=0;n<i.length;n+=1)(!e||S(i[n]).is(e))&&t.push(i[n])}return S(t)},filter:function(e){let t=w(this,e);return S(t)},remove:function(){for(let e=0;e<this.length;e+=1)this[e].parentNode&&this[e].parentNode.removeChild(this[e]);return this}};function C(e,t=0){return setTimeout(e,t)}function A(){return Date.now()}function L(e){return"object"==typeof e&&null!==e&&e.constructor&&"Object"===Object.prototype.toString.call(e).slice(8,-1)}function k(...e){let t=Object(e[0]),n=["__proto__","constructor","prototype"];for(let i=1;i<e.length;i+=1){let r=e[i];if(null!=r&&// eslint-disable-next-line
("undefined"!=typeof window&&void 0!==window.HTMLElement?!(r instanceof HTMLElement):!r||1!==r.nodeType&&11!==r.nodeType)){let e=Object.keys(Object(r)).filter(e=>0>n.indexOf(e));for(let n=0,i=e.length;n<i;n+=1){let i=e[n],o=Object.getOwnPropertyDescriptor(r,i);void 0!==o&&o.enumerable&&(L(t[i])&&L(r[i])?r[i].__swiper__?t[i]=r[i]:k(t[i],r[i]):!L(t[i])&&L(r[i])?(t[i]={},r[i].__swiper__?t[i]=r[i]:k(t[i],r[i])):t[i]=r[i])}}}return t}function _(e,t,n){e.style.setProperty(t,n)}function D({swiper:e,targetPosition:t,side:n}){let i;let r=v(),o=-e.translate,s=null,a=e.params.speed;e.wrapperEl.style.scrollSnapType="none",r.cancelAnimationFrame(e.cssModeFrameID);let l=t>o?"next":"prev",c=(e,t)=>"next"===l&&e>=t||"prev"===l&&e<=t,u=()=>{i=new Date().getTime(),null===s&&(s=i);let l=Math.max(Math.min((i-s)/a,1),0),d=o+(.5-Math.cos(l*Math.PI)/2)*(t-o);if(c(d,t)&&(d=t),e.wrapperEl.scrollTo({[n]:d}),c(d,t)){e.wrapperEl.style.overflow="hidden",e.wrapperEl.style.scrollSnapType="",setTimeout(()=>{e.wrapperEl.style.overflow="",e.wrapperEl.scrollTo({[n]:d})}),r.cancelAnimationFrame(e.cssModeFrameID);return}e.cssModeFrameID=r.requestAnimationFrame(u)};u()}function O(){return e||(e=function(){let e=v(),t=g();return{smoothScroll:t.documentElement&&"scrollBehavior"in t.documentElement.style,touch:!!("ontouchstart"in e||e.DocumentTouch&&t instanceof e.DocumentTouch),passiveListener:function(){let t=!1;try{let n=Object.defineProperty({},"passive",{// eslint-disable-next-line
...
e.fn.select2.amd=t,n)},"function"==typeof define&&define.amd?define(["jquery"],r):ei?ei=function(e,t){return void 0===t&&(t="undefined"!=typeof window?l("3oRXo"):l("3oRXo")(e)),r(t),t}:r(jQuery),/*@__PURE__*/i(ei)(/*@__PURE__*/i(en)),window.$=window.jQuery=/*@__PURE__*/i(en),window.addEventListener("load",function(){(function(){document.querySelector(".delivery")&&new V(".delivery",{modules:[K,Y,ee,et],loop:!0,centeredSlides:!0,effect:"creative",grabCursor:!0,autoplay:{delay:5e3,disableOnInteraction:!1},pagination:{el:".delivery-pagination",clickable:!0},creativeEffect:{limitProgress:2,prev:{translate:["-100%",-60,-60]},next:{translate:["100%",-60,-60]}},breakpoints:{641:{slidesPerView:1.5,spaceBetween:10,creativeEffect:{limitProgress:2,prev:{translate:["-90%",-40,-40]},next:{translate:["90%",-40,-40]}}},769:{spaceBetween:40,slidesPerView:2,creativeEffect:{limitProgress:2,prev:{translate:["-90%",-40,-40]},next:{translate:["90%",-40,-40]}}}}}),document.querySelector(".about")&&new V(".about",{modules:[K,Y,ee,et],slidesPerView:1,loop:!0,grabCursor:!0,pagination:{el:".about-pagination",clickable:!0},breakpoints:{481:{direction:"vertical"}}});let e=new V(".geography",{modules:[K,Y,ee,et],effect:"fade",loop:!0,grabCursor:!0,observer:!0,grabCursor:!0,autoplay:{delay:5e3,disableOnInteraction:!1},pagination:{el:".geography-pagination",bulletClass:"swiper-pagination-bullet-custom",bulletActiveClass:"swiper-pagination-bullet-custom--active",renderBullet:function(e,t){return`<div class="${t}" data-index="${e}">
          ...
          </div>`},clickable:!0},on:{init:function(){var e;this.el.style.setProperty("--delay",this.params.autoplay.delay),document.querySelectorAll(".swiper-pagination-bullet-custom line").forEach(e=>{e.setAttribute("x2","0")}),null===(e=document.querySelector(".swiper-pagination-bullet-custom.swiper-pagination-bullet-custom--active line"))||void 0===e||e.setAttribute("x2","80")},slideChange:function(){var e;document.querySelectorAll(".swiper-pagination-bullet-custom line").forEach(e=>{e.setAttribute("x2","0")}),null===(e=document.querySelector(".swiper-pagination-bullet-custom.swiper-pagination-bullet-custom--active line"))||void 0===e||e.setAttribute("x2","80")}}}),t=document.querySelector(".header");window.innerWidth>1366&&/*@__PURE__*/i(d)("#fullpage",{navigation:!1,onLeave:function(n,i,r,o,s){!0==i.isLast?t.classList.add("close"):document.querySelector(".header.close")&&t.classList.remove("close"),document.querySelector(".fp-viewing-1")&&document.querySelector(".geography")&&e.slideToLoop(0,0),document.querySelector(".fp-viewing-3")&&document.querySelector(".geography")&&e.slideToLoop(0,0)}}),window.innerWidth<=1366&&window.addEventListener("scroll",function(){var e=null,n=/*@__PURE__*/i(en)(window).scrollTop(),r=/*@__PURE__*/i(en)(window).height(),o=/*@__PURE__*/i(en)(".footer").offset().top,s=/*@__PURE__*/i(en)(".footer").outerHeight();n+r>=o&&n+r-2*s<=o+(r-s)?((null==e||!1==e)&&t.classList.add("close"),e=!0):((null==e||!0==e)&&t.classList.remove("close"),e=!1)})})(),document.querySelectorAll('a[href^="#"]').forEach(e=>{e.addEventListener("click",function(e){e.preventDefault(),document.querySelector(this.getAttribute("href")).scrollIntoView({behavior:"smooth"})})}),new c,new u;var e,t,n=document.querySelector(".containerMin");let r=document.querySelectorAll(".geography-box"),o=document.querySelectorAll(".geography-nav");function s(e){return e.id?/*@__PURE__*/i(en)(/*@__PURE__*/i(en)(`[data-template="${e.id}"]`).html()):e.text}n&&(e=n.getBoundingClientRect(),t=window.innerWidth>768?e.left+50:window.innerWidth>375?e.left+30:e.left+12),null==r||r.forEach(function(e){e.style.left=""+t+"px"}),null==o||o.forEach(function(e){e.style.left=""+t+"px"}),window.innerWidth<=992&&(null==r||r.forEach(function(e){e.style.right=""+t+"px"}),null==o||o.forEach(function(e){e.style.right=""+t+"px"})),window.addEventListener("resize",function(){null==r||r.forEach(function(e){e.style.left=""+t+"px"}),null==o||o.forEach(function(e){e.style.left=""+t+"px"}),window.innerWidth<=992&&(null==r||r.forEach(function(e){e.style.right=""+t+"px"}),null==o||o.forEach(function(e){e.style.right=""+t+"px"}))}),window.innerWidth<640&&(/*@__PURE__*/i(en)(".select").select2({minimumResultsForSearch:1/0,templateResult:s,templateSelection:s}),/*@__PURE__*/i(en)(".select").on("select2:select",function(e){let t=e.target.value;console.log(t),document.querySelectorAll(".tab-content").forEach(function(e){e.getAttribute("id")==t&&(document.querySelector(".tab-content.current").classList.remove("current"),e.classList.add("current"))})}))});//# sourceMappingURL=about.2fe4c38a.js.map

//# sourceMappingURL=about.2fe4c38a.js.map
