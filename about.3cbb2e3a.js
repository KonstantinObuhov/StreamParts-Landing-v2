...
T.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "),function(e,t){c["[object "+t+"]"]=t.toLowerCase()});var A=i.pop,L=i.sort,_=i.splice,k="[\\x20\\t\\r\\n\\f]",O=RegExp("^"+k+"+|((?:^|[^\\\\])(?:\\\\.)*)"+k+"+$","g");// Note: an element does not contain itself
...
var D=/([\0-\x1f\x7f]|^-?\d)|^-$|[^\x80-\uFFFF\w-]/g;function M(e,t){return t?// U+0000 NULL becomes U+FFFD REPLACEMENT CHARACTER
"\x00"===e?"�":e.slice(0,-1)+"\\"+e.charCodeAt(e.length-1).toString(16)+" ":"\\"+e}T.escapeSelector=function(e){return(e+"").replace(D,M)},function(){var t,n,r,s,c,u,p,h,g,m,y=a,b=T.expando,w=0,S=0,x=et(),E=et(),D=et(),M=et(),P=function(e,t){return e===t&&(c=!0),0},j="checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",// https://www.w3.org/TR/css-syntax-3/#ident-token-diagram
I="(?:\\\\[\\da-fA-F]{1,6}"+k+"?|\\\\[^\\r\\n\\f]|[\\w-]|[^\x00-\\x7f])+",N="\\["+k+"*("+I+")(?:"+k+// Operator (capture 2)
"*([*^$|!~]?=)"+k+// "Attribute values must be CSS identifiers [capture 5] or strings [capture 3 or capture 4]"
"*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|("+I+"))|)"+k+"*\\]",H=":("+I+")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|"+N+")*)|.*)\\)|)",q=RegExp(k+"+","g"),R=RegExp("^"+k+"*,"+k+"*"),z=RegExp("^"+k+"*([>+~]|"+k+")"+k+"*"),B=RegExp(k+"|>"),F=new RegExp(H),W=RegExp("^"+I+"$"),G={ID:RegExp("^#("+I+")"),CLASS:RegExp("^\\.("+I+")"),TAG:RegExp("^("+I+"|[*])"),ATTR:RegExp("^"+N),PSEUDO:RegExp("^"+H),CHILD:RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\("+k+"*(even|odd|(([+-]|)(\\d*)n|)"+k+"*(?:([+-]|)"+k+"*(\\d+)|))"+k+"*\\)|)","i"),bool:RegExp("^(?:"+j+")$","i"),// For use in libraries implementing .is()
// We use this for POS matching in `select`
needsContext:RegExp("^"+k+"*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\("+k+"*((?:-\\d)?\\d*)"+k+"*\\)|)(?=[^-]|$)","i")},U=/^(?:input|select|textarea|button)$/i,V=/^h\d$/i,Y=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,X=/[+~]/,// https://www.w3.org/TR/CSS21/syndata.html#escaped-characters
K=RegExp("\\\\[\\da-fA-F]{1,6}"+k+"?|\\\\([^\\r\\n\\f])","g"),Q=function(e,t){var n="0x"+e.slice(1)-65536;return t||(n<0?String.fromCharCode(n+65536):String.fromCharCode(n>>10|55296,1023&n|56320))},// Support: IE 9 - 11+, Edge 12 - 18+
...
if(11!==m&&(l=Y.exec(e))){// ID selector
...
(p=X.test(e)&&es(t.parentNode)||t)==t&&f.scope||((a=t.getAttribute("id"))?a=T.escapeSelector(a):t.setAttribute("id",a=b)),o=// Prefix every selector in the list
...
(t=u.createElement("input")).setAttribute("name",""),e.appendChild(t),e.querySelectorAll("[name='']").length||g.push("\\["+k+"*name"+k+"*="+k+"*(?:''|\"\")")}),f.cssHas||// Our regular `try-catch` mechanism fails to detect natively-unsupported
...
c=!f.sortStable,s=!f.sortStable&&o.call(e,0),L.call(e,P),c){for(;t=e[r++];)t===e[r]&&(i=n.push(r));for(;i--;)_.call(e,n[i],1)}return(// Clear input after sorting to release objects
...
e[0]=e[0].slice(0,t),e[2]=n.slice(0,t)),e.slice(0,3))}},filter:{TAG:function(e){var t=e.replace(K,Q).toLowerCase();return"*"===e?function(){return!0}:function(e){return C(e,t)}},CLASS:function(e){var t=x[e+" "];return t||(t=RegExp("(^|"+k+")"+e+"("+k+"|$)"),x(e,function(e){return t.test("string"==typeof e.className&&e.className||void 0!==e.getAttribute&&e.getAttribute("class")||"")}))},ATTR:function(e,t,n){return function(i){var r=ee.attr(i,e);return null==r?"!="===t:!t||((r+="","="===t)?r===n:"!="===t?r!==n:"^="===t?n&&0===r.indexOf(n):"*="===t?n&&r.indexOf(n)>-1:"$="===t?n&&r.slice(-n.length)===n:"~="===t?(" "+r.replace(q," ")+" ").indexOf(n)>-1:"|="===t&&(r===n||r.slice(0,n.length+1)===n+"-"))}},CHILD:function(e,t,n,i,r){var o="nth"!==e.slice(0,3),s="last"!==e.slice(-4),a="of-type"===t;return 1===i&&0===r?function(e){return!!e.parentNode}:function(t,n,l){var c,u,d,p,h,f=o!==s?"nextSibling":"previousSibling",g=t.parentNode,m=a&&t.nodeName.toLowerCase(),v=!l&&!a,y=!1;if(g){// :(first|last|only)-(child|of-type)
...
var t=[],n=[],i=ef(e.replace(O,"$1"));return i[b]?en(function(e,t,n,r){// Match elements unmatched by `matcher`
...
for(s in(!i||(r=R.exec(a)))&&(r&&(a=a.slice(r[0].length)||a),l.push(o=[])),i=!1,(r=z.exec(a))&&(i=r.shift(),o.push({value:i,// Cast descendant combinators to space
type:r[0].replace(O," ")}),a=a.slice(i.length)),n.filter)(r=G[s].exec(a))&&(!c[s]||(r=c[s](r)))&&(i=r.shift(),o.push({value:i,type:s,matches:r}),a=a.slice(i.length));if(!i)break}return(// Return the length of the invalid excess
...
(p=D(e,(i=c.length>0,o=d.length>0,s=function(e,t,s,a,l){var p,f,g,m=0,v="0",b=e&&[],S=[],x=r,E=e||o&&n.find.TAG("*",l),C=w+=null==x?1:Math.random()||.1,L=E.length;// Add elements passing elementMatchers directly to results
...
o--&&(a=s[o],!n.relative[l=a.type]);)if((c=n.find[l])&&(r=c(a.matches[0].replace(K,Q),X.test(s[0].type)&&es(t.parentNode)||t))){if(// If seed is empty or no tokens remain, we can return early
...
(u||ef(e,d))(r,t,!h,i,!t||X.test(e)&&es(t.parentNode)||t),i)}el.prototype=n.filters=n.pseudos,n.setFilters=new el,// One-time assignments
...
n=n||q,"string"==typeof e){// Match html or make sure no context is specified for #id
if((i="<"===e[0]&&">"===e[e.length-1]&&e.length>=3?[null,e,null]:R.exec(e))&&(i[1]||!t)){// HANDLE: $(html) -> $(array)
...
q=T(v);var z=/^(?:parents|prev(?:Until|All))/,B={children:!0,contents:!0,next:!0,prev:!0};function F(e,t){for(;(e=e[t])&&1!==e.nodeType;);return e}T.fn.extend({has:function(e){var t=T(e,this),n=t.length;return this.filter(function(){for(var e=0;e<n;e++)if(T.contains(this,t[e]))return!0})},closest:function(e,t){var n,i=0,r=this.length,o=[],s="string"!=typeof e&&T(e);// Positional selectors never match, since there's no _selection_ context
...
e.console&&e.console.warn&&t&&Y.test(t.name)&&e.console.warn("jQuery.Deferred exception: "+t.message,t.stack,n)},T.readyException=function(t){e.setTimeout(function(){throw t})};// The deferred used on DOM ready
var X=T.Deferred();// The ready event handler and self cleanup method
function K(){v.removeEventListener("DOMContentLoaded",K),e.removeEventListener("load",K),T.ready()}T.fn.ready=function(e){return X.then(e)// Wrap jQuery.readyException in a function so that the lookup
...
X.resolveWith(v,[T]))}}),T.ready.then=X.then,"complete"!==v.readyState&&("loading"===v.readyState||v.documentElement.doScroll)?(// Use the handy event callback
...
s=eT(u.appendChild(o),"script"),l&&eE(s),n)for(c=0;o=s[c++];)eS.test(o.type||"")&&n.push(o)}return u}var eL=/^([^.]*)(?:\.(.+)|)/;function e$(){return!0}function e_(){return!1}function ek(e,t,n,i,r,o){var s,a;// Types can be a map of types/handlers
...
function eO(e,t,n){// Missing `isSetup` indicates a trigger call, which must force setup through jQuery.event.add
...
!1===e.returnValue?e$:e_,// Create target properties
...
eO(this,e),!0)},teardown:function(){var e;if(!v.documentMode)return!1;(e=er.get(this,t)-1)?er.set(this,t,e):(this.removeEventListener(t,n),er.remove(this,t))},// Suppress native focus or blur if we're currently inside
...
eD=/<script|<style|<link/i,eM=/checked\s*(?:[^=]|=\s*.checked.)/i,eP=/^\s*<!\[CDATA\[|\]\]>\s*$/g;// Prefer a tbody over its parent table for containing new rows
...
eo.hasData(e)&&(o=eo.access(e),s=T.extend({},o),eo.set(t,s))}}function eq(e,t,n,i){// Flatten any nested arrays
t=s(t);var r,o,a,l,c,u,d=0,p=e.length,h=p-1,m=t[0],v=g(m);// We can't cloneNode fragments that contain checked, in WebKit
if(v||p>1&&"string"==typeof m&&!f.checkClone&&eM.test(m))return e.each(function(r){var o=e.eq(r);v&&(t[0]=m.call(this,r,o.html())),eq(o,t,n,i)});if(p&&(o=(r=eA(t,e[0].ownerDocument,!1,e,i)).firstChild,1===r.childNodes.length&&(r=o),o||i)){// Use the original fragment for the last item
...
b(c.textContent.replace(eP,""),c,u))}return e}function eR(e,t,n){for(var i,r=t?T.filter(t,e):e,o=0;null!=(i=r[o]);o++)n||1!==i.nodeType||T.cleanData(eT(i)),i.parentNode&&(n&&eh(i)&&eE(eT(i,"script")),i.parentNode.removeChild(i));return e}T.extend({htmlPrefilter:function(e){return e},clone:function(e,t,n){var i,r,o,s,a=e.cloneNode(!0),l=eh(e);// Fix IE cloning issues
...
(n[eo.expando]=void 0)}}}),T.fn.extend({detach:function(e){return eR(this,e,!0)},remove:function(e){return eR(this,e)},text:function(e){return Q(this,function(e){return void 0===e?T.text(this):this.empty().each(function(){(1===this.nodeType||11===this.nodeType||9===this.nodeType)&&(this.textContent=e)})},null,e,arguments.length)},append:function(){return eq(this,arguments,function(e){(1===this.nodeType||11===this.nodeType||9===this.nodeType)&&ej(this,e).appendChild(e)})},prepend:function(){return eq(this,arguments,function(e){if(1===this.nodeType||11===this.nodeType||9===this.nodeType){var t=ej(this,e);t.insertBefore(e,t.firstChild)}})},before:function(){return eq(this,arguments,function(e){this.parentNode&&this.parentNode.insertBefore(e,this)})},after:function(){return eq(this,arguments,function(e){this.parentNode&&this.parentNode.insertBefore(e,this.nextSibling)})},empty:function(){for(var e,t=0;null!=(e=this[t]);t++)1===e.nodeType&&(// Prevent memory leaks
...
if("string"==typeof e&&!eD.test(e)&&!ex[(ew.exec(e)||["",""])[1].toLowerCase()]){e=T.htmlPrefilter(e);try{for(;n<i;n++)t=this[n]||{},1===t.nodeType&&(T.cleanData(eT(t,!1)),t.innerHTML=e);t=0;// If using innerHTML throws an exception, use the fallback method
...
return eq(this,arguments,function(t){var n=this.parentNode;0>T.inArray(this,e)&&(T.cleanData(eT(this)),n&&n.replaceChild(t,this));// Force callback invocation
...
(s=s.replace(O,"$1")||void 0),""!==s||eh(e)||(s=T.style(e,t)),!f.pixelBoxStyles()&&ez.test(s)&&eG.test(t)&&(// Remember the original values
...
i.style.display="block",ep.appendChild(t).appendChild(n).appendChild(i),a=parseInt((r=e.getComputedStyle(n)).height,10)+parseInt(r.borderTopWidth,10)+parseInt(r.borderBottomWidth,10)===n.offsetHeight,ep.removeChild(t)),a}}))}();var eY=["Webkit","Moz","ms"],eX=v.createElement("div").style,eK={};// Return a potentially-mapped jQuery.cssProps or vendor prefixed property
function eQ(e){return T.cssProps[e]||eK[e]||(e in eX?e:eK[e]=// Return a vendor-prefixed property or undefined
function(e){for(// Check for vendor prefixed names
var t=e[0].toUpperCase()+e.slice(1),n=eY.length;n--;)if((e=eY[n]+t)in eX)return e}(e)||e)}var // except "table", "table-cell", or "table-caption"
...
T.fx.step={};var e6,e9,e7,e8,e5=/^(?:toggle|show|hide)$/,te=/queueHooks$/;// Animations created synchronously will run synchronously
...
p.always(function(){s.unqueued--,T.queue(e,"fx").length||s.empty.fire()})})),t)if(r=t[i],e5.test(r)){if(delete t[i],o=o||"toggle"===r,r===(g?"hide":"show")){// Pretend to be hidden if this is a "show" and
...
(e=n[t])()||n[t]!==e||n.splice(t--,1);n.length||T.fx.stop(),e7=void 0},T.fx.timer=function(e){T.timers.push(e),T.fx.start()},T.fx.interval=13,T.fx.start=function(){e8||(e8=!0,function t(){e8&&(!1===v.hidden&&e.requestAnimationFrame?e.requestAnimationFrame(t):e.setTimeout(t,T.fx.interval),T.fx.tick())}())},T.fx.stop=function(){e8=null},T.fx.speeds={slow:600,fast:200,// Default speed
...
return this.name&&!T(this).is(":disabled")&&tT.test(this.nodeName)&&!tx.test(e)&&(this.checked||!eb.test(e))}).map(function(e,t){var n=T(this).val();return null==n?null:Array.isArray(n)?T.map(n,function(e){return{name:t.name,value:e.replace(tS,"\r\n")}}):{name:t.name,value:n.replace(tS,"\r\n")}}).get()}});var tE=/%20/g,tC=/#.*$/,tA=/([?&])_=[^&]*/,tL=/^(.*?):[ \t]*([^\r\n]*)$/mg,t$=/^(?:GET|HEAD)$/,t_=/^\/\//,/* Prefilters
	 ...
	 */tO={},tD="*/".concat("*"),tM=v.createElement("a");// Base "constructor" for jQuery.ajaxPrefilter and jQuery.ajaxTransport
...
function tj(e,t,n,i){var r={},o=e===tO;function s(a){var l;return r[a]=!0,T.each(e[a]||[],function(e,a){var c=a(t,n,i);return"string"!=typeof c||o||r[c]?o?!(l=c):void 0:(t.dataTypes.unshift(c),s(c),!1)}),l}return s(t.dataTypes[0])||!r["*"]&&s("*")}// A special extend for ajax options
...
lastModified:{},etag:{},ajaxSettings:{url:tg.href,type:"GET",isLocal:/^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(tg.protocol),global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",/*
		...
		traditional: false,
		headers: {},
		*/accepts:{"*":tD,text:"text/plain",html:"text/html",xml:"application/xml, text/xml",json:"application/json, text/javascript"},contents:{xml:/\bxml\b/,html:/\bhtml/,json:/\bjson\b/},responseFields:{xml:"responseXML",text:"responseText",json:"responseJSON"},// Data converters
...
ajaxSetup:function(e,t){return t?tI(tI(e,T.ajaxSettings),t):tI(T.ajaxSettings,e)},ajaxPrefilter:tP(tk),ajaxTransport:tP(tO),// Main method
...
h.url=((t||h.url||tg.href)+"").replace(t_,tg.protocol+"//"),// Alias method option to type as per ticket trac-12004
...
tj(tk,h,n,E),c)return E;// Check for headers option
...
E.setRequestHeader("Accept",h.dataTypes[0]&&h.accepts[h.dataTypes[0]]?h.accepts[h.dataTypes[0]]+("*"!==h.dataTypes[0]?", "+tD+"; q=0.01":""):h.accepts["*"]),h.headers)E.setRequestHeader(d,h.headers[d]);// Allow custom headers/mimetypes and early abort
...
i=tj(tO,h,n,E)){// If request was aborted inside ajaxSend, stop there
...
v.head.appendChild(t[0])},abort:function(){n&&n()}}}});var tq=[],tR=/(=)\?(?=&|$)|\?\?/;// Default jsonp settings
T.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var e=tq.pop()||T.expando+"_"+tm.guid++;return this[e]=!0,e}}),// Detect, normalize options and install callbacks for jsonp requests
T.ajaxPrefilter("json jsonp",function(t,n,i){var r,o,s,a=!1!==t.jsonp&&(tR.test(t.url)?"url":"string"==typeof t.data&&0===(t.contentType||"").indexOf("application/x-www-form-urlencoded")&&tR.test(t.data)&&"data");// Handle iff the expected data type is "jsonp" or we have a parameter to set
if(a||"jsonp"===t.dataTypes[0])// Delegate to script
return(// Get callback name, remembering preexisting value associated with it
r=t.jsonpCallback=g(t.jsonpCallback)?t.jsonpCallback():t.jsonpCallback,a?t[a]=t[a].replace(tR,"$1"+r):!1!==t.jsonp&&(t.url+=(tv.test(t.url)?"&":"?")+t.jsonp+"="+r),// Use data converter to retrieve json after script execution
...
e.exports=n.document?i(n,!0):function(e){if(!e.document)throw Error("jQuery requires a window with a document");return i(e)}:i(n)});class c{constructor(e="menu-burger",t="menu"){this.menuBurger=document.getElementById(e),this.menu=document.getElementById(t),this.menuBurger.addEventListener("click",e=>{this.menuBurger.classList.toggle("open"),this.menu.classList.toggle("open")})}}class u{constructor(e="tab-nav-item",t="tab-nav-items",n="tab-content"){this.tabsNavItems=document.getElementsByClassName(e),this.tabNavList=document.getElementsByClassName(t),this.tabsContentItems=document.getElementsByClassName(n),this.handleClickOnTabs()}handleClickOnTabs(){for(let e of this.tabsNavItems)e.addEventListener("click",e=>{this.switchTab(e.target);// console.log(event.target);
})}switchTab(e){let t=e.getAttribute("data-tab");for(let e of this.tabsNavItems)e.classList.remove("active");for(let e of this.tabsContentItems)e.id===t?e.classList.add("current"):e.classList.remove("current");e.classList.add("active"),this.tabNavList[0].classList.toggle("expanded")}}var d={};/**
 * Swiper 7.4.1
 ...
 *//* eslint-disable no-param-reassign */function p(e){return null!==e&&"object"==typeof e&&"constructor"in e&&e.constructor===Object}function h(e={},t={}){Object.keys(t).forEach(n=>{void 0===e[n]?e[n]=t[n]:p(t[n])&&p(e[n])&&Object.keys(t[n]).length>0&&h(e[n],t[n])})}d=function(){Array.prototype.find||Object.defineProperty(Array.prototype,"find",{value:function(e){// 1. Let O be ? ToObject(this value).
...
return s.length=o,s}));var e,t,n,i,r,o,s,a,l,c,u,d,p,h,f,g,m,v,y,b,w,S,x,T,E,C,A,L,_,k,O,D=window,M=document,P=navigator.userAgent.match(/(iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/),j=/(Mac|iPhone|iPod|iPad)/i.test(D.navigator.userAgent),I="ontouchstart"in D||navigator.msMaxTouchPoints>0||navigator.maxTouchPoints,N=!!window.MSInputMethodContext&&!!document.documentMode,H={test:{},shared:{}},q=["parallax","scrollOverflowReset","dragAndMove","offsetSections","fadingEffect","responsiveSlides","continuousHorizontal","interlockedSlides","scrollHorizontally","resetSliders","cards","dropEffect","waterEffect"];//utils
/**
    * Shows a message in the console of the given type.
    */// function showError(type, text) {
//   win.console && win.console[type] && win.console[type]('fullPage: ' + text);
// }
function R(e){return"none"!==D.getComputedStyle(e).display}function z(e){return Array.from(e).filter(function(e){return R(e)})}/**
...
if("[object Object]"===Object.prototype.toString.call(i[r])){e[r]=F(e[r],i[r]);continue}e[r]=i[r]}}}return e}/**
    ...
    */function G(){return"innerHeight"in D?D.innerHeight:M.documentElement.offsetHeight}/**
    * Gets the window width.
    */function U(){return D.innerWidth}/**
    ...
    */function Y(e){return e.previousElementSibling}/**
...
function eh(){var e=M.documentElement;return(D.pageYOffset||e.scrollTop)-(e.clientTop||0)}/**
    * Gets the siblings of the passed element
    */function ef(e){return Array.prototype.filter.call(e.parentNode.children,function(t){return t!==e})}function eg(e){e.preventDefault()}function em(e,t){return e.getAttribute(t)}function ev(e,t,n){M.addEventListener(e,t,"undefined"===n?null:n)}function ey(e,t,n){D.addEventListener(e,t,"undefined"===n?null:n)}function eb(e,t,n){M.removeEventListener(e,t,"undefined"===n?null:n)}function ew(e,t,n){D.removeEventListener(e,t,"undefined"===n?null:n)}/**
    ...
    */function ex(e,t,n){var i;n=void 0===n?{}:n,"function"==typeof D.CustomEvent?i=new CustomEvent(t,{detail:n}):(i=M.createEvent("CustomEvent")).initCustomEvent(t,!0,!0,n),e.dispatchEvent(i)}/**
    * Polyfill of .matches()
...
function eL(e,t,n){for(var i=e[n],r=[];i;)(eT(i,t)||null==t)&&r.push(i),i=i[n];return r}/**
    ...
    */function e_(e,t){return eL(e,t,"previousElementSibling")}/**
    * Converts an object to an array.
    */function ek(e){return Object.keys(e).map(function(t){return e[t]})}function eO(e){return e[e.length-1]}/**
    * Gets the average of the last `number` elements of the given array.
    */function eD(e,t){for(var n=0,i=e.slice(Math.max(e.length-t,1)),r=0;r<i.length;r++)n+=i[r];return Math.ceil(n/t)}/**
...
window.fp_utils={$:B,deepExtend:F,hasClass:W,getWindowHeight:G,css:V,prev:Y,next:X,last:K,index:Q,getList:Z,hide:J,show:ee,isArrayOrList:et,addClass:en,removeClass:ei,appendTo:er,wrap:eo,wrapAll:es,unwrap:el,closest:ec,after:eu,before:ed,insertBefore:ep,getScrollTop:eh,siblings:ef,preventDefault:eg,isFunction:eS,trigger:ex,matches:eT,toggle:eE,createElementFromHTML:eC,remove:eA,// "filter": filter,
untilAll:eL,nextAll:e$,prevAll:e_};var eI=/*#__PURE__*/Object.freeze({__proto__:null,// showError: showError,
isVisible:R,getVisible:z,$:B,deepExtend:F,hasClass:W,getWindowHeight:G,getWindowWidth:U,css:V,prev:Y,next:X,last:K,index:Q,getList:Z,hide:J,show:ee,isArrayOrList:et,addClass:en,removeClass:ei,appendTo:er,wrap:eo,wrapAll:es,wrapInner:ea,unwrap:el,closest:ec,after:eu,before:ed,insertBefore:ep,getScrollTop:eh,siblings:ef,preventDefault:eg,getAttr:em,docAddEvent:ev,windowAddEvent:ey,docRemoveEvent:eb,windowRemoveEvent:ew,isFunction:eS,trigger:ex,matches:eT,toggle:eE,createElementFromHTML:eC,remove:eA,untilAll:eL,nextAll:e$,prevAll:e_,toArray:ek,getLast:eO,getAverage:eD,setSrc:eM,getParentsUntil:eP,isInsideInput:ej});function eN(e){return(eN="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}var eH={events:{},on:function(e,t){var n=this;return"object"!==eN(this.events[e])&&(this.events[e]=[]),this.events[e].push(t),function(){return n.removeListener(e,t)}},removeListener:function(e,t){if("object"===eN(this.events[e])){var n=this.events[e].indexOf(t);n>-1&&this.events[e].splice(n,1)}},emit:function(e){for(var t=this,n=arguments.length,i=Array(n>1?n-1:0),r=1;r<n;r++)i[r-1]=arguments[r];"object"===eN(this.events[e])&&this.events[e].forEach(function(e){return e.apply(t,i)})},once:function(e,t){var n=this,i=this.on(e,function(){i();for(var e=arguments.length,r=Array(e),o=0;o<e;o++)r[o]=arguments[o];t.apply(n,r)})}},eq={numSections:0,numSlides:0,slides:[],sections:[],activeSection:null,scrollTrigger:null,isBeyondFullpage:!1,aboutToScrollToFullPage:!1,slideMoving:!1,isResizing:!1,isScrolling:!1,lastScrolledDestiny:void 0,lastScrolledSlide:void 0,activeAnimation:!1,canScroll:!0,touchDirection:"none",wheelDirection:"none",isGrabbing:!1,isUsingWheel:!1,isWindowFocused:!0,previousDestTop:0,windowsHeight:G(),isDoingContinousVertical:!1,timeouts:{},scrollY:0,scrollX:0};function eR(e){Object.assign(eq,e)}D.state=eq;var ez={onAfterRenderNoAnchor:"onAfterRenderNoAnchor",onClickOrTouch:"onClickOrTouch",moveSlideLeft:"moveSlideLeft",moveSlideRight:"moveSlideRight",onInitialise:"onInitialise",beforeInit:"beforeInit",bindEvents:"bindEvents",onDestroy:"onDestroy",contentChanged:"contentChanged",onScrollOverflowScrolled:"onScrollOverflowScrolled",onScrollPageAndSlide:"onScrollPageAndSlide",onKeyDown:"onKeyDown",onMenuClick:"onMenuClick",scrollPage:"scrollPage",landscapeScroll:"landscapeScroll",scrollBeyondFullpage:"scrollBeyondFullpage",onPerformMovement:"onPerformMovement",onSlideLeave:"onSlideLeave",onLeave:"onLeave",afterSectionLoads:"afterSectionLoads",afterSlideLoads:"afterSlideLoads"};function eB(e){eH.emit(ez.onClickOrTouch,{e:e,target:e.target})}function eF(){["click","touchstart"].forEach(function(e){eb(e,eB)})}// changing isWindowFocused to true on focus event
function eW(){eR({isWindowFocused:!0})}eH.on(ez.bindEvents,function(){//Scrolls to the section when clicking the navigation bullet
...
var eG="fullpage-wrapper",eU="."+eG,eV="fp-responsive",eY="fp-notransition",eX="fp-destroyed",eK="fp-enabled",eQ="fp-viewing",eZ="active",eJ="."+eZ,e0="fp-completely",e1="."+e0,e2="fp-section",e3="."+e2,e4=e3+eJ,e6="fp-auto-height",e9="."+e6,e7="fp-auto-height-responsive",e8="."+e7,e5="fp-nav",te="#"+e5,tt="fp-tooltip",tn="."+tt,ti="fp-slide",tr="."+ti,to=tr+eJ,ts="fp-slides",ta="."+ts,tl="fp-slidesContainer",tc="."+tl,tu="fp-table",td="fp-overflow",tp="."+td,th="fp-is-overflow",tf="fp-slidesNav",tg="."+tf,tm=tg+" a",tv="fp-arrow",ty="fp-controlArrow",tb="."+ty,tw="fp-prev",tS=tb+"."+tw,tx="fp-next",tT=tb+"."+tx,tE={//navigation
...
afterLoad:null,beforeLeave:null,onLeave:null,afterRender:null,afterResize:null,afterReBuild:null,afterSlideLoad:null,onSlideLeave:null,afterResponsive:null,onScrollOverflow:null,lazyLoading:!0,observer:!0,scrollBeyondFullpage:!0},tC=null,tA=!1,tL=F({},tE),t$=null;function t_(){return t$||tE}/*
    * Sets the state for a variable with multiple states (original, and temporal)
    * Some variables such as `autoScrolling` or `recordHistory` might change automatically its state when using `responsive` or `autoScrolling:false`.
    * This function is used to keep track of both states, the original and the temporal one.
    * If type is not 'internal', then we assume the user is globally changing the variable.
    */function tk(e,t,n){t$[e]=t,"internal"!==n&&(tL[e]=t)}/**
    * Setting options from DOM elements if they are not provided.
    */function tO(){//no anchors option? Checking for them in the DOM attributes
if(!t_().anchors.length){var e="[data-anchor]",t=B(t_().sectionSelector.split(",").join(e+",")+e,tC);t.length&&t.length===B(t_().sectionSelector,tC).length&&(tA=!0,t.forEach(function(e){t_().anchors.push(em(e,"data-anchor").toString())}))}//no tooltips option? Checking for them in the DOM attributes
if(!t_().navigationTooltips.length){var n="[data-tooltip]",i=B(t_().sectionSelector.split(",").join(n+",")+n,tC);i.length&&i.forEach(function(e){t_().navigationTooltips.push(em(e,"data-tooltip").toString())})}}var tD=function(e){this.anchor=e.anchor,this.item=e.item,this.index=e.index(),this.isLast=this.index===e.item.parentElement.querySelectorAll(e.selector).length-1,this.isFirst=!this.index,this.isActive=e.isActive},tM=function(e,t){this.parent=this.parent||null,this.selector=t,this.anchor=em(e,"data-anchor")||t_().anchors[Q(e,t_().sectionSelector)],this.item=e,this.isVisible=R(e),this.isActive=W(e,eZ),this.hasScroll=W(e,td)||null!=B(tp,e)[0],this.isSection=t===t_().sectionSelector,this.container=ec(e,tc)||ec(e,eU),this.index=function(){return this.siblings().indexOf(this)}};function tP(e){return e.map(function(e){return e.item})}function tj(e,t){return e.find(function(e){return e.item===t})}tM.prototype.siblings=function(){return this.isSection?this.isVisible?eq.sections:eq.sectionsIncludingHidden:this.parent?this.parent.slides:0},tM.prototype.prev=function(){var e=this.siblings(),t=(this.isSection?e.indexOf(this):this.parent.slides.indexOf(this))-1;return t>=0?e[t]:null},tM.prototype.next=function(){var e=this.siblings(),t=(this.isSection?e.indexOf(this):this.parent.slides.indexOf(this))+1;return t<e.length?e[t]:null},tM.prototype.prevPanel=function(){return this.prev()||(this.parent?this.parent.prev():null)},tM.prototype.nextPanel=function(){return this.next()||(this.parent?this.parent.next():null)},tM.prototype.getSiblings=function(){return this.isSection?eq.sections:eq.panels};var tI=function(e){tD.call(this,e)},tN=function(e){tD.call(this,e)};/**
    * Gets the active slide (or section) for the given section
    */function tH(e){var t=B(to,e);return t.length&&(e=t[0]),e}function tq(e){return e?e.activeSlide?e.activeSlide:e:null}/**
    * Gets the scrolling settings depending on the plugin autoScrolling option
    */function tR(e){var t,n,i=t_();return i.autoScrolling&&!i.scrollBar?(t=-e,n=B(eU)[0]):(t=e,n=window),{options:t,element:n}}/**
    * Scrolls the page / slider the given number of pixels.
    * It will do it one or another way dependiong on the library's config.
    */function tz(e,t){!t_().autoScrolling||t_().scrollBar||e.self!=window&&W(e,ts)?e.self!=window&&W(e,ts)?e.scrollLeft=t:e.scrollTo(0,t):e.style.top=t+"px"}/**
    * Adds transition animations for the given element
    */function tB(e){var t="transform "+t_().scrollingSpeed+"ms "+t_().easingcss3;return ei(e,eY),V(e,{"-webkit-transition":t,transition:t})}/**
    ...
    */function tG(e,t){t?tB(tC):en(tC,eY),clearTimeout(v),V(tC,tW(e)),H.test.translate3d=e,v=setTimeout(function(){ei(tC,eY)},10)}/**
    * Scrolls silently (with no animation) the page to the given Y position.
    */function tU(e){// The first section can have a negative value in iOS 10. Not quite sure why: -0.0142822265625
// that's why we round it to 0.
var t=Math.round(e);if(t_().css3&&t_().autoScrolling&&!t_().scrollBar)tG("translate3d(0px, -"+t+"px, 0px)",!1);else if(t_().autoScrolling&&!t_().scrollBar)V(tC,{top:-t+"px"}),H.test.top=-t+"px";else{var n=tR(t);tz(n.element,n.options)}}/**
    * Defines the scrolling speed
    */function tV(e,t){tk("scrollingSpeed",e,t)}H.setScrollingSpeed=tV;var tY=null,tX=null,tK=null;/**
    * Simulates the animated scrollTop of jQuery. Used when css3:false or scrollBar:true or autoScrolling:false
    * http://stackoverflow.com/a/16136789/1081396
    */function tQ(e,t,n,i){var r,o=e.self!=D&&W(e,ts)?e.scrollLeft:!t_().autoScrolling||t_().scrollBar?eh():e.offsetTop,s=t-o,a=!1,l=eq.activeAnimation;eR({activeAnimation:!0}),y&&window.cancelAnimationFrame(y),y=function(c){r||(r=c);var u=Math.floor(c-r);if(eq.activeAnimation){//in order to stope it from other function whenever we want
var d=t;n&&(d=D.fp_easings[t_().easing](u,o,s,n)),u<=n&&tz(e,d),u<n?window.requestAnimationFrame(y):void 0===i||a||(i(),eR({activeAnimation:!1}),a=!0)}else a||l||(i(),eR({activeAnimation:!1}),a=!0)},window.requestAnimationFrame(y)}/**
    * Makes sure to only create a Panel object if the element exist
    */function tZ(e){return e&&!e.item?new tI(new nI(e)):e?new tI(e):null}function tJ(e){return e?new tN(e):null}/**
    * Dispatch events & callbacks
    */function t0(e,t){var n,i=(n={afterRender:function(){return{section:tZ(eq.activeSection),slide:tJ(eq.activeSection.activeSlide)}},onLeave:function(){return{origin:tZ(t.items.origin),destination:tZ(t.items.destination),direction:t.direction,trigger:eq.scrollTrigger}},afterLoad:function(){return n.onLeave()},afterSlideLoad:function(){return{section:tZ(t.items.section),origin:tZ(t.items.origin),destination:tZ(t.items.destination),direction:t.direction,trigger:eq.scrollTrigger}},onSlideLeave:function(){return n.afterSlideLoad()},beforeLeave:function(){return n.onLeave()},onScrollOverflow:function(){return{section:tZ(eq.activeSection),slide:tJ(eq.activeSection.activeSlide),position:t.position,direction:t.direction}}})[e]();return ex(tC,e,i),!1!==t_()[e].apply(i[Object.keys(i)[0]],ek(i))}/**
...
B("video, audio",t).forEach(function(e){e.hasAttribute("data-keepplaying")||"function"!=typeof e.pause||e.pause()}),B('iframe[src*="youtube.com/embed/"]',t).forEach(function(e){/youtube\.com\/embed\//.test(em(e,"src"))&&!e.hasAttribute("data-keepplaying")&&e.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}',"*")})}/**
    ...
    */function t4(e){t_().lazyLoading&&B("img[data-src], img[data-srcset], source[data-src], source[data-srcset], video[data-src], audio[data-src], iframe[data-src]",tH(e)).forEach(function(e){if(["src","srcset"].forEach(function(t){var n=em(e,"data-"+t);null!=n&&n&&(eM(e,t),e.addEventListener("load",function(){}))}),eT(e,"source")){var t=ec(e,"video, audio");t&&(t.load(),t.onloadeddata=function(){})}})}/**
    * Sets a class for the body of the page depending on the active section / slide
    */function t6(){var e=eq.activeSection.item,t=eq.activeSection.activeSlide,n=String(t9(e));t&&(n=n+"-"+t9(t.item)),n=n.replace("/","-").replace("#","");var i=RegExp("\\b\\s?"+eQ+"-[^\\s]+\\b","g");tY.className=tY.className.replace(i,""),en(tY,eQ+"-"+n)}/**
    * Gets the anchor for the given slide / section. Its index will be used if there's none.
    */function t9(e){if(!e)return null;var t=em(e,"data-anchor"),n=Q(e);return null==t&&(t=n),t}/**
    * Sets the state of the website depending on the active section/slide.
    * It changes the URL hash when needed and updates the body class.
    */function t7(e,t,n){var i="";t_().anchors.length&&!t_().lockAnchors&&(e?(null!=n&&(i=n),null==t&&(t=e),eR({lastScrolledSlide:t}),t8(i+"/"+t)):(null!=e&&eR({lastScrolledSlide:t}),t8(n))),t6()}/**
    * Sets the URL hash.
    */function t8(e){if(t_().recordHistory)location.hash=e;else if(P||I)D.history.replaceState(void 0,void 0,"#"+e);else{var t=D.location.href.split("#")[0];D.location.replace(t+"#"+e)}}/**
    * Gets the name for screen readers for a section/slide navigation bullet.
    */function t5(e,t,n){var i="Section"===t?t_().anchors[e]:em(n,"data-anchor");return encodeURI(t_().navigationTooltips[e]||i||t+" "+(e+1))}function ne(e){e.cancelable&&eg(e),eR({scrollTrigger:"horizontalNav"});/*jshint validthis:true */var t=ec(this,e3),n=B(ta,ec(this,e3))[0],i=tj(eq.sections,t).slides[Q(ec(this,"li"))];eH.emit(ez.landscapeScroll,{slides:n,destination:i.item})}var nt={};/**
    * Allowing or disallowing the mouse/swipe scroll in a given direction. (not for keyboard)
    * @param type m (mouse) or k (keyboard)
    */function nn(e,t,n){//up, down, left, right
"all"!==t?nt[n][t]=e:Object.keys(nt[n]).forEach(function(t){nt[n][t]=e})}function ni(){/*jshint validthis:true */var e=ec(this,e3);/*jshint validthis:true */W(this,tw)?nt.m.left&&(eR({scrollTrigger:"slideArrow"}),eH.emit(ez.moveSlideLeft,{section:e})):nt.m.right&&(eR({scrollTrigger:"slideArrow"}),eH.emit(ez.moveSlideRight,{section:e}))}/**
    * Defines wheter to record the history for each hash change in the URL.
    */function nr(e,t){tk("recordHistory",e,t)}/**
    * Sets the autoScroll option.
    * It changes the scroll bar visibility and the history of the site as a result.
    */function no(e,t){e||tU(0),tk("autoScrolling",e,t);var n=eq.activeSection.item;if(t_().autoScrolling&&!t_().scrollBar)V(tK,{overflow:"hidden",height:"100%"}),ei(tY,"fp-scrollable"),nr(tL.recordHistory,"internal"),V(tC,{"-ms-touch-action":"none","touch-action":"none"}),null!=n&&tU(n.offsetTop);else if(V(tK,{overflow:"visible",height:"initial"}),en(tY,"fp-scrollable"),nr(!!t_().autoScrolling&&tL.recordHistory,"internal"),V(tC,{"-ms-touch-action":"","touch-action":""}),null!=n){var i=tR(n.offsetTop);i.element.scrollTo(0,i.options)}}/**
    * Makes sure lazyload is done for other sections in the viewport that are not the
    * active one. 
    */function ns(){var e=B(e9)[0]||W(tY,eV)&&B(e8)[0];//quitting when it doesn't apply
t_().lazyLoading&&e&&//making sure to lazy load auto-height sections that are in the viewport
B(e3+":not("+eJ+")").forEach(function(e){var t,n,i,r,o;n=(t=e.getBoundingClientRect()).top,i=t.bottom,r=n+2<eq.windowsHeight&&n>0,o=i>2&&i<eq.windowsHeight,(r||o)&&t4(e)})}function na(){/*jshint validthis:true */ex(Y(this),"click")}/**
    * Creates a vertical navigation bar.
    */function nl(){eA(B(te));var e=M.createElement("div");e.setAttribute("id",e5);var t=M.createElement("ul");e.appendChild(t),er(e,tY);var n=B(te)[0];en(n,"fp-"+t_().navigationPosition),t_().showActiveTooltip&&en(n,"fp-show-active");for(var i="",r=0;r<eq.sections.length;r++){var o=eq.sections[r],s="";t_().anchors.length&&(s=o.anchor),i+='<li><a href="#'+encodeURI(s)+'"><span class="fp-sr-only">'+t5(o.index(),"Section")+"</span><span></span></a>";var a=t_().navigationTooltips[o.index()];void 0!==a&&""!==a&&(i+='<div class="'+tt+" fp-"+t_().navigationPosition+'">'+a+"</div>"),i+="</li>"}B("ul",n)[0].innerHTML=i;var l=B("li",B(te)[0])[eq.activeSection.index()];en(B("a",l),eZ)}//Scrolls to the section when clicking the navigation bullet
function nc(e){e.preventDefault&&eg(e),eR({scrollTrigger:"verticalNav"});/*jshint validthis:true */// @ts-ignore
var t=Q(ec(this,te+" li"));eH.emit(ez.scrollPage,{destination:eq.sections[t]})}/**
    * Sets to active the current menu and vertical nav items.
    */function nu(e,t){var n;t_().menu&&t_().menu.length&&B(t_().menu).forEach(function(t){null!=t&&(ei(B(eJ,t),eZ),en(B('[data-menuanchor="'+e+'"]',t),eZ))}),n=B(te)[0],t_().navigation&&null!=n&&"none"!==n.style.display&&(ei(B(eJ,n),eZ),e?en(B('a[href="#'+e+'"]',n),eZ):en(B("a",B("li",n)[t]),eZ))}nt.m={up:!0,down:!0,left:!0,right:!0},nt.k=F({},nt.m),eH.on(ez.onClickOrTouch,function(e){var t=e.target;(eT(t,tb)||ec(t,tb))&&ni.call(t,e)}//Scrolling horizontally when clicking on the slider controls.
),H.setRecordHistory=nr,H.setAutoScrolling=no,H.test.setAutoScrolling=no,new Date().getTime();/**
     * Triggers the callback once per scroll wheel action.
     * Based on scrolling speed delay.
     */var nd=(n=!0,i=new Date().getTime(),r=!D.fullpage_api,function(e,o){var s=new Date().getTime(),a="wheel"===e?t_().scrollingSpeed:100;return n=r||s-i>=a,r=!D.fullpage_api,n&&(t=o(),i=s),void 0===t||t});/**
    * Fires the wheel event once per mouse wheel trigger.
    */function np(e,t){if(eS(t_().beforeLeave))return nd(eq.scrollTrigger,function(){return t0(e,t)})}/**
    * Scrolls the site to the given element and scrolls to the slide if a callback is given.
    */function nh(e,t,n){var i,r,o=e.item;if(null!=o){//there's no element to scroll, leaving the function
var s=(l=o.offsetHeight,u=c=o.offsetTop,d=c>eq.previousDestTop,p=u-G()+l,h=t_().bigSectionsDestination,l>G()?(d||h)&&"bottom"!==h||(u=p):(d||eq.isResizing&&null==X(o))&&(u=p),/*
      Keeping record of the last scrolled position to determine the scrolling direction.
      No conventional methods can be used as the scroll bar might not be present
      AND the section might not be active if it is auto-height and didnt reach the middle
      of the viewport.
      */eR({previousDestTop:u}),u),a={element:o,callback:t,isMovementUp:n,dtop:s,yMovement:tF(eq.activeSection,o),anchorLink:e.anchor,sectionIndex:e.index(),activeSlide:e.activeSlide?e.activeSlide.item:null,leavingSection:eq.activeSection.index()+1,//caching the value of isResizing at the momment the function is called
//because it will be checked later inside a setTimeout and the value might change
localIsResizing:eq.isResizing,items:{origin:eq.activeSection,destination:e},direction:null};if((eq.activeSection.item!=o||eq.isResizing)&&(!t_().scrollBar||eh()!==a.dtop||W(o,e6))){if(null!=a.activeSlide&&(i=em(a.activeSlide,"data-anchor"),r=Q(a.activeSlide,null)),!a.localIsResizing){var l,c,u,d,p,h,f,g,m=a.yMovement;//required for continousVertical
if(void 0!==n&&(m=n?"up":"down"),//for the callback
a.direction=m,eS(t_().beforeLeave)&&!1===np("beforeLeave",a)||eS(t_().onLeave)&&!t0("onLeave",a))return}// If continuousVertical && we need to wrap around
t_().autoScrolling&&t_().continuousVertical&&void 0!==a.isMovementUp&&(!a.isMovementUp&&"up"==a.yMovement||// Intending to scroll down but about to go up or
a.isMovementUp&&"down"==a.yMovement)&&(f=a,eR({isDoingContinousVertical:!0}),g=eq.activeSection.item,f.isMovementUp?// Move all next sections to before the active section
ed(g,e$(g,e3)):eu(g,e_(g,e3).reverse()),// Maintain the displayed position (now that we changed the element order)
tU(eq.activeSection.item.offsetTop),/**
    * Maintains the active slides in the viewport
    * (Because the `scroll` animation might get lost with some actions, such as when using continuousVertical)
    */function(){for(var e=B(to),t=0;t<e.length;t++)n_(e[t],"internal")}(),f.wrapAroundElements=g,f.dtop=f.element.offsetTop,f.yMovement=tF(eq.activeSection,f.element),a=f),a.localIsResizing||t3(eq.activeSection.item),en(o,eZ),ei(ef(o),eZ),nD(),t4(o),//more than once if the page is scrolling
eR({canScroll:H.test.isTesting}),t7(r,i,a.anchorLink),eH.emit(ez.onLeave,a),/**
    * Performs the vertical movement (by CSS3 or by jQuery)
    */function(e){var t=t_().scrollingSpeed<700,n=t?700:t_().scrollingSpeed;if(eR({touchDirection:"none",scrollY:Math.round(e.dtop)}),eH.emit(ez.onPerformMovement),t_().css3&&t_().autoScrolling&&!t_().scrollBar)tG("translate3d(0px, -"+Math.round(e.dtop)+"px, 0px)",!0),t_().scrollingSpeed?(clearTimeout(b),b=setTimeout(function(){nf(e),eR({canScroll:!t||H.test.isTesting})},t_().scrollingSpeed)):nf(e);else{var i=tR(e.dtop);H.test.top=-e.dtop+"px",clearTimeout(b),tQ(i.element,i.options,t_().scrollingSpeed,function(){t_().scrollBar?/* Hack!
            The timeout prevents setting the most dominant section in the viewport as "active" when the user
            scrolled to a smaller section by using the mousewheel (auto scrolling) rather than draging the scroll bar.
             When using scrollBar:true It seems like the scroll events still getting propagated even after the scrolling animation has finished.
            */b=setTimeout(function(){nf(e)},30):(nf(e),eR({canScroll:!t||H.test.isTesting}))})}// enabling canScroll after the minimum transition laps
t&&(clearTimeout(w),w=setTimeout(function(){eR({canScroll:!0})},n))}(a),eR({lastScrolledDestiny:a.anchorLink}),nu(a.anchorLink,a.sectionIndex)}}}/**
    * Actions to do once the section is loaded.
    */function nf(e){eR({isBeyondFullpage:!1}),null!=e.wrapAroundElements&&(e.isMovementUp?ed(B(e3)[0],e.wrapAroundElements):eu(B(e3)[eq.sections.length-1],e.wrapAroundElements),tU(eq.activeSection.item.offsetTop),//@ts-check
/**
    * Maintains the active slides in the viewport
    * (Because the `scroll` animation might get lost with some actions, such as when using continuousVertical)
    */function(){for(var e=B(to),t=0;t<e.length;t++)n_(e[t],"internal")}(),eR({isDoingContinousVertical:!1})),eS(t_().afterLoad)&&!e.localIsResizing&&t0("afterLoad",e),nD(),e.localIsResizing||t1(e.element),en(e.element,e0),ei(ef(e.element),e0),ns(),eR({canScroll:!0}),eH.emit(ez.afterSectionLoads,e),eS(e.callback)&&e.callback()}/**
    * Sets fitToSection
    */function ng(e,t){tk("fitToSection",e,t)}/**
    * Fits the site to the nearest active section
    */function nm(){//checking fitToSection again in case it was set to false before the timeout delay
eq.canScroll&&(//allows to scroll to an active section and
//if the section is already active, we prevent firing callbacks
eR({isResizing:!0}),nh(eq.activeSection),eR({isResizing:!1}))}/**
    * Checks if the site needs to get responsive and disables autoScrolling if so.
    * A class `fp-responsive` is added to the plugin's container in case the user wants to use it for his own responsive CSS.
    */function nv(){var e=t_().responsive||t_().responsiveWidth,t=t_().responsiveHeight,n=e&&D.innerWidth<e,i=t&&D.innerHeight<t;//backwards compatiblity
e&&t?ny(n||i):e?ny(n):t&&ny(i)}/**
    * Turns fullPage.js to normal scrolling mode when the viewport `width` or `height`
    * are smaller than the set limit values.
    */function ny(e){var t=W(tY,eV);e?!t&&(no(!1,"internal"),ng(!1,"internal"),J(B(te)),en(tY,eV),eS(t_().afterResponsive))&&t_().afterResponsive.call(tC,e):t&&(no(tL.autoScrolling,"internal"),ng(tL.autoScrolling,"internal"),ee(B(te)),ei(tY,eV),eS(t_().afterResponsive))&&t_().afterResponsive.call(tC,e)}function nb(e){t_().verticalCentered&&(!t_().scrollOverflow&&nE.shouldBeScrollable(e.item)||nE.isScrollable(e)||W(e.item,tu)||en(e.item,tu))}H.moveTo=moveTo,H.getScrollY=function(){return eq.scrollY},eH.on(ez.onDestroy,function(){clearTimeout(b),clearTimeout(w)}),H.setFitToSection=ng,H.fitToSection=nm,H.setResponsive=ny;var nw=null;/**
    * Styling vertical sections
    */function nS(e){var t=e.item,n=e.allSlidesItems.length,i=e.index();!eq.activeSection&&e.isVisible&&(en(t,eZ),nD(),nw=eq.activeSection.item),t_().paddingTop&&V(t,{"padding-top":t_().paddingTop}),t_().paddingBottom&&V(t,{"padding-bottom":t_().paddingBottom}),void 0!==t_().sectionsColor[i]&&V(t,{"background-color":t_().sectionsColor[i]}),void 0!==t_().anchors[i]&&t.setAttribute("data-anchor",e.anchor),n||nb(e)}function nx(){t_().scrollOverflow&&!t_().scrollBar&&(nE.makeScrollable(),nE.focusScrollable())}function nT(){eH.removeListener(ez.onAfterRenderNoAnchor,nx),eb("keyup",nE.keyUpHandler)}H.getActiveSection=/**
    * Gets the active section.
    */function(){return eq.activeSection},eH.on(ez.bindEvents,function(){// We can't focus scrollOverflow before scrolling
// to the anchor (if we need to)
eH.on(ez.onAfterRenderNoAnchor,nx),eH.on(ez.onLeave,nE.onLeave),eH.on(ez.onSlideLeave,nE.onLeave),eH.on(ez.afterSlideLoads,nE.afterLoad),eH.on(ez.afterSectionLoads,nE.afterLoad),eH.on(ez.onDestroy,nT),ev("keyup",nE.keyUpHandler)});var nE={focusedElem:null,shouldFocusScrollable:!0,isInnerScrollAllowed:!0,timeBeforeReachingLimit:null,timeLastScroll:null,preventScrollWithMouseWheel:function(e){if(!eq.canScroll)return eg(e),!1},preventScrollWithKeyboard:function(e){if(!ej()&&t_().keyboardScrolling&&[38,33,32,40,34,36,35].indexOf(e.keyCode)>-1&&!nE.isInnerScrollAllowed)return eg(e),!1},keyUpHandler:function(){nE.shouldFocusScrollable=eq.canScroll},// Leaving sections or slides
onLeave:function(){clearTimeout(S),nE.isInnerScrollAllowed=!1},// Loading sections or slides
afterLoad:function(){nE.isInnerScrollAllowed=!1,clearTimeout(S),S=setTimeout(function(){nE.shouldFocusScrollable=eq.canScroll},200)},// Unfocusing the scrollable element from the orgin section/slide
unfocusScrollable:function(){M.activeElement===this.focusedElem&&(// @ts-ignore
this.focusedElem.blur(),nE.isInnerScrollAllowed=!1)},focusScrollable:function(){if(t_().scrollOverflow&&nE.shouldFocusScrollable){nE.unfocusScrollable();var e=nE.getScrollableItem(eq.activeSection.item);// On desktop we focus the scrollable to be able to use the mouse wheel
!e||P||I||(this.focusedElem=e,// to avoid issue #4484 & #4493 on Safari
requestAnimationFrame(function(){e.focus(),nE.isInnerScrollAllowed=!0})),nE.shouldFocusScrollable=!1}},makeScrollable:function(){t_().scrollOverflowMacStyle&&!j&&en(tY,"fp-scroll-mac"),eq.panels.forEach(function(e){if((!e.slides||!e.slides.length)&&!(W(e.item,e7)&&W(tY,eV))){var t=tH(e.item),n=nE.shouldBeScrollable(e.item),i=e.isSection?e:e.parent;if(N){var r=n?"addClass":"removeClass";eI[r](i.item,th),eI[r](e.item,th)}else en(i.item,th),en(e.item,th);e.hasScroll||(nE.createWrapper(t),nE.bindEvents(t)),// this is executed on page load (after images load)
e.hasScroll=!0}})},bindEvents:function(e){nE.getScrollableItem(e).addEventListener("scroll",nE.onPanelScroll),e.addEventListener("wheel",nE.preventScrollWithMouseWheel,{passive:!1}),e.addEventListener("keydown",nE.preventScrollWithKeyboard,{passive:!1})},createWrapper:function(e){var t=document.createElement("div");t.className=td,ea(e,t),t.setAttribute("tabindex","-1")},destroyWrapper:function(e){var t=B(tp,e)[0];t&&(el(t),e.removeAttribute("tabindex"))},getScrollableItem:function(e){var t=tH(e);return B(tp,t)[0]||t},hasScroll:function(e){return W(e,td)||null!=B(tp,e)[0]},isScrollable:function(e){return e.isSection&&e.activeSlide?e.activeSlide.hasScroll:e.hasScroll},shouldBeScrollable:function(e){return nE.getScrollableItem(e).scrollHeight>D.innerHeight},isScrolled:function(e,t){if(!eq.canScroll)return!1;// we won't allow scrolloverflow on scrollBar:true
if(t_().scrollBar)return!0;var n=nE.getScrollableItem(t);if(!t_().scrollOverflow||!W(n,td)||// Checking the section first 
// In case they apply to both section + slide #4505
W(t,"fp-noscroll")||// Checking the slide (in case it has)
W(tH(t),"fp-noscroll"))return!0;var i=n.scrollTop,r="down"===e&&n.scrollHeight<=Math.ceil(n.offsetHeight+i)+(N?1:0),o="up"===e&&i<=0||r;return o||(this.timeBeforeReachingLimit=new Date().getTime()),o},shouldMovePage:function(){this.timeLastScroll=new Date().getTime();var e=this.timeLastScroll-nE.timeBeforeReachingLimit,t=(P||I)&&eq.isGrabbing,n=eq.isUsingWheel&&e>600;return t&&e>400||n},onPanelScroll:(o=0,function(e){var t=e.target.scrollTop,n="none"!==eq.touchDirection?eq.touchDirection:o<t?"down":"up";o=t,eS(t_().onScrollOverflow)&&t0("onScrollOverflow",{position:t,direction:n}),W(e.target,td)&&eq.canScroll&&nE.isScrolled(n,e.target)&&nE.shouldMovePage()&&nE.shouldBeScrollable(eq.activeSection.item)&&eH.emit(ez.onScrollOverflowScrolled,{direction:n})})};function nC(){clearTimeout(x),eR({slideMoving:!1})}/**
    * Scrolls horizontal sliders.
    */function nA(e,t,n){var i,r,o=ec(e,e3),s=eq.sections.filter(function(e){return e.item==o})[0],a=s.slides.filter(function(e){return e.item==t})[0],l={slides:e,destiny:t,direction:n,destinyPos:{left:t.offsetLeft},slideIndex:a.index(),section:o,sectionIndex:s.index(),anchorLink:s.anchor,slidesNav:B(tg,o)[0],slideAnchor:a.anchor,prevSlide:s.activeSlide.item,prevSlideIndex:s.activeSlide.index(),items:{section:s,origin:s.activeSlide,destination:a},//caching the value of isResizing at the momment the function is called
//because it will be checked later inside a setTimeout and the value might change
localIsResizing:eq.isResizing};if(l.xMovement=(i=l.prevSlideIndex)==(r=l.slideIndex)?"none":i>r?"left":"right",l.direction=l.direction?l.direction:l.xMovement,l.localIsResizing||eR({canScroll:!1}),t_().onSlideLeave&&!l.localIsResizing&&"none"!==l.xMovement&&eS(t_().onSlideLeave)&&!1===t0("onSlideLeave",l)){eR({slideMoving:!1});return}en(t,eZ),ei(ef(t),eZ),nD(),l.localIsResizing||(t3(l.prevSlide),t4(t)),!t_().loopHorizontal&&t_().controlArrows&&(//hidding it for the fist slide, showing for the rest
eE(B(tS,l.section),0!==l.slideIndex),eE(B(tT,l.section),null!=X(l.destiny))),s.isActive&&!l.localIsResizing&&t7(l.slideIndex,l.slideAnchor,l.anchorLink),eH.emit(ez.onSlideLeave,l),/**
    * Performs the horizontal movement. (CSS3 or jQuery)
    *
    * @param fireCallback {Boolean} - determines whether or not to fire the callback
    */function(e,t,n){var i,r,o=t.destinyPos;if(i=t.slidesNav,r=t.slideIndex,t_().slidesNavigation&&null!=i&&(ei(B(eJ,i),eZ),en(B("a",B("li",i)[r]),eZ)),eR({scrollX:Math.round(o.left)}),t_().css3){var s="translate3d(-"+Math.round(o.left)+"px, 0px, 0px)";H.test.translate3dH[t.sectionIndex]=s,V(tB(B(tc,e)),tW(s)),clearTimeout(x),x=setTimeout(function(){n&&n$(t)},t_().scrollingSpeed)}else H.test.left[t.sectionIndex]=Math.round(o.left),tQ(e,Math.round(o.left),t_().scrollingSpeed,function(){n&&n$(t)})}(e,l,!0)}function nL(){clearTimeout(x)}function n$(e){e.localIsResizing||(eS(t_().afterSlideLoad)&&t0("afterSlideLoad",e),//needs to be inside the condition to prevent problems with continuousVertical and scrollHorizontally
//and to prevent double scroll right after a windows resize
eR({canScroll:!0}),t1(e.destiny),eH.emit(ez.afterSlideLoads,e)),eR({slideMoving:!1})}/**
    * Slides silently (with no animation) the active slider to the given slide.
    * @param noCallback {bool} true or defined -> no callbacks
    */function n_(e,t){tV(0,"internal"),void 0!==t&&eR({isResizing:!0}),nA(ec(e,ta),e),void 0!==t&&eR({isResizing:!1}),tV(tL.scrollingSpeed,"internal")}H.landscapeScroll=nA,eH.on(ez.bindEvents,function(){eH.on(ez.onPerformMovement,nC)});var nk=null,nO=null;/** 
     * Updates the state of the app.
     */function nD(){eq.activeSection=null,eq.sections.map(function(e){var t=W(e.item,eZ);e.isActive=t,e.hasScroll=nE.hasScroll(e.item),t&&(eq.activeSection=e),e.slides.length&&(e.activeSlide=null,e.slides.map(function(t){var n=W(t.item,eZ);t.hasScroll=nE.hasScroll(e.item),t.isActive=n,n&&(e.activeSlide=t)}))}),/**
     * When changes in the DOM take place there's a change 
     * the active section is now hidden or removed. 
     * fullPage.js will scroll to the closest section nearby.
     */function(){var e=eq.activeSection,t=!!eq.activeSection&&eq.activeSection.slides.length,n=eq.activeSection?eq.activeSection.activeSlide:null;if(!e&&eq.sections.length&&!eq.isBeyondFullpage&&nk){var i=nj(nk,eq.sections);i&&(eq.activeSection=i,eq.activeSection.isActive=!0,en(eq.activeSection.item,eZ)),eq.activeSection&&tU(eq.activeSection.item.offsetTop)}if(t&&!n&&nO){var r=nj(nO,eq.activeSection.slides);r&&(eq.activeSection.activeSlide=r,eq.activeSection.activeSlide.isActive=!0,en(eq.activeSection.activeSlide.item,eZ)),eq.activeSection.activeSlide&&n_(eq.activeSection.activeSlide.item,"internal")}}()}function nM(){var e=B(t_().sectionSelector,tC),t=z(e),n=Array.from(e).map(function(e){return new nI(e)}),i=n.filter(function(e){return e.isVisible}),r=i.reduce(function(e,t){return e.concat(t.slides)},[]);nk=nP(eq.activeSection),nO=nP(eq.activeSection?eq.activeSection.activeSlide:null),eq.numSections=t.length,eq.numSlides=i.reduce(function(e,t){return e+t.slides.length},0),eq.sections=i,eq.sectionsIncludingHidden=n,eq.slides=r,eq.panels=eq.sections.concat(eq.slides)}function nP(e){if(!e)return null;var t=e?e.item:null,n=e.isSection?eq.sectionsIncludingHidden:eq.activeSection.slidesIncludingHidden;if(t){var i=tj(n,t);return i?i.index():null}return null}function nj(e,t){var n,i=e-1,r=e;do{if(n=t[i]||t[r])break;i-=1,r+=1}while(i>=0||r<t.length)return n}/**
    * Section object
    */var nI=function(e){var t=this;[].push.call(arguments,t_().sectionSelector),tM.apply(this,arguments),this.allSlidesItems=B(t_().slideSelector,e),this.slidesIncludingHidden=Array.from(this.allSlidesItems).map(function(e){return new nN(e,t)}),this.slides=this.slidesIncludingHidden.filter(function(e){return e.isVisible}),this.activeSlide=this.slides.length?this.slides.filter(function(e){return e.isActive})[0]||this.slides[0]:null};nI.prototype=tM.prototype,nI.prototype.constructor=nI;/**
    * Slide object
    */var nN=function(e,t){this.parent=t,tM.call(this,e,t_().slideSelector)};/**
    * Adds internal classes to be able to provide customizable selectors
    * keeping the link with the style sheet.
    */function nH(){en(B(t_().sectionSelector,tC),e2),en(B(t_().slideSelector,tC),ti)}/**
    * Styles the horizontal slides for a section.
    */function nq(e){var t,n,i=e.slides.length,r=e.allSlidesItems,o=e.slides,s=100/i;if(!B(ta,e.item)[0]){var a=M.createElement("div");a.className=ts,es(r,a);var l=M.createElement("div");l.className=tl,es(r,l)}V(B(tc,e.item),{width:100*i+"%"}),i>1&&(t_().controlArrows&&(t=e.item,n=[eC(t_().controlArrowsHTML[0]),eC(t_().controlArrowsHTML[1])],eu(B(ta,t)[0],n),en(n,ty),en(n[0],tw),en(n[1],tx),"#fff"!==t_().controlArrowColor&&(V(B(tT,t),{"border-color":"transparent transparent transparent "+t_().controlArrowColor}),V(B(tS,t),{"border-color":"transparent "+t_().controlArrowColor+" transparent transparent"})),t_().loopHorizontal||J(B(tS,t))),t_().slidesNavigation&&/**
    * Creates a landscape navigation bar with dots for horizontal sliders.
    */function(e){var t=e.item,n=e.slides.length;er(eC('<div class="'+tf+'"><ul></ul></div>'),t);var i=B(tg,t)[0];//top or bottom
en(i,"fp-"+t_().slidesNavPosition);for(var r=0;r<n;r++){var o=B(tr,t)[r];er(eC('<li><a href="#"><span class="fp-sr-only">'+t5(r,"Slide",o)+"</span><span></span></a></li>"),B("ul",i)[0])}//centering it
V(i,{"margin-left":"-"+i.innerWidth/2+"px"});var s=e.activeSlide?e.activeSlide.index():0;en(B("a",B("li",i)[s]),eZ)}(e)),o.forEach(function(e){V(e.item,{width:s+"%"}),t_().verticalCentered&&nb(e)});var c=e.activeSlide||null;//if the slide won't be an starting point, the default will be the first one
null!=c&&eq.activeSection&&(0!==eq.activeSection.index()||0===eq.activeSection.index()&&0!==c.index())?n_(c.item,"internal"):en(r[0],eZ)}nN.prototype=tM.prototype,nN.prototype.constructor=nI;var nR={attributes:!1,subtree:!0,childList:!0,characterData:!0};function nz(){return z(B(t_().slideSelector,tC)).length!==eq.numSlides}/**
     * Listen to changes on sections and fires reBuild
     * when those changes affect the section height.
     */function nB(e){var t=nz();(nz()||z(B(t_().sectionSelector,tC)).length!==eq.numSections)&&!eq.isDoingContinousVertical&&(t_().observer&&T&&// we modidy the DOM again
T.disconnect(),nM(),nD(),t_().anchors=[],eA(B(te)),nH(),tO(),t_().navigation&&nl(),t&&(eA(B(tg)),eA(B(tb))),eq.sections.forEach(function(e){e.slides.length?t&&nq(e):nS(e)})),t_().observer&&T&&B(eU)[0]&&T.observe(B(eU)[0],nR)}eH.on(ez.bindEvents,function(){var e,t;t_().observer&&"MutationObserver"in window&&B(eU)[0]&&(e=B(eU)[0],(t=new MutationObserver(nB)).observe(e,nR),T=t),eH.on(ez.contentChanged,nB)}),H.render=nB;var nF=function(){//cheks for passive event support
var e=!1;try{var t=Object.defineProperty({},"passive",{get:function(){e=!0}});ey("testPassive",null,t),ew("testPassive",null,t)}catch(e){}return function(){return e}}();function nW(){return!!nF()&&{passive:!1}}var nG=(l=new Date().getTime(),c=[],{registerEvent:function(e){var t=(e=e||D.event).wheelDelta||-e.deltaY||-e.detail,n=void 0!==e.wheelDeltaX||void 0!==e.deltaX;s=Math.abs(e.wheelDeltaX)<Math.abs(e.wheelDelta)||Math.abs(e.deltaX)<Math.abs(e.deltaY)||!n;var i=new Date().getTime();a=0>Math.max(-1,Math.min(1,t))?"down":"up",c.length>149&&c.shift(),//keeping record of the previous scrollings
c.push(Math.abs(t));var r=i-l;l=i,r>200&&(c=[])},isAccelerating:function(){var e=eD(c,10),t=eD(c,70);return!!c.length&&e>=t&&s},getDirection:function(){return a}});function nU(){var e=t_().css3?eh()+G():eO(eq.sections).item.offsetTop+eO(eq.sections).item.offsetHeight,t=tR(e);H.test.top=-e+"px",eR({canScroll:!1}),tQ(t.element,t.options,t_().scrollingSpeed,function(){setTimeout(function(){eR({isBeyondFullpage:!0}),eR({canScroll:!0})},30)})}function nV(){tC.getBoundingClientRect().bottom>=0&&nY()}function nY(){var e=tR(eO(eq.sections).item.offsetTop);eR({canScroll:!1}),tQ(e.element,e.options,t_().scrollingSpeed,function(){eR({canScroll:!0}),eR({isBeyondFullpage:!1}),eR({isAboutToScrollToFullPage:!1})})}var nX=(u=!1,d={},p={},function(e,t,n){switch(e){case"set":d[t]=new Date().getTime(),p[t]=n;break;case"isNewKeyframe":u=new Date().getTime()-d[t]>p[t]}return u});/**
    * Moves the page down one section.
    */function nK(){var e=eq.activeSection.next();//looping to the top if there's no more sections below
!e&&(t_().loopBottom||t_().continuousVertical)&&(e=eq.sections[0]),null!=e?nh(e,null,!1):tC.scrollHeight<tY.scrollHeight&&t_().scrollBar&&t_().scrollBeyondFullpage&&eH.emit(ez.scrollBeyondFullpage)}/**
    * Moves the page up one section.
    */function nQ(){var e=eq.activeSection.prev();//looping to the bottom if there's no more sections above
!e&&(t_().loopTop||t_().continuousVertical)&&(e=eO(eq.sections)),null!=e&&nh(e,null,!0)}H.moveSectionDown=nK,H.moveSectionUp=nQ;var nZ=0;/**
    * Detecting the direction of the mouse movement.
    * Used only for the middle button of the mouse.
    */function nJ(e){t_().autoScrolling&&(eq.canScroll&&(e.pageY<nZ&&nt.m.up?nQ():e.pageY>nZ&&nt.m.down&&nK()),nZ=e.pageY)}/**
    * Determines the way of scrolling up or down:
    * by 'automatically' scrolling a section or by using the default and normal scrolling.
    */function n0(e){if(nt.m[e]){var t="down"===e?nK:nQ;t_().scrollOverflow&&nE.isScrollable(eq.activeSection)?nE.isScrolled(e,eq.activeSection.item)&&nE.shouldMovePage()&&t():t()}}var n1=0,n2=0,n3=0,n4=0,n6=(D.PointerEvent&&(e={down:"pointerdown",move:"pointermove"}),e),n9={touchmove:"ontouchmove"in window?"touchmove":n6?n6.move:null,touchstart:"ontouchstart"in window?"touchstart":n6?n6.down:null};/* Detecting touch events

    * As we are changing the top property of the page on scrolling, we can not use the traditional way to detect it.
    * This way, the touchstart and the touch moves shows an small difference between them which is the
    * used one to determine the direction.
    */function n7(e){var t=ec(e.target,e3)||eq.activeSection.item,n=nE.isScrollable(eq.activeSection);if(n8(e)){eR({isGrabbing:!0,isUsingWheel:!1}),t_().autoScrolling&&(n&&!eq.canScroll||t_().scrollBar)&&eg(e);var i=it(e);n3=i.y,n4=i.x;var r=Math.abs(n1-n3)>D.innerHeight/100*t_().touchSensitivity,o=Math.abs(n2-n4)>U()/100*t_().touchSensitivity,s=B(ta,t).length&&Math.abs(n2-n4)>Math.abs(n1-n3),a=n2>n4?"right":"left",l=n1>n3?"down":"up";eR({touchDirection:s?a:l}),s?!eq.slideMoving&&o&&(n2>n4?nt.m.right&&eH.emit(ez.moveSlideRight,{section:t}):nt.m.left&&eH.emit(ez.moveSlideLeft,{section:t})):t_().autoScrolling&&eq.canScroll&&r&&n0(l)}}/**
    * As IE >= 10 fires both touch and mouse events when using a mouse in a touchscreen
    * this way we make sure that is really a touch event what IE is detecting.
    */function n8(e){//if is not IE   ||  IE is detecting `touch` or `pen`
return void 0===e.pointerType||"mouse"!=e.pointerType}/**
    * Handler for the touch start event.
    */function n5(e){if(t_().fitToSection&&eR({activeAnimation:!1}),n8(e)){var t=it(e);n1=t.y,n2=t.x}ey("touchend",ie)}/**
    * Handler for the touch end event.
    */function ie(){ew("touchend",ie),eR({isGrabbing:!1})}/**
    * Gets the pageX and pageY properties depending on the browser.
    * https://github.com/alvarotrigo/fullPage.js/issues/194#issuecomment-34069854
    */function it(e){var t={};return t.y=void 0!==e.pageY&&(e.pageY||e.pageX)?e.pageY:e.touches[0].pageY,t.x=void 0!==e.pageX&&(e.pageY||e.pageX)?e.pageX:e.touches[0].pageX,I&&n8(e)&&t_().scrollBar&&void 0!==e.touches&&(t.y=e.touches[0].pageY,t.x=e.touches[0].pageX),t}/*
    * Preventing bouncing in iOS #2285
    */function ii(e){t_().autoScrolling&&n8(e)&&nt.m.up&&!eq.canScroll&&eg(e)}/**
    * Slides a slider to the given direction.
    * Optional `section` param.
    */function ir(e,t){var n=null==t?eq.activeSection.item:t,i=tj(eq.sections,n),r=B(ta,n)[0];if(null!=r&&!eq.slideMoving&&!(i.slides.length<2)){var o=i.activeSlide,s="left"===e?o.prev():o.next();if(!s){//respect loopHorizontal setting
if(!t_().loopHorizontal)return;s="left"===e?eO(i.slides):i.slides[0]}eR({slideMoving:!H.test.isTesting}),nA(r,s.item,e)}}/**
    ...
    */function ia(e){var t=eq.sections.filter(function(t){return t.anchor===e})[0];return t||(t=eq.sections[void 0!==e?e-1:0]),t}/**
...
n.anchor&&n.anchor===eq.lastScrolledDestiny||W(n.item,eZ)?il(o):nh(n,function(){il(o)})}}/**
...
function ip(e){clearTimeout(C);var t=e.keyCode,n=[37,39].indexOf(t)>-1,i=t_().autoScrolling||t_().fitToSection||n;9===t?/**
    * Makes sure the tab key will only focus elements within the current section/slide
    * preventing this way from breaking the page.
    * Based on "Modals and keyboard traps"
    * from https://developers.google.com/web/fundamentals/accessibility/focus/using-tabindex
    */function(e){var t,n,i,r,o,s=e.shiftKey,a=M.activeElement,l=ib(tH(eq.activeSection.item));function c(e){return eg(e),l[0]?l[0].focus():null}// deactivating tab while scrolling #4550
if(!eq.canScroll){eg(e);return}//outside any section or slide? Let's not hijack the tab!
...
var u=a==l[0],d=a==l[l.length-1],p=s&&u;if(p||!s&&d){eg(e);var h=/**
     ...
     *
     */function(e){var t,n=e?"prevPanel":"nextPanel",i=[],r=tq((eq.activeSection&&eq.activeSection.activeSlide?eq.activeSection.activeSlide:eq.activeSection)[n]());do(i=ib(r.item)).length&&(t={panel:r,itemToFocus:i[e?i.length-1:0]}),r=tq(r[n]());while(r&&0===i.length)return t}(p),f=h?h.panel:null;if(f){var g=f.isSection?f:f.parent;eH.emit(ez.onScrollPageAndSlide,{sectionAnchor:g.index()+1,slideAnchor:f.isSection?0:f.index()}),A=h.itemToFocus,eg(e)}}}}(e):!ej()&&t_().keyboardScrolling&&i&&(E=e.ctrlKey,C=setTimeout(function(){/**
    * Keydown event
    */(function(e){var t=e.shiftKey,n=M.activeElement,i=eT(n,"video")||eT(n,"audio"),r={up:nE.isScrolled("up",eq.activeSection.item),down:nE.isScrolled("down",eq.activeSection.item)},o=[37,39].indexOf(e.keyCode)>-1;if(!([40,38,32,33,34].indexOf(e.keyCode)>-1)||eq.isBeyondFullpage||ec(e.target,tp)||e.preventDefault(),eq.canScroll||o)switch(eR({scrollTrigger:"keydown"}),e.keyCode){//up
case 38:case 33:nt.k.up&&r.up?eq.isBeyondFullpage?eH.emit(ez.onKeyDown,{e:e}):nQ():nE.focusScrollable();break;//down
case 32://spacebar
if(t&&nt.k.up&&!i&&r.up){nQ();break}/* falls through */case 40:case 34:if(nt.k.down&&r.down){if(eq.isBeyondFullpage)return;// space bar?
32===e.keyCode&&i||nK()}else nE.focusScrollable();break;//Home
case 36:nt.k.up&&iu(1);break;//End
case 35:nt.k.down&&iu(eq.sections.length);break;//left
case 37:nt.k.left&&io();break;//right
case 39:nt.k.right&&is();break;default:return}}//to prevent scrolling while zooming
)(e)},0))}function ih(e){eq.isWindowFocused&&(E=e.ctrlKey)}//when opening a new tab (ctrl + t), `control` won't be pressed when coming back.
function ig(){eR({isWindowFocused:!1}),E=!1}function im(e){iy()}function iv(e){(!ec(A,tr)||ec(A,to))&&iy()}function iy(){A&&(A.focus(),A=null)}/**
...
ey("blur",ig),ev("keydown",ip),ev("keyup",ih),eH.on(ez.onDestroy,id),eH.on(ez.afterSlideLoads,im),eH.on(ez.afterSectionLoads,iv)});var iw=new Date().getTime(),iS=[];/**
    ...
    */function ix(e){var t,n,i,r;e?(n="",D.addEventListener?t="addEventListener":(t="attachEvent",n="on"),i="onwheel"in M.createElement("div")?"wheel":void 0!==M.onmousewheel?"mousewheel":"DOMMouseScroll",r=nW(),"DOMMouseScroll"==i?M[t](n+"MozMousePixelScroll",iT,r):M[t](n+i,iT,r),tC.addEventListener("mousedown",iE),tC.addEventListener("mouseup",iC)):(M.addEventListener?(eb("mousewheel",iT,!1),eb("wheel",iT,!1),eb("MozMousePixelScroll",iT,!1)):M.detachEvent("onmousewheel",iT),tC.removeEventListener("mousedown",iE),tC.removeEventListener("mouseup",iC))}/**
     * Detecting mousewheel scrolling
     *
     * http://blogs.sitepointstatic.com/examples/tech/mouse-wheel/index.html
     * http://www.sitepoint.com/html5-javascript-mouse-wheel/
     */function iT(e){var t=new Date().getTime(),n=W(B(e1)[0],"fp-normal-scroll"),i=function(e,t){new Date().getTime();var n,i=eq.isBeyondFullpage&&e.getBoundingClientRect().bottom>=0&&"up"===nG.getDirection(),r=eq.isAboutToScrollToFullPage;if(r)return eg(t),!1;if(eq.isBeyondFullpage){if(i){if(!r&&(!nX("isNewKeyframe","beyondFullpage")||!nG.isAccelerating()))return(n=tR(eO(eq.sections).item.offsetTop+eO(eq.sections).item.offsetHeight)).element.scrollTo(0,n.options),eR({isAboutToScrollToFullPage:!1}),eg(t),!1;if(nG.isAccelerating())return i=!1,eR({isAboutToScrollToFullPage:!0}),eR({scrollTrigger:"wheel"}),nY(),eg(t),!1}else nX("set","beyondFullpage",1e3);if(!r&&!i)return!0}}(tC,e);//is scroll allowed?
if(eq.isUsingWheel||eR({isGrabbing:!1,isUsingWheel:!0,touchDirection:"none"}),!nt.m.down&&!nt.m.up)return eg(e),!1;if(i)return!0;//autoscrolling and not zooming?
if(!1===i)return eg(e),!1;if(t_().autoScrolling&&!E&&!n){var r=// cross-browser wheel delta
(e=e||D.event).wheelDelta||-e.deltaY||-e.detail,o=Math.max(-1,Math.min(1,r)),s=void 0!==e.wheelDeltaX||void 0!==e.deltaX,a=Math.abs(e.wheelDeltaX)<Math.abs(e.wheelDelta)||Math.abs(e.deltaX)<Math.abs(e.deltaY)||!s;iS.length>149&&iS.shift(),//keeping record of the previous scrollings
iS.push(Math.abs(r)),t_().scrollBar&&eg(e);//time difference between the last scroll and the current one
var l=t-iw;return iw=t,l>200&&(iS=[]),eR({wheelDirection:o<0?"down":o>0?"up":"none"}),eq.canScroll&&eD(iS,10)>=eD(iS,70)&&a&&(eR({scrollTrigger:"wheel"}),o<0?n0("down"):n0("up")),!1}t_().fitToSection&&eR({activeAnimation:!1})}//binding the mousemove when the mouse's middle button is released
...
2==e.which&&tC.removeEventListener("mousemove",nJ)}/**
    ...
    */function(){if(n9.touchmove&&(P||I)){t_().autoScrolling&&(tY.removeEventListener(n9.touchmove,ii,{passive:!1}),tY.addEventListener(n9.touchmove,ii,{passive:!1}));var e=t_().touchWrapper;e.removeEventListener(n9.touchstart,n5),e.removeEventListener(n9.touchmove,n7,{passive:!1}),e.addEventListener(n9.touchstart,n5),e.addEventListener(n9.touchmove,n7,{passive:!1})}}()):(ix(!1),/**
    * Removes the auto scrolling for touch devices.
    */function(){if(n9.touchmove&&(P||I)){t_().autoScrolling&&(tY.removeEventListener(n9.touchmove,n7,{passive:!1}),tY.removeEventListener(n9.touchmove,ii,{passive:!1}));var e=t_().touchWrapper;e.removeEventListener(n9.touchstart,n5),e.removeEventListener(n9.touchmove,n7,{passive:!1})}}())}H.setMouseWheelScrolling=ix;var iL=!0;function i$(){["mouseenter","touchstart","mouseleave","touchend"].forEach(function(e){eb(e,ik,!0);//true is required!
})}function i_(e,t){//a way to pass arguments to the onMouseEnterOrLeave function
document["fp_"+e]=t,ev(e,ik,!0)}function ik(e){var t=e.type,n=!1,i="mouseleave"===t?e.toElement||e.relatedTarget:e.target;if(i==document||!i){iA(!0);return}"touchend"===t&&(iL=!1,setTimeout(function(){iL=!0},800)),("mouseenter"!==t||iL)&&(t_().normalScrollElements.split(",").forEach(function(e){if(!n){var t=eT(i,e),r=ec(i,e);//leaving a child inside the normalScoll element is not leaving the normalScroll #3661
(t||r)&&(H.shared.isNormalScrollElement||iA(!1),H.shared.isNormalScrollElement=!0,n=!0)}}),!n&&H.shared.isNormalScrollElement&&(iA(!0),H.shared.isNormalScrollElement=!1))}/**
    ...
    * Anchors or index positions can be used as params.
    */function iO(e,t){tV(0,"internal"),iu(e,t),tV(tL.scrollingSpeed,"internal")}eH.on(ez.bindEvents,function(){t_().normalScrollElements&&(["mouseenter","touchstart"].forEach(function(e){i_(e,!1)}),["mouseleave","touchend"].forEach(function(e){i_(e,!0)})),eH.on(ez.onDestroy,i$)}),H.silentMoveTo=iO;var iD=G(),iM=U(),iP=!1;function ij(){clearTimeout(L),clearTimeout(_),ew("resize",iI)}/*
    * Resize event handler.
    */function iI(){iP||(!t_().autoScrolling||t_().scrollBar)&&t_().fitToSection||iH(G()),function(){if(P)// (some apps or browsers, like Chrome/Firefox will delay a bit to scroll 
// to the focused input
for(var e=0;e<4;e++)_=setTimeout(function(){window.requestAnimationFrame(function(){// on Android devices the browser scrolls to the focused element
// messing up the whole page structure. So we need to update the
// translate3d value when the keyboard shows/hides
t_().autoScrolling&&!t_().scrollBar&&(eR({isResizing:!0}),iO(eq.activeSection.index()+1),eR({isResizing:!1}))})},200*e)}(),iP=!0,//http://stackoverflow.com/questions/4298612/jquery-how-to-call-resize-event-only-once-its-finished-resizing    
...
/**
    ...
    */(function(){if(eR({isResizing:!0}),iH(""),t_().autoScrolling||eq.isBeyondFullpage||/**
     * Defining the value in px of a VH unit. (Used for autoScrolling: false)
     * To fix the height issue on mobile devices when using VH units.
     * https://css-tricks.com/the-trick-to-viewport-units-on-mobile/
     */function(){if(!t_().autoScrolling||t_().scrollBar){// First we get the viewport height and we multiple it by 1% to get a value for a vh unit
var e=.01*D.innerHeight;// Then we set the value in the --vh custom property to the root of the document
M.documentElement.style.setProperty("--vh","".concat(e,"px"))}}(),eH.emit(ez.contentChanged),nD(),nv(),P){var e,t,n=M.activeElement;//if the keyboard is NOT visible
...
Math.abs(i-iD)>20*Math.max(iD,i)/100&&(iN(!0),iD=i)}}else e=G(),t=U(),(eq.windowsHeight!==e||iM!==t)&&(eR({windowsHeight:e}),iM=t,iN(!0));eR({isResizing:!1})})(),iP=!1},400)}/**
     * When resizing is finished, we adjust the slides sizes and positions
     */function iN(e){if(!W(tC,eX)){//nothing to do if the plugin was destroyed
//updating global vars
eR({isResizing:!0,windowsHeight:G(),windowsWidth:U()});for(var t=eq.sections,n=0;n<t.length;++n){var i=t[n],r=B(ta,i.item)[0];i.slides.length>1&&nA(r,i.activeSlide.item)}t_().scrollOverflow&&nE.makeScrollable();var o=eq.activeSection.index();!eq.isBeyondFullpage&&o&&iO(o+1),eR({isResizing:!1}),eS(t_().afterResize)&&e&&t_().afterResize.call(tC,D.innerWidth,D.innerHeight),eS(t_().afterReBuild)&&!e&&t_().afterReBuild.call(tC),ex(tC,"afterRebuild")}}function iH(e){var t=""===e?"":e+"px";eq.sections.forEach(function(e){V(e.item,{height:t})})}function iq(){var e,t,n=D.location.hash;if(n.length){//getting the anchor link in the URL and deleting the `#`
var i=n.replace("#","").split("/"),r=n.indexOf("#/")>-1;//using / for visual reasons and not as a section/slide separator #2803
e=r?"/"+i[1]:decodeURIComponent(i[0]);var o=r?i[2]:i[1];o&&o.length&&(t=decodeURIComponent(o))}return{section:e,slide:t}}function iR(){ew("hashchange",iz)}/**
    * Detecting any change on the URL to scroll to the given anchor link
    * (a way to detect back history button as we play with the hashes on the URL)
    */function iz(){if(!eq.isScrolling&&!t_().lockAnchors){var e=iq(),t=e.section,n=e.slide,i=void 0===eq.lastScrolledDestiny,r=void 0===eq.lastScrolledDestiny&&void 0===n&&!eq.slideMoving;t&&t.length&&(t&&t!==eq.lastScrolledDestiny&&!i||r||!eq.slideMoving&&eq.lastScrolledSlide!=n)&&eH.emit(ez.onScrollPageAndSlide,{sectionAnchor:t,slideAnchor:n})}}function iB(e){var t=e.target;ec(t,t_().menu+" [data-menuanchor]")&&iF.call(t,e)}//Menu item handler when not using anchors or using lockAnchors:true
function iF(e){eR({scrollTrigger:"menu"}),B(t_().menu)[0]&&(t_().lockAnchors||!t_().anchors.length)&&(eg(e),/*jshint validthis:true */eH.emit(ez.onMenuClick,{anchor:em(this,"data-menuanchor")}))}function iW(e){var t=e.target;t&&ec(t,te+" a")?nc.call(t,e.e):eT(t,tn)?na.call(t):(eT(t,tm)||null!=ec(t,tm))&&ne.call(t,e.e)}H.reBuild=iN,eH.on(ez.bindEvents,function(){// Setting VH correctly in mobile devices
iI(),ey("resize",iI),eH.on(ez.onDestroy,ij)}),H.setLockAnchors=/**
    * Sets lockAnchors
    */function(e){t_().lockAnchors=e},eH.on(ez.bindEvents,function(){//detecting any change on the URL to scroll to the given anchor link
//(a way to detect back history button as we play with the hashes on the URL)
ey("hashchange",iz),eH.on(ez.onDestroy,iR)}),eH.on(ez.bindEvents,function(){ev("wheel",nG.registerEvent,nW()),eH.on(ez.scrollBeyondFullpage,nU),eH.on(ez.onKeyDown,nV)}),eH.on(ez.bindEvents,function(){eH.on(ez.onClickOrTouch,iB)}),eH.on(ez.bindEvents,function(){eH.on(ez.onClickOrTouch,iW)});var iG=0;function iU(e){if(!eq.isResizing&&eq.activeSection&&(eO(eq.sections),!eq.isBeyondFullpage&&!eq.isAboutToScrollToFullPage&&(!t_().autoScrolling||t_().scrollBar))){var t=eh(),n=(l=t>iG?"down":"up",iG=t,eR({previousDestTop:t}),l),i=0,r=t+G()/2,o=tY.scrollHeight-G()===t,s=eq.sections;if(eR({scrollY:t}),o)i=s.length-1;else if(t)for(var a=0;a<s.length;++a)s[a].item.offsetTop<=r&&(i=a);else i=0;//executing only once the first time we reach the section
if(u=(c=eq.activeSection.item.offsetTop)+G(),("up"==n?u>=eh()+G():c<=eh())&&!W(eq.activeSection.item,e0)&&(en(eq.activeSection.item,e0),ei(ef(eq.activeSection.item),e0)),p=(d=s[i]).item,!d.isActive){eR({isScrolling:!0});var l,c,u,d,p,h,f,g=eq.activeSection.item,m=eq.activeSection.index()+1,v=tF(eq.activeSection,p),y=d.anchor,b=d.index()+1,w=d.activeSlide,S={activeSection:g,sectionIndex:b-1,anchorLink:y,element:p,leavingSection:m,direction:v,items:{origin:eq.activeSection,destination:d}};w&&(f=w.anchor,h=w.index()),eq.canScroll&&(en(p,eZ),ei(ef(p),eZ),eS(t_().beforeLeave)&&np("beforeLeave",S),eS(t_().onLeave)&&t0("onLeave",S),eS(t_().afterLoad)&&t0("afterLoad",S),t3(g),t4(p),t1(p),nu(y,b-1),t_().anchors.length&&eR({lastScrolledDestiny:y}),nD(),t7(h,f,y)),clearTimeout(k),k=setTimeout(function(){eR({isScrolling:!1})},100)}t_().fitToSection&&eq.canScroll&&(clearTimeout(O),O=setTimeout(function(){eq.sections.filter(function(e){var t=e.item.getBoundingClientRect();return Math.round(t.bottom)===Math.round(G())||0===Math.round(t.top)}).length||nm()},t_().fitToSectionDelay))}}/**
    * Adds or remove the possibility of scrolling through sections by using the keyboard arrow keys
    */function iV(e,t){void 0!==t?(t=t.replace(/ /g,"").split(",")).forEach(function(t){nn(e,t,"k")}):(nn(e,"all","k"),t_().keyboardScrolling=e)}/**
    * Actions and callbacks to fire afterRender
    */function iY(){var e,t,n=eq.activeSection,i=eq.activeSection.item;en(i,e0),t4(i),ns(),t1(i),t=ia((e=iq()).section),(!e.section||!t||void 0!==t&&t.index()===Q(nw))&&eS(t_().afterLoad)&&t0("afterLoad",{activeSection:i,element:i,direction:null,//for backwards compatibility callback (to be removed in a future!)
anchorLink:n.anchor,sectionIndex:n.index(),items:{origin:eq.activeSection,destination:eq.activeSection}}),eS(t_().afterRender)&&t0("afterRender")}/**
    * Adds or remove the possibility of scrolling through sections by using the mouse wheel/trackpad or touch gestures.
    * Optionally a second parameter can be used to specify the direction for which the action will be applied.
    *
    * @param directions string containing the direction or directions separated by comma.
    */function iX(e,t){void 0!==t?(t=t.replace(/ /g,"").split(",")).forEach(function(t){nn(e,t,"m")}):nn(e,"all","m")}/**
    * Scrolls to the anchor in the URL when loading the site
    */function iK(){var e=iq(),t=e.section,n=e.slide;t?t_().animateAnchor?ic(t,n):iO(t,n):eH.emit(ez.onAfterRenderNoAnchor,null)}/**
    * Displays warnings
    */function iQ(){var e=t_().licenseKey,t="font-size: 15px;background:yellow;";""===t_().licenseKey.trim()||(t_()&&eq.isValid||M.domain.indexOf("alvarotrigo.com")>-1)&&e&&e.length<20&&(console.warn("%c This website was made using fullPage.js slider. More info on the following website:",t),console.warn("%c https://alvarotrigo.com/fullPage/",t)),W(tX,eK)||(t_().continuousVertical&&(t_().loopTop||t_().loopBottom)&&(t_().continuousVertical=!1),t_().scrollOverflow&&(t_().scrollBar||t_().autoScrolling),t_().continuousVertical&&(t_().scrollBar||!t_().autoScrolling)&&(t_().continuousVertical=!1),//using extensions? Wrong file!
q.forEach(function(e){t_()[e]}),t_().anchors.forEach(function(e){//case insensitive selectors (http://stackoverflow.com/a/19465187/1081396)
var t=[].slice.call(B("[name]")).filter(function(t){return em(t,"name")&&em(t,"name").toLowerCase()==e.toLowerCase()}),n=[].slice.call(B("[id]")).filter(function(t){return em(t,"id")&&em(t,"id").toLowerCase()==e.toLowerCase()});(n.length||t.length)&&(n.length,n.length||t.length)}))}function iZ(e,t){var n;if(tY=B("body")[0],tX=B("html")[0],tK=B("html, body"),W(tX,eK)){iQ();return}return n="string"==typeof e?B(e)[0]:e,tE.touchWrapper=n,tL=Object.assign({},t$=F({},tE,t)),tC="string"==typeof e?B(e)[0]:e,eH.emit(ez.onInitialise),iQ(),H.getFullpageData=function(){return{options:t_()}},H.version="4.0.20",H.test=Object.assign(H.test,{top:"0px",translate3d:"translate3d(0px, 0px, 0px)",translate3dH:function(){for(var e=[],t=0;t<B(t_().sectionSelector,tC).length;t++)e.push("translate3d(0px, 0px, 0px)");return e}(),left:function(){for(var e=[],t=0;t<B(t_().sectionSelector,tC).length;t++)e.push(0);return e}(),options:t_(),setAutoScrolling:null}),//mean to be used on their own by developers
H.shared=Object.assign(H.shared,{afterRenderActions:null,isNormalScrollElement:!1}),D.fullpage_api=H,tC&&(eH.emit(ez.beforeInit),nM(),nD(),t_().scrollBar=t_().scrollBar||t_().hybrid,tO(),/**
    * Works over the DOM structure to set it up for the current fullpage getOptions().
    */function(){V(eP(tC,"body"),{height:"100%",position:"relative"}),en(tC,eG),en(tX,eK),eR({windowsHeight:G()}),ei(tC,eX),nH();for(var e=eq.sectionsIncludingHidden,t=0;t<e.length;t++){var n=e[t],i=n.allSlidesItems,r=em(n.item,"style");r&&n.item.setAttribute("data-fp-styles",r),nS(n),/**
    * Sets the data-anchor attributes to the menu elements and activates the current one.
    */function(e){var t=e.index();void 0!==t_().anchors[t]&&e.isActive&&nu(t_().anchors[t],t),t_().menu&&t_().css3&&null!=ec(B(t_().menu)[0],eU)&&B(t_().menu).forEach(function(e){tY.appendChild(e)})}(n),i.length>0&&nq(n)}//fixed elements need to be moved out of the plugin container due to problems with CSS3.
t_().fixedElements&&t_().css3&&B(t_().fixedElements).forEach(function(e){tY.appendChild(e)}),t_().navigation&&nl(),B('iframe[src*="youtube.com/embed/"]',tC).forEach(function(e){/**
    * Adds a new parameter and its value to the `src` of a given element
    */(function(e,t){var n=em(e,"src");e.setAttribute("src",n+(/\?/.test(n)?"&":"?")+t)})(e,"enablejsapi=1")}),t_().scrollOverflow&&nE.makeScrollable()}(),iX(!0),iA(!0),no(t_().autoScrolling,"internal"),nv(),t6(),"complete"===M.readyState&&iK(),ey("load",iK),iY(),nM(),nD(),eH.emit(ez.bindEvents)),D.fullpage_api}return eH.on(ez.onDestroy,function(){clearTimeout(k),clearTimeout(O)}),eH.on(ez.bindEvents,function(){ey("scroll",iU),M.body.addEventListener("scroll",iU),eH.on(ez.onScrollPageAndSlide,function(e){ic(e.sectionAnchor,e.slideAnchor)}),eH.on(ez.onMenuClick,function(e){iu(e.anchor,void 0)}),eH.on(ez.onScrollOverflowScrolled,function(e){("down"===e.direction?nK:nQ)()}),eH.on(ez.scrollPage,function(e){nh(e.destination)})}),eH.on(ez.onDestroy,function(){ew("scroll",iU)}),H.getActiveSlide=/**
    * Gets the active slide.
    */function(){return tJ(eq.activeSection.activeSlide)},H.getScrollX=function(){return eq.scrollX},eH.on(ez.bindEvents,function(){eH.on(ez.onDestroy,nL),eH.on(ez.landscapeScroll,function(e){nA(e.slides,e.destination)}),eH.on(ez.moveSlideRight,function(e){is(e.section)}),eH.on(ez.moveSlideLeft,function(e){io(e.section)})}),eH.on(ez.bindEvents,function(){var e=t_().credits.position||"right",t=["left","right"].indexOf(e)>-1?"".concat(e,": 0;"):"",n='\n        <div class="fp-watermark" style="'.concat(t,'">\n            <a href="https://alvarotrigo.com/fullPage/" \n                rel="nofollow noopener" \n                target="_blank" \n                style="text-decoration:none; color: #000;">\n                    ').concat(t_().credits.label||"Made with fullPage.js","\n            </a>\n        </div>\n    "),i=eO(eq.sections),r=!eq.isValid||t_().credits.enabled;i&&i.item&&r&&i.item.insertAdjacentHTML("beforeend",n)}),function(){eH.on(ez.onInitialise,function(){var t,a,l,c;eR({isValid:(t_().licenseKey,a=function(t){var n=parseInt("514").toString(16);if(!t||t.length<29||4===t.split(e[0]).length)return null;var i=["Each","for"][r()]().join(""),a=t[["split"]]("-"),l=[];a[i](function(e,t){if(t<4){var i,s,a=(i=e[e.length-1],s=["NaN","is"][r()]().join(""),window[s](i)?o(i):i-eZ.length);l.push(a);var c=o(e[a]);1===t&&(c=c.toString().padStart(2,"0")),n+=c,0!==t&&1!==t||(n+="-")}});var c=0,u="";return t.split("-").forEach(function(e,t){if(t<4){for(var n=0,i=0;i<4;i++)i!==l[t]&&(n+=Math.abs(o(e[i])),isNaN(e[i])||c++);var r=s(n);u+=r}}),u+=s(c),{v:new Date(n+"T00:00"),o:n.split("-")[2]===8*(eZ.length-2)+"",l:u}}(t=t_().licenseKey),c=i[r()]().join(""),l=t&&0===c.indexOf(t)&&t.length===c.length,(a||l)&&(a&&n<=a.v&&a.l===t.split(e[0])[4]||l||a.o)||!1)})});var e=["-"],t="2023-4-29".split("-"),n=new Date(t[0],t[1],t[2]),i=["se","licen","-","v3","l","gp"];function r(){return"reverse"}function o(e){return e?isNaN(e)?e.charCodeAt(0)-72:e:""}function s(e){var t=72+e;return t>90&&t<97&&(t+=15),String.fromCharCode(t).toUpperCase()}}(),//@ts-check
H.setKeyboardScrolling=iV,H.shared.afterRenderActions=iY,H.setAllowScrolling=iX,H.destroy=/*
    * Destroys fullpage.js plugin events and optinally its html markup and styles
    */function(e){no(!1,"internal"),iX(!0),iA(!1),iV(!1),en(tC,eX),eH.emit(ez.onDestroy),e&&(//reseting the `top` or `translate` properties to 0
tU(0),B("img[data-src], source[data-src], audio[data-src], iframe[data-src]",tC).forEach(function(e){eM(e,"src")}),B("img[data-srcset]").forEach(function(e){eM(e,"srcset")}),eA(B(te+", "+tg+", "+tb)),V(tP(eq.sections),{height:"","background-color":"",padding:""}),V(tP(eq.slides),{width:""}),V(tC,{height:"",position:"","-ms-touch-action":"","touch-action":""}),V(tK,{overflow:"",height:""}),ei(tX,eK),ei(tY,eV+" fp-scrollable"),tY.className.split(/\s+/).forEach(function(e){0===e.indexOf(eQ)&&ei(tY,e)}),tP(eq.panels).forEach(function(e){t_().scrollOverflow&&nE.destroyWrapper(e),ei(e,tu+" "+eZ+" "+e0+" "+th);var t=em(e,"data-fp-styles");t&&e.setAttribute("style",t),W(e,e2)&&!tA&&e.removeAttribute("data-anchor")}),en(tC,eY),[".fp-tableCell",tc,ta].forEach(function(e){B(e,tC).forEach(function(e){//unwrap not being use in case there's no child element inside and its just text
el(e)})}),V(tC,{"-webkit-transition":"none",transition:"none"}),ei(tC,eG),D.scrollTo(0,0),[e2,ti,tl].forEach(function(e){ei(B("."+e),e)}))},// @ts-ignore
D.fp_easings=F(D.fp_easings,{easeInOutCubic:function(e,t,n,i){return(e/=i/2)<1?n/2*e*e*e+t:n/2*((e-=2)*e*e+2)+t}}),D.jQuery&&(h=D.jQuery)&&iZ&&(h.fn.fullpage=function(e){e=h.extend({},e,{$:h}),new iZ(this[0],e),Object.keys(H).forEach(function(e){t_().$.fn.fullpage[e]=H[e]})}),iZ}();const f={body:{},addEventListener(){},removeEventListener(){},activeElement:{blur(){},nodeName:""},querySelector:()=>null,querySelectorAll:()=>[],getElementById:()=>null,createEvent:()=>({initEvent(){}}),createElement:()=>({children:[],childNodes:[],style:{},setAttribute(){},getElementsByTagName:()=>[]}),createElementNS:()=>({}),importNode:()=>null,location:{hash:"",host:"",hostname:"",href:"",origin:"",pathname:"",protocol:"",search:""}};function g(){let e="undefined"!=typeof document?document:{};return h(e,f),e}const m={document:f,navigator:{userAgent:""},location:{hash:"",host:"",hostname:"",href:"",origin:"",pathname:"",protocol:"",search:""},history:{replaceState(){},pushState(){},go(){},back(){}},CustomEvent:function(){return this},addEventListener(){},removeEventListener(){},getComputedStyle:()=>({getPropertyValue:()=>""}),Image(){},Date(){},screen:{},setTimeout(){},clearTimeout(){},matchMedia:()=>({}),requestAnimationFrame:e=>"undefined"==typeof setTimeout?(e(),null):setTimeout(e,0),cancelAnimationFrame(e){"undefined"!=typeof setTimeout&&clearTimeout(e)}};function v(){let e="undefined"!=typeof window?window:{};return h(e,m),e}class y extends Array{constructor(e){"number"==typeof e?super(e):(super(...e||[]),/**
 * Dom7 4.0.6
 ...
 *//* eslint-disable no-proto */function(e){let t=e.__proto__;Object.defineProperty(e,"__proto__",{get:()=>t,set(e){t.__proto__=e}})}(this))}}function b(e=[]){let t=[];return e.forEach(e=>{Array.isArray(e)?t.push(...b(e)):t.push(e)}),t}function w(e,t){return Array.prototype.filter.call(e,t)}function S(e,t){let n=v(),i=g(),r=[];if(!t&&e instanceof y)return e;if(!e)return new y(r);if("string"==typeof e){let n=e.trim();if(n.indexOf("<")>=0&&n.indexOf(">")>=0){let e="div";0===n.indexOf("<li")&&(e="ul"),0===n.indexOf("<tr")&&(e="tbody"),(0===n.indexOf("<td")||0===n.indexOf("<th"))&&(e="tr"),0===n.indexOf("<tbody")&&(e="table"),0===n.indexOf("<option")&&(e="select");let t=i.createElement(e);t.innerHTML=n;for(let e=0;e<t.childNodes.length;e+=1)r.push(t.childNodes[e])}else r=// eslint-disable-next-line
...
for(n=0;n<this.length;n+=1)this[n].style[e]=t;return this},each:function(e){return e&&this.forEach((t,n)=>{e.apply(t,[t,n])}),this},html:function(e){if(void 0===e)return this[0]?this[0].innerHTML:null;for(let t=0;t<this.length;t+=1)this[t].innerHTML=e;return this},text:function(e){if(void 0===e)return this[0]?this[0].textContent.trim():null;for(let t=0;t<this.length;t+=1)this[t].textContent=e;return this},is:function(e){let t,n;let i=v(),r=g(),o=this[0];if(!o||void 0===e)return!1;if("string"==typeof e){if(o.matches)return o.matches(e);if(o.webkitMatchesSelector)return o.webkitMatchesSelector(e);if(o.msMatchesSelector)return o.msMatchesSelector(e);for(n=0,t=S(e);n<t.length;n+=1)if(t[n]===o)return!0;return!1}if(e===r)return o===r;if(e===i)return o===i;if(e.nodeType||e instanceof y){for(n=0,t=e.nodeType?[e]:e;n<t.length;n+=1)if(t[n]===o)return!0}return!1},index:function(){let e,t=this[0];if(t){for(e=0;null!==(t=t.previousSibling);)1===t.nodeType&&(e+=1);return e}},eq:function(e){if(void 0===e)return this;let t=this.length;if(e>t-1)return S([]);if(e<0){let n=t+e;return n<0?S([]):S([this[n]])}return S([this[e]])},append:function(...e){let t;let n=g();for(let i=0;i<e.length;i+=1){t=e[i];for(let e=0;e<this.length;e+=1)if("string"==typeof t){let i=n.createElement("div");for(i.innerHTML=t;i.firstChild;)this[e].appendChild(i.firstChild)}else if(t instanceof y)for(let n=0;n<t.length;n+=1)this[e].appendChild(t[n]);else this[e].appendChild(t)}return this},prepend:function(e){let t,n;let i=g();for(t=0;t<this.length;t+=1)if("string"==typeof e){let r=i.createElement("div");for(r.innerHTML=e,n=r.childNodes.length-1;n>=0;n-=1)this[t].insertBefore(r.childNodes[n],this[t].childNodes[0])}else if(e instanceof y)for(n=0;n<e.length;n+=1)this[t].insertBefore(e[n],this[t].childNodes[0]);else this[t].insertBefore(e,this[t].childNodes[0]);return this},next:function(e){if(this.length>0){if(e)return this[0].nextElementSibling&&S(this[0].nextElementSibling).is(e)?S([this[0].nextElementSibling]):S([]);if(this[0].nextElementSibling)return S([this[0].nextElementSibling])}return S([])},nextAll:function(e){let t=[],n=this[0];if(!n)return S([]);for(;n.nextElementSibling;){let i=n.nextElementSibling;// eslint-disable-line
e?S(i).is(e)&&t.push(i):t.push(i),n=i}return S(t)},prev:function(e){if(this.length>0){let t=this[0];if(e)return t.previousElementSibling&&S(t.previousElementSibling).is(e)?S([t.previousElementSibling]):S([]);if(t.previousElementSibling)return S([t.previousElementSibling])}return S([])},prevAll:function(e){let t=[],n=this[0];if(!n)return S([]);for(;n.previousElementSibling;){let i=n.previousElementSibling;// eslint-disable-line
e?S(i).is(e)&&t.push(i):t.push(i),n=i}return S(t)},parent:function(e){let t=[];// eslint-disable-line
for(let n=0;n<this.length;n+=1)null!==this[n].parentNode&&(e?S(this[n].parentNode).is(e)&&t.push(this[n].parentNode):t.push(this[n].parentNode));return S(t)},parents:function(e){let t=[];// eslint-disable-line
for(let n=0;n<this.length;n+=1){let i=this[n].parentNode;// eslint-disable-line
for(;i;)e?S(i).is(e)&&t.push(i):t.push(i),i=i.parentNode}return S(t)},closest:function(e){let t=this;// eslint-disable-line
return void 0===e?S([]):(t.is(e)||(t=t.parents(e).eq(0)),t)},find:function(e){let t=[];for(let n=0;n<this.length;n+=1){let i=this[n].querySelectorAll(e);for(let e=0;e<i.length;e+=1)t.push(i[e])}return S(t)},children:function(e){let t=[];// eslint-disable-line
for(let n=0;n<this.length;n+=1){let i=this[n].children;for(let n=0;n<i.length;n+=1)(!e||S(i[n]).is(e))&&t.push(i[n])}return S(t)},filter:function(e){let t=w(this,e);return S(t)},remove:function(){for(let e=0;e<this.length;e+=1)this[e].parentNode&&this[e].parentNode.removeChild(this[e]);return this}};function C(e,t=0){return setTimeout(e,t)}function A(){return Date.now()}function L(e){return"object"==typeof e&&null!==e&&e.constructor&&"Object"===Object.prototype.toString.call(e).slice(8,-1)}function _(...e){let t=Object(e[0]),n=["__proto__","constructor","prototype"];for(let i=1;i<e.length;i+=1){let r=e[i];if(null!=r&&// eslint-disable-next-line
("undefined"!=typeof window&&void 0!==window.HTMLElement?!(r instanceof HTMLElement):!r||1!==r.nodeType&&11!==r.nodeType)){let e=Object.keys(Object(r)).filter(e=>0>n.indexOf(e));for(let n=0,i=e.length;n<i;n+=1){let i=e[n],o=Object.getOwnPropertyDescriptor(r,i);void 0!==o&&o.enumerable&&(L(t[i])&&L(r[i])?r[i].__swiper__?t[i]=r[i]:_(t[i],r[i]):!L(t[i])&&L(r[i])?(t[i]={},r[i].__swiper__?t[i]=r[i]:_(t[i],r[i])):t[i]=r[i])}}}return t}function k(e,t,n){e.style.setProperty(t,n)}function O({swiper:e,targetPosition:t,side:n}){let i;let r=v(),o=-e.translate,s=null,a=e.params.speed;e.wrapperEl.style.scrollSnapType="none",r.cancelAnimationFrame(e.cssModeFrameID);let l=t>o?"next":"prev",c=(e,t)=>"next"===l&&e>=t||"prev"===l&&e<=t,u=()=>{i=new Date().getTime(),null===s&&(s=i);let l=Math.max(Math.min((i-s)/a,1),0),d=o+(.5-Math.cos(l*Math.PI)/2)*(t-o);if(c(d,t)&&(d=t),e.wrapperEl.scrollTo({[n]:d}),c(d,t)){e.wrapperEl.style.overflow="hidden",e.wrapperEl.style.scrollSnapType="",setTimeout(()=>{e.wrapperEl.style.overflow="",e.wrapperEl.scrollTo({[n]:d})}),r.cancelAnimationFrame(e.cssModeFrameID);return}e.cssModeFrameID=r.requestAnimationFrame(u)};u()}function D(){return e||(e=function(){let e=v(),t=g();return{smoothScroll:t.documentElement&&"scrollBehavior"in t.documentElement.style,touch:!!("ontouchstart"in e||e.DocumentTouch&&t instanceof e.DocumentTouch),passiveListener:function(){let t=!1;try{let n=Object.defineProperty({},"passive",{// eslint-disable-next-line
get(){t=!0}});e.addEventListener("testPassiveListener",null,n)}catch(e){}return t}(),gestures:"ongesturestart"in e}}()),e}function M({swiper:e,runCallbacks:t,direction:n,step:i}){let{activeIndex:r,previousIndex:o}=e,s=n;if(s||(s=r>o?"next":r<o?"prev":"reset"),e.emit(`transition${i}`),t&&r!==o){if("reset"===s){e.emit(`slideResetTransition${i}`);return}e.emit(`slideChangeTransition${i}`),"next"===s?e.emit(`slideNextTransition${i}`):e.emit(`slidePrevTransition${i}`)}}function P(e){let t=g(),n=v(),i=this.touchEventsData,{params:r,touches:o,enabled:s}=this;if(!s||this.animating&&r.preventInteractionOnTransition)return;!this.animating&&r.cssMode&&r.loop&&this.loopFix();let a=e;a.originalEvent&&(a=a.originalEvent);let l=S(a.target);if("wrapper"===r.touchEventsTarget&&!l.closest(this.wrapperEl).length||(i.isTouchEvent="touchstart"===a.type,!i.isTouchEvent&&"which"in a&&3===a.which||!i.isTouchEvent&&"button"in a&&a.button>0||i.isTouched&&i.isMoved))return;let c=!!r.noSwipingClass&&""!==r.noSwipingClass;c&&a.target&&a.target.shadowRoot&&e.path&&e.path[0]&&(l=S(e.path[0]));let u=r.noSwipingSelector?r.noSwipingSelector:`.${r.noSwipingClass}`,d=!!(a.target&&a.target.shadowRoot);if(r.noSwiping&&(d?function(e,t=this){return function t(n){if(!n||n===g()||n===v())return null;n.assignedSlot&&(n=n.assignedSlot);let i=n.closest(e);return i||t(n.getRootNode().host)}(t)}(u,a.target):l.closest(u)[0])){this.allowClick=!0;return}if(r.swipeHandler&&!l.closest(r.swipeHandler)[0])return;o.currentX="touchstart"===a.type?a.targetTouches[0].pageX:a.pageX,o.currentY="touchstart"===a.type?a.targetTouches[0].pageY:a.pageY;let p=o.currentX,h=o.currentY,f=r.edgeSwipeDetection||r.iOSEdgeSwipeDetection,m=r.edgeSwipeThreshold||r.iOSEdgeSwipeThreshold;if(f&&(p<=m||p>=n.innerWidth-m)){if("prevent"!==f)return;e.preventDefault()}if(Object.assign(i,{isTouched:!0,isMoved:!1,allowTouchCallbacks:!0,isScrolling:void 0,startMoving:void 0}),o.startX=p,o.startY=h,i.touchStartTime=A(),this.allowClick=!0,this.updateSize(),this.swipeDirection=void 0,r.threshold>0&&(i.allowThresholdMove=!1),"touchstart"!==a.type){let e=!0;l.is(i.focusableElements)&&(e=!1),t.activeElement&&S(t.activeElement).is(i.focusableElements)&&t.activeElement!==l[0]&&t.activeElement.blur();let n=e&&this.allowTouchMove&&r.touchStartPreventDefault;(r.touchStartForcePreventDefault||n)&&!l[0].isContentEditable&&a.preventDefault()}this.emit("touchStart",a)}function j(e){let t=g(),n=this.touchEventsData,{params:i,touches:r,rtlTranslate:o,enabled:s}=this;if(!s)return;let a=e;if(a.originalEvent&&(a=a.originalEvent),!n.isTouched){n.startMoving&&n.isScrolling&&this.emit("touchMoveOpposite",a);return}if(n.isTouchEvent&&"touchmove"!==a.type)return;let l="touchmove"===a.type&&a.targetTouches&&(a.targetTouches[0]||a.changedTouches[0]),c="touchmove"===a.type?l.pageX:a.pageX,u="touchmove"===a.type?l.pageY:a.pageY;if(a.preventedByNestedSwiper){r.startX=c,r.startY=u;return}if(!this.allowTouchMove){// isMoved = true;
this.allowClick=!1,n.isTouched&&(Object.assign(r,{startX:c,startY:u,currentX:c,currentY:u}),n.touchStartTime=A());return}if(n.isTouchEvent&&i.touchReleaseOnEdges&&!i.loop){if(this.isVertical()){if(u<r.startY&&this.translate<=this.maxTranslate()||u>r.startY&&this.translate>=this.minTranslate()){n.isTouched=!1,n.isMoved=!1;return}}else if(c<r.startX&&this.translate<=this.maxTranslate()||c>r.startX&&this.translate>=this.minTranslate())return}if(n.isTouchEvent&&t.activeElement&&a.target===t.activeElement&&S(a.target).is(n.focusableElements)){n.isMoved=!0,this.allowClick=!1;return}if(n.allowTouchCallbacks&&this.emit("touchMove",a),a.targetTouches&&a.targetTouches.length>1)return;r.currentX=c,r.currentY=u;let d=r.currentX-r.startX,p=r.currentY-r.startY;if(this.params.threshold&&Math.sqrt(d**2+p**2)<this.params.threshold)return;if(void 0===n.isScrolling){let e;this.isHorizontal()&&r.currentY===r.startY||this.isVertical()&&r.currentX===r.startX?n.isScrolling=!1:d*d+p*p>=25&&(e=180*Math.atan2(Math.abs(p),Math.abs(d))/Math.PI,n.isScrolling=this.isHorizontal()?e>i.touchAngle:90-e>i.touchAngle)}if(n.isScrolling&&this.emit("touchMoveOpposite",a),void 0===n.startMoving&&(r.currentX!==r.startX||r.currentY!==r.startY)&&(n.startMoving=!0),n.isScrolling){n.isTouched=!1;return}if(!n.startMoving)return;this.allowClick=!1,!i.cssMode&&a.cancelable&&a.preventDefault(),i.touchMoveStopPropagation&&!i.nested&&a.stopPropagation(),n.isMoved||(i.loop&&!i.cssMode&&this.loopFix(),n.startTranslate=this.getTranslate(),this.setTransition(0),this.animating&&this.$wrapperEl.trigger("webkitTransitionEnd transitionend"),n.allowMomentumBounce=!1,i.grabCursor&&(!0===this.allowSlideNext||!0===this.allowSlidePrev)&&this.setGrabCursor(!0),this.emit("sliderFirstMove",a)),this.emit("sliderMove",a),n.isMoved=!0;let h=this.isHorizontal()?d:p;r.diff=h,h*=i.touchRatio,o&&(h=-h),this.swipeDirection=h>0?"prev":"next",n.currentTranslate=h+n.startTranslate;let f=!0,m=i.resistanceRatio;// Threshold
if(i.touchReleaseOnEdges&&(m=0),h>0&&n.currentTranslate>this.minTranslate()?(f=!1,i.resistance&&(n.currentTranslate=this.minTranslate()-1+(-this.minTranslate()+n.startTranslate+h)**m)):h<0&&n.currentTranslate<this.maxTranslate()&&(f=!1,i.resistance&&(n.currentTranslate=this.maxTranslate()+1-(this.maxTranslate()-n.startTranslate-h)**m)),f&&(a.preventedByNestedSwiper=!0),!this.allowSlideNext&&"next"===this.swipeDirection&&n.currentTranslate<n.startTranslate&&(n.currentTranslate=n.startTranslate),!this.allowSlidePrev&&"prev"===this.swipeDirection&&n.currentTranslate>n.startTranslate&&(n.currentTranslate=n.startTranslate),this.allowSlidePrev||this.allowSlideNext||(n.currentTranslate=n.startTranslate),i.threshold>0){if(Math.abs(h)>i.threshold||n.allowThresholdMove){if(!n.allowThresholdMove){n.allowThresholdMove=!0,r.startX=r.currentX,r.startY=r.currentY,n.currentTranslate=n.startTranslate,r.diff=this.isHorizontal()?r.currentX-r.startX:r.currentY-r.startY;return}}else{n.currentTranslate=n.startTranslate;return}}i.followFinger&&!i.cssMode&&((i.freeMode&&i.freeMode.enabled&&this.freeMode||i.watchSlidesProgress)&&(this.updateActiveIndex(),this.updateSlidesClasses()),this.params.freeMode&&i.freeMode.enabled&&this.freeMode&&this.freeMode.onTouchMove(),// Update progress
this.updateProgress(n.currentTranslate),this.setTranslate(n.currentTranslate))}function I(e){let t;let n=this,i=n.touchEventsData,{params:r,touches:o,rtlTranslate:s,slidesGrid:a,enabled:l}=n;if(!l)return;let c=e;if(c.originalEvent&&(c=c.originalEvent),i.allowTouchCallbacks&&n.emit("touchEnd",c),i.allowTouchCallbacks=!1,!i.isTouched){i.isMoved&&r.grabCursor&&n.setGrabCursor(!1),i.isMoved=!1,i.startMoving=!1;return}// Return Grab Cursor
r.grabCursor&&i.isMoved&&i.isTouched&&(!0===n.allowSlideNext||!0===n.allowSlidePrev)&&n.setGrabCursor(!1);// Time diff
let u=A(),d=u-i.touchStartTime;if(n.allowClick){let e=c.path||c.composedPath&&c.composedPath();n.updateClickedSlide(e&&e[0]||c.target),n.emit("tap click",c),d<300&&u-i.lastClickTime<300&&n.emit("doubleTap doubleClick",c)}if(i.lastClickTime=A(),C(()=>{n.destroyed||(n.allowClick=!0)}),!i.isTouched||!i.isMoved||!n.swipeDirection||0===o.diff||i.currentTranslate===i.startTranslate){i.isTouched=!1,i.isMoved=!1,i.startMoving=!1;return}if(i.isTouched=!1,i.isMoved=!1,i.startMoving=!1,t=r.followFinger?s?n.translate:-n.translate:-i.currentTranslate,r.cssMode)return;if(n.params.freeMode&&r.freeMode.enabled){n.freeMode.onTouchEnd({currentPos:t});return}// Find current slide
...
if(!r.shortSwipes){n.slideTo(n.activeIndex);return}let e=n.navigation&&(c.target===n.navigation.nextEl||c.target===n.navigation.prevEl);e?c.target===n.navigation.nextEl?n.slideTo(p+g):n.slideTo(p):("next"===n.swipeDirection&&n.slideTo(p+g),"prev"===n.swipeDirection&&n.slideTo(p))}}function N(){let{params:e,el:t}=this;if(t&&0===t.offsetWidth)return;// Breakpoints
...
this.allowSlidePrev=i,this.allowSlideNext=n,this.params.watchOverflow&&r!==this.snapGrid&&this.checkOverflow()}function H(e){this.enabled&&!this.allowClick&&(this.params.preventClicks&&e.preventDefault(),this.params.preventClicksPropagation&&this.animating&&(e.stopPropagation(),e.stopImmediatePropagation()))}function q(){let{wrapperEl:e,rtlTranslate:t,enabled:n}=this;if(!n)return;this.previousTranslate=this.translate,this.isHorizontal()?this.translate=-e.scrollLeft:this.translate=-e.scrollTop,-0===this.translate&&(this.translate=0),this.updateActiveIndex(),this.updateSlidesClasses();let i=this.maxTranslate()-this.minTranslate();(0===i?0:(this.translate-this.minTranslate())/i)!==this.progress&&this.updateProgress(t?-this.translate:this.translate),this.emit("setTranslate",this.translate,!1)}Object.keys(E).forEach(e=>{Object.defineProperty(S.fn,e,{value:E[e],writable:!0})});let R=!1;function z(){}const B=(e,t)=>{let n=g(),{params:i,touchEvents:r,el:o,wrapperEl:s,device:a,support:l}=e,c=!!i.nested,u="on"===t?"addEventListener":"removeEventListener";if(l.touch){let t="touchstart"===r.start&&!!l.passiveListener&&!!i.passiveListeners&&{passive:!0,capture:!1};o[u](r.start,e.onTouchStart,t),o[u](r.move,e.onTouchMove,l.passiveListener?{passive:!1,capture:c}:c),o[u](r.end,e.onTouchEnd,t),r.cancel&&o[u](r.cancel,e.onTouchEnd,t)}else o[u](r.start,e.onTouchStart,!1),n[u](r.move,e.onTouchMove,c),n[u](r.end,e.onTouchEnd,!1);// Prevent Links Clicks
(i.preventClicks||i.preventClicksPropagation)&&o[u]("click",e.onClick,!0),i.cssMode&&s[u]("scroll",e.onScroll),i.updateOnWindowResize?e[t](a.ios||a.android?"resize orientationchange observerUpdate":"resize observerUpdate",N,!0):e[t]("observerUpdate",N,!0)},F=(e,t)=>e.grid&&t.grid&&t.grid.rows>1;var W={init:!0,direction:"horizontal",touchEventsTarget:"wrapper",initialSlide:0,speed:300,cssMode:!1,updateOnWindowResize:!0,resizeObserver:!0,nested:!1,createElements:!1,enabled:!0,focusableElements:"input, select, option, textarea, button, video, label",// Overrides
...
lastClickTime:A(),clickTimeout:void 0,// Velocities
...
let n=S(e||t.params.el);if(!(e=n[0]))return!1;e.swiper=t;let i=()=>`.${(t.params.wrapperClass||"").trim().split(" ").join(".")}`,r=(()=>{if(e&&e.shadowRoot&&e.shadowRoot.querySelector){let t=S(e.shadowRoot.querySelector(i()));// Children needs to return slot items
return t.children=e=>n.children(e),t}return n.children(i())})();if(0===r.length&&t.params.createElements){let e=g(),i=e.createElement("div");r=S(i),i.className=t.params.wrapperClass,n.append(i),n.children(`.${t.params.slideClass}`).each(e=>{r.append(e)})}return Object.assign(t,{$el:n,el:e,$wrapperEl:r,wrapperEl:r[0],mounted:!0,// RTL
...
this.attachEvents(),this.initialized=!0,this.emit("init"),this.emit("afterInit")),this}destroy(e=!0,t=!0){let n=this,{params:i,$el:r,$wrapperEl:o,slides:s}=n;return void 0===n.params||n.destroyed||(n.emit("beforeDestroy"),n.initialized=!1,n.detachEvents(),i.loop&&n.loopDestroy(),t&&(n.removeClasses(),r.removeAttr("style"),o.removeAttr("style"),s&&s.length&&s.removeClass([i.slideVisibleClass,i.slideActiveClass,i.slideNextClass,i.slidePrevClass].join(" ")).removeAttr("style").removeAttr("data-swiper-slide-index")),n.emit("destroy"),Object.keys(n.eventsListeners).forEach(e=>{n.off(e)}),!1!==e&&(n.$el[0].swiper=null,function(e){Object.keys(e).forEach(t=>{try{e[t]=null}catch(e){}try{delete e[t]}catch(e){}})}(n)),n.destroyed=!0),null}static extendDefaults(e){_(U,e)}static get extendedDefaults(){return U}static get defaults(){return W}static installModule(e){V.prototype.__modules__||(V.prototype.__modules__=[]);let t=V.prototype.__modules__;"function"==typeof e&&0>t.indexOf(e)&&t.push(e)}static use(e){return Array.isArray(e)?e.forEach(e=>V.installModule(e)):V.installModule(e),V}}function Y(e=""){return`.${e.trim().replace(/([\.:!\/])/g,"\\$1")// eslint-disable-line
.replace(/ /g,".")}`}function X({swiper:e,extendParams:t,on:n,emit:i}){let r;let o="swiper-pagination";t({pagination:{el:null,bulletElement:"span",clickable:!1,hideOnClick:!1,renderBullet:null,renderProgressbar:null,renderFraction:null,renderCustom:null,progressbarOpposite:!1,type:"bullets",// 'bullets' or 'progressbar' or 'fraction' or 'custom'
...
if(e.params.loop?((t=Math.ceil((e.activeIndex-e.loopedSlides)/e.params.slidesPerGroup))>c-1-2*e.loopedSlides&&(t-=c-2*e.loopedSlides),t>d-1&&(t-=d),t<0&&"bullets"!==e.params.paginationType&&(t=d+t)):t=void 0!==e.snapIndex?e.snapIndex:e.activeIndex||0,"bullets"===o.type&&e.pagination.bullets&&e.pagination.bullets.length>0){let i,a,c;let d=e.pagination.bullets;if(o.dynamicBullets&&(r=d.eq(0)[e.isHorizontal()?"outerWidth":"outerHeight"](!0),u.css(e.isHorizontal()?"width":"height",`${r*(o.dynamicMainBullets+4)}px`),o.dynamicMainBullets>1&&void 0!==e.previousIndex&&((s+=t-(e.previousIndex-e.loopedSlides||0))>o.dynamicMainBullets-1?s=o.dynamicMainBullets-1:s<0&&(s=0)),c=((a=(i=Math.max(t-s,0))+(Math.min(d.length,o.dynamicMainBullets)-1))+i)/2),d.removeClass(["","-next","-next-next","-prev","-prev-prev","-main"].map(e=>`${o.bulletActiveClass}${e}`).join(" ")),u.length>1)d.each(e=>{let n=S(e),r=n.index();r===t&&n.addClass(o.bulletActiveClass),o.dynamicBullets&&(r>=i&&r<=a&&n.addClass(`${o.bulletActiveClass}-main`),r===i&&l(n,"prev"),r===a&&l(n,"next"))});else{let n=d.eq(t),r=n.index();if(n.addClass(o.bulletActiveClass),o.dynamicBullets){let t=d.eq(i),n=d.eq(a);for(let e=i;e<=a;e+=1)d.eq(e).addClass(`${o.bulletActiveClass}-main`);if(e.params.loop){if(r>=d.length){for(let e=o.dynamicMainBullets;e>=0;e-=1)d.eq(d.length-e).addClass(`${o.bulletActiveClass}-main`);d.eq(d.length-o.dynamicMainBullets-1).addClass(`${o.bulletActiveClass}-prev`)}else l(t,"prev"),l(n,"next")}else l(t,"prev"),l(n,"next")}}if(o.dynamicBullets){let t=Math.min(d.length,o.dynamicMainBullets+4),i=(r*t-r)/2-c*r;d.css(e.isHorizontal()?n?"right":"left":"top",`${i}px`)}}if("fraction"===o.type&&(u.find(Y(o.currentClass)).text(o.formatFractionCurrent(t+1)),u.find(Y(o.totalClass)).text(o.formatFractionTotal(d))),"progressbar"===o.type){let n;n=o.progressbarOpposite?e.isHorizontal()?"vertical":"horizontal":e.isHorizontal()?"horizontal":"vertical";let i=(t+1)/d,r=1,s=1;"horizontal"===n?r=i:s=i,u.find(Y(o.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${r}) scaleY(${s})`).transition(e.params.speed)}"custom"===o.type&&o.renderCustom?(u.html(o.renderCustom(e,t+1,d)),i("paginationRender",u[0])):i("paginationUpdate",u[0]),e.params.watchOverflow&&e.enabled&&u[e.isLocked?"addClass":"removeClass"](o.lockClass)}function u(){// Render Container
let t=e.params.pagination;if(a())return;let n=e.virtual&&e.params.virtual.enabled?e.virtual.slides.length:e.slides.length,r=e.pagination.$el,o="";if("bullets"===t.type){let i=e.params.loop?Math.ceil((n-2*e.loopedSlides)/e.params.slidesPerGroup):e.snapGrid.length;e.params.freeMode&&e.params.freeMode.enabled&&!e.params.loop&&i>n&&(i=n);for(let n=0;n<i;n+=1)t.renderBullet?o+=t.renderBullet.call(e,n,t.bulletClass):o+=`<${t.bulletElement} class="${t.bulletClass}"></${t.bulletElement}>`;r.html(o),e.pagination.bullets=r.find(Y(t.bulletClass))}"fraction"===t.type&&(o=t.renderFraction?t.renderFraction.call(e,t.currentClass,t.totalClass):`<span class="${t.currentClass}"></span> / <span class="${t.totalClass}"></span>`,r.html(o)),"progressbar"===t.type&&(o=t.renderProgressbar?t.renderProgressbar.call(e,t.progressbarFillClass):`<span class="${t.progressbarFillClass}"></span>`,r.html(o)),"custom"!==t.type&&i("paginationRender",e.pagination.$el[0])}function d(){e.params.pagination=function(e,t,n,i){let r=g();return e.params.createElements&&Object.keys(i).forEach(o=>{if(!n[o]&&!0===n.auto){let s=e.$el.children(`.${i[o]}`)[0];s||((s=r.createElement("div")).className=i[o],e.$el.append(s)),n[o]=s,t[o]=s}}),n}(e,e.originalParams.pagination,e.params.pagination,{el:"swiper-pagination"});let t=e.params.pagination;if(!t.el)return;let n=S(t.el);0===n.length||(e.params.uniqueNavElements&&"string"==typeof t.el&&n.length>1&&(n=e.$el.find(t.el)).length>1&&(n=n.filter(t=>S(t).parents(".swiper")[0]===e.el)),"bullets"===t.type&&t.clickable&&n.addClass(t.clickableClass),n.addClass(t.modifierClass+t.type),n.addClass(t.modifierClass+e.params.direction),"bullets"===t.type&&t.dynamicBullets&&(n.addClass(`${t.modifierClass}${t.type}-dynamic`),s=0,t.dynamicMainBullets<1&&(t.dynamicMainBullets=1)),"progressbar"===t.type&&t.progressbarOpposite&&n.addClass(t.progressbarOppositeClass),t.clickable&&n.on("click",Y(t.bulletClass),function(t){t.preventDefault();let n=S(this).index()*e.params.slidesPerGroup;e.params.loop&&(n+=e.loopedSlides),e.slideTo(n)}),Object.assign(e.pagination,{$el:n,el:n[0]}),e.enabled||n.addClass(t.lockClass))}function p(){let t=e.params.pagination;if(a())return;let n=e.pagination.$el;n.removeClass(t.hiddenClass),n.removeClass(t.modifierClass+t.type),n.removeClass(t.modifierClass+e.params.direction),e.pagination.bullets&&e.pagination.bullets.removeClass&&e.pagination.bullets.removeClass(t.bulletActiveClass),t.clickable&&n.off("click",Y(t.bulletClass))}n("init",()=>{d(),u(),c()}),n("activeIndexChange",()=>{e.params.loop?c():void 0===e.snapIndex&&c()}),n("snapIndexChange",()=>{e.params.loop||c()}),n("slidesLengthChange",()=>{e.params.loop&&(u(),c())}),n("snapGridLengthChange",()=>{e.params.loop||(u(),c())}),n("destroy",()=>{p()}),n("enable disable",()=>{let{$el:t}=e.pagination;t&&t[e.enabled?"removeClass":"addClass"](e.params.pagination.lockClass)}),n("lock unlock",()=>{c()}),n("click",(t,n)=>{let r=n.target,{$el:o}=e.pagination;if(e.params.pagination.el&&e.params.pagination.hideOnClick&&o.length>0&&!S(r).hasClass(e.params.pagination.bulletClass)){if(e.navigation&&(e.navigation.nextEl&&r===e.navigation.nextEl||e.navigation.prevEl&&r===e.navigation.prevEl))return;let t=o.hasClass(e.params.pagination.hiddenClass);!0===t?i("paginationShow"):i("paginationHide"),o.toggleClass(e.params.pagination.hiddenClass)}}),Object.assign(e.pagination,{render:u,update:c,init:d,destroy:p})}/* eslint no-underscore-dangle: "off" *//* eslint no-use-before-define: "off" */function K({swiper:e,extendParams:t,on:n,emit:i}){let r;function o(){let t=e.slides.eq(e.activeIndex),n=e.params.autoplay.delay;t.attr("data-swiper-autoplay")&&(n=t.attr("data-swiper-autoplay")||e.params.autoplay.delay),clearTimeout(r),r=C(()=>{let t;e.params.autoplay.reverseDirection?e.params.loop?(e.loopFix(),t=e.slidePrev(e.params.speed,!0,!0),i("autoplay")):e.isBeginning?e.params.autoplay.stopOnLastSlide?a():(t=e.slideTo(e.slides.length-1,e.params.speed,!0,!0),i("autoplay")):(t=e.slidePrev(e.params.speed,!0,!0),i("autoplay")):e.params.loop?(e.loopFix(),t=e.slideNext(e.params.speed,!0,!0),i("autoplay")):e.isEnd?e.params.autoplay.stopOnLastSlide?a():(t=e.slideTo(0,e.params.speed,!0,!0),i("autoplay")):(t=e.slideNext(e.params.speed,!0,!0),i("autoplay")),e.params.cssMode&&e.autoplay.running?o():!1===t&&o()},n)}function s(){return void 0===r&&!e.autoplay.running&&(e.autoplay.running=!0,i("autoplayStart"),o(),!0)}function a(){return!!e.autoplay.running&&void 0!==r&&(r&&(clearTimeout(r),r=void 0),e.autoplay.running=!1,i("autoplayStop"),!0)}function l(t){e.autoplay.running&&(e.autoplay.paused||(r&&clearTimeout(r),e.autoplay.paused=!0,0!==t&&e.params.autoplay.waitForTransition?["transitionend","webkitTransitionEnd"].forEach(t=>{e.$wrapperEl[0].addEventListener(t,u)}):(e.autoplay.paused=!1,o())))}function c(){let t=g();"hidden"===t.visibilityState&&e.autoplay.running&&l(),"visible"===t.visibilityState&&e.autoplay.paused&&(o(),e.autoplay.paused=!1)}function u(t){e&&!e.destroyed&&e.$wrapperEl&&t.target===e.$wrapperEl[0]&&(["transitionend","webkitTransitionEnd"].forEach(t=>{e.$wrapperEl[0].removeEventListener(t,u)}),e.autoplay.paused=!1,e.autoplay.running?o():a())}function d(){e.params.autoplay.disableOnInteraction?a():l(),["transitionend","webkitTransitionEnd"].forEach(t=>{e.$wrapperEl[0].removeEventListener(t,u)})}function p(){e.params.autoplay.disableOnInteraction||(e.autoplay.paused=!1,o())}e.autoplay={running:!1,paused:!1},t({autoplay:{enabled:!1,delay:3e3,waitForTransition:!0,disableOnInteraction:!0,stopOnLastSlide:!1,reverseDirection:!1,pauseOnMouseEnter:!1}}),n("init",()=>{if(e.params.autoplay.enabled){s();let t=g();t.addEventListener("visibilitychange",c),e.params.autoplay.pauseOnMouseEnter&&(e.$el.on("mouseenter",d),e.$el.on("mouseleave",p))}}),n("beforeTransitionStart",(t,n,i)=>{e.autoplay.running&&(i||!e.params.autoplay.disableOnInteraction?e.autoplay.pause(n):a())}),n("sliderFirstMove",()=>{e.autoplay.running&&(e.params.autoplay.disableOnInteraction?a():l())}),n("touchEnd",()=>{e.params.cssMode&&e.autoplay.paused&&!e.params.autoplay.disableOnInteraction&&o()}),n("destroy",()=>{e.$el.off("mouseenter",d),e.$el.off("mouseleave",p),e.autoplay.running&&a();let t=g();t.removeEventListener("visibilitychange",c)}),Object.assign(e.autoplay,{pause:l,run:o,start:s,stop:a})}function Q(e){let{effect:t,swiper:n,on:i,setTranslate:r,setTransition:o,overwriteParams:s,perspective:a}=e;i("beforeInit",()=>{if(n.params.effect!==t)return;n.classNames.push(`${n.params.containerModifierClass}${t}`),a&&a()&&n.classNames.push(`${n.params.containerModifierClass}3d`);let e=s?s():{};Object.assign(n.params,e),Object.assign(n.originalParams,e)}),i("setTranslate",()=>{n.params.effect===t&&r()}),i("setTransition",(e,i)=>{n.params.effect===t&&o(i)})}function Z(e,t){return e.transformEl?t.find(e.transformEl).css({"backface-visibility":"hidden","-webkit-backface-visibility":"hidden"}):t}function J({swiper:e,duration:t,transformEl:n,allSlides:i}){let{slides:r,activeIndex:o,$wrapperEl:s}=e;if(e.params.virtualTranslate&&0!==t){let t=!1;(i?n?r.find(n):r:n?r.eq(o).find(n):r.eq(o)).transitionEnd(()=>{if(t||!e||e.destroyed)return;t=!0,e.animating=!1;let n=["webkitTransitionEnd","transitionend"];for(let e=0;e<n.length;e+=1)s.trigger(n[e])})}}function ee({swiper:e,extendParams:t,on:n}){t({fadeEffect:{crossFade:!1,transformEl:null}}),Q({effect:"fade",swiper:e,on:n,setTranslate:()=>{let{slides:t}=e,n=e.params.fadeEffect;for(let i=0;i<t.length;i+=1){let t=e.slides.eq(i),r=t[0].swiperSlideOffset,o=-r;e.params.virtualTranslate||(o-=e.translate);let s=0;e.isHorizontal()||(s=o,o=0);let a=e.params.fadeEffect.crossFade?Math.max(1-Math.abs(t[0].progress),0):1+Math.min(Math.max(t[0].progress,-1),0),l=Z(n,t);l.css({opacity:a}).transform(`translate3d(${o}px, ${s}px, 0px)`)}},setTransition:t=>{let{transformEl:n}=e.params.fadeEffect,i=n?e.slides.find(n):e.slides;i.transition(t),J({swiper:e,duration:t,transformEl:n,allSlides:!0})},overwriteParams:()=>({slidesPerView:1,slidesPerGroup:1,watchSlidesProgress:!0,spaceBetween:0,virtualTranslate:!e.params.cssMode})})}function et({swiper:e,extendParams:t,on:n}){t({creativeEffect:{transformEl:null,limitProgress:1,shadowPerProgress:!1,progressMultiplier:1,perspective:!0,prev:{translate:[0,0,0],rotate:[0,0,0],opacity:1,scale:1},next:{translate:[0,0,0],rotate:[0,0,0],opacity:1,scale:1}}});let i=e=>"string"==typeof e?e:`${e}px`;Q({effect:"creative",swiper:e,on:n,setTranslate:()=>{let{slides:t,$wrapperEl:n,slidesSizesGrid:r}=e,o=e.params.creativeEffect,{progressMultiplier:s}=o,a=e.params.centeredSlides;if(a){let t=r[0]/2-e.params.slidesOffsetBefore||0;n.transform(`translateX(calc(50% - ${t}px))`)}for(let n=0;n<t.length;n+=1){let r=t.eq(n),l=r[0].progress,c=Math.min(Math.max(r[0].progress,-o.limitProgress),o.limitProgress),u=c;a||(u=Math.min(Math.max(r[0].originalProgress,-o.limitProgress),o.limitProgress));let d=r[0].swiperSlideOffset,p=[e.params.cssMode?-d-e.translate:-d,0,0],h=[0,0,0],f=!1;e.isHorizontal()||(p[1]=p[0],p[0]=0);let g={translate:[0,0,0],rotate:[0,0,0],scale:1,opacity:1};c<0?(g=o.next,f=!0):c>0&&(g=o.prev,f=!0),p.forEach((e,t)=>{p[t]=`calc(${e}px + (${i(g.translate[t])} * ${Math.abs(c*s)}))`}),h.forEach((e,t)=>{h[t]=g.rotate[t]*Math.abs(c*s)}),r[0].style.zIndex=-Math.abs(Math.round(l))+t.length;let m=p.join(", "),v=`rotateX(${h[0]}deg) rotateY(${h[1]}deg) rotateZ(${h[2]}deg)`,y=u<0?`scale(${1+(1-g.scale)*u*s})`:`scale(${1-(1-g.scale)*u*s})`,b=u<0?1+(1-g.opacity)*u*s:1-(1-g.opacity)*u*s,w=`translate3d(${m}) ${v} ${y}`;if(f&&g.shadow||!f){let e=r.children(".swiper-slide-shadow");if(0===e.length&&g.shadow&&(e=function(e,t,n){let i=`swiper-slide-shadow${n?`-${n}`:""}`,r=e.transformEl?t.find(e.transformEl):t,o=r.children(`.${i}`);return o.length||(o=S(`<div class="swiper-slide-shadow${n?`-${n}`:""}"></div>`),r.append(o)),o}(o,r)),e.length){let t=o.shadowPerProgress?c*(1/o.limitProgress):c;e[0].style.opacity=Math.min(Math.max(Math.abs(t),0),1)}}let x=Z(o,r);x.transform(w).css({opacity:b}),g.origin&&x.css("transform-origin",g.origin)}},setTransition:t=>{let{transformEl:n}=e.params.creativeEffect,i=n?e.slides.find(n):e.slides;i.transition(t).find(".swiper-slide-shadow").transition(t),J({swiper:e,duration:t,transformEl:n,allSlides:!0})},perspective:()=>e.params.creativeEffect.perspective,overwriteParams:()=>({watchSlidesProgress:!0,virtualTranslate:!e.params.cssMode})})}Object.keys(G).forEach(e=>{Object.keys(G[e]).forEach(t=>{V.prototype[t]=G[e][t]})}),V.use([function({swiper:e,on:t,emit:n}){let i=v(),r=null,o=()=>{e&&!e.destroyed&&e.initialized&&(n("beforeResize"),n("resize"))},s=()=>{e&&!e.destroyed&&e.initialized&&(r=new ResizeObserver(t=>{let{width:n,height:i}=e,r=n,s=i;t.forEach(({contentBoxSize:t,contentRect:n,target:i})=>{i&&i!==e.el||(r=n?n.width:(t[0]||t).inlineSize,s=n?n.height:(t[0]||t).blockSize)}),(r!==n||s!==i)&&o()})).observe(e.el)},a=()=>{r&&r.unobserve&&e.el&&(r.unobserve(e.el),r=null)},l=()=>{e&&!e.destroyed&&e.initialized&&n("orientationchange")};t("init",()=>{if(e.params.resizeObserver&&void 0!==i.ResizeObserver){s();return}i.addEventListener("resize",o),i.addEventListener("orientationchange",l)}),t("destroy",()=>{a(),i.removeEventListener("resize",o),i.removeEventListener("orientationchange",l)})},function({swiper:e,extendParams:t,on:n,emit:i}){let r=[],o=v(),s=(e,t={})=>{let n=o.MutationObserver||o.WebkitMutationObserver,s=new n(e=>{// The observerUpdate event should only be triggered
...
s(e.$el[0],{childList:e.params.observeSlideChildren}),s(e.$wrapperEl[0],{attributes:!1})}}),n("destroy",()=>{r.forEach(e=>{e.disconnect()}),r.splice(0,r.length)})}]);var en=l("6KOho");window.$=window.jQuery=/*@__PURE__*/i(en);var en=l("6KOho"),ei={};r=function(e){// This is needed so we can catch the AMD loader configuration and use it
...
return{errorLoading:function(){return"The results could not be loaded."},inputTooLong:function(e){var t=e.input.length-e.maximum,n="Please delete "+t+" character";return 1!=t&&(n+="s"),n},inputTooShort:function(e){return"Please enter "+(e.minimum-e.input.length)+" or more characters"},loadingMore:function(){return"Loading more results…"},maximumSelected:function(e){var t="You can only select "+e.maximum+" item";return 1!=e.maximum&&(t+="s"),t},noResults:function(){return"No results found"},searching:function(){return"Searching…"},removeAllItems:function(){return"Remove all items"},removeItem:function(){return"Remove item"},search:function(){return"Search"}}}),t.define("select2/defaults",["jquery","./results","./selection/single","./selection/multiple","./selection/placeholder","./selection/allowClear","./selection/search","./selection/selectionCss","./selection/eventRelay","./utils","./translation","./diacritics","./data/select","./data/array","./data/ajax","./data/tags","./data/tokenizer","./data/minimumInputLength","./data/maximumInputLength","./data/maximumSelectionLength","./dropdown","./dropdown/search","./dropdown/hidePlaceholder","./dropdown/infiniteScroll","./dropdown/attachBody","./dropdown/minimumResultsForSearch","./dropdown/selectOnClose","./dropdown/closeOnSelect","./dropdown/dropdownCss","./dropdown/tagsSearchHighlight","./i18n/en"],function(e,t,n,i,r,o,s,a,l,c,u,d,p,h,f,g,m,v,y,b,w,S,x,T,E,C,A,L,_,k,O){function D(){this.reset()}return D.prototype.apply=function(u){if(null==(u=e.extend(!0,{},this.defaults,u)).dataAdapter&&(null!=u.ajax?u.dataAdapter=f:null!=u.data?u.dataAdapter=h:u.dataAdapter=p,u.minimumInputLength>0&&(u.dataAdapter=c.Decorate(u.dataAdapter,v)),u.maximumInputLength>0&&(u.dataAdapter=c.Decorate(u.dataAdapter,y)),u.maximumSelectionLength>0&&(u.dataAdapter=c.Decorate(u.dataAdapter,b)),u.tags&&(u.dataAdapter=c.Decorate(u.dataAdapter,g)),(null!=u.tokenSeparators||null!=u.tokenizer)&&(u.dataAdapter=c.Decorate(u.dataAdapter,m))),null==u.resultsAdapter&&(u.resultsAdapter=t,null!=u.ajax&&(u.resultsAdapter=c.Decorate(u.resultsAdapter,T)),null!=u.placeholder&&(u.resultsAdapter=c.Decorate(u.resultsAdapter,x)),u.selectOnClose&&(u.resultsAdapter=c.Decorate(u.resultsAdapter,A)),u.tags&&(u.resultsAdapter=c.Decorate(u.resultsAdapter,k))),null==u.dropdownAdapter){if(u.multiple)u.dropdownAdapter=w;else{var d=c.Decorate(w,S);u.dropdownAdapter=d}0!==u.minimumResultsForSearch&&(u.dropdownAdapter=c.Decorate(u.dropdownAdapter,C)),u.closeOnSelect&&(u.dropdownAdapter=c.Decorate(u.dropdownAdapter,L)),null!=u.dropdownCssClass&&(u.dropdownAdapter=c.Decorate(u.dropdownAdapter,_)),u.dropdownAdapter=c.Decorate(u.dropdownAdapter,E)}null==u.selectionAdapter&&(u.multiple?u.selectionAdapter=i:u.selectionAdapter=n,null!=u.placeholder&&(u.selectionAdapter=c.Decorate(u.selectionAdapter,r)),u.allowClear&&(u.selectionAdapter=c.Decorate(u.selectionAdapter,o)),u.multiple&&(u.selectionAdapter=c.Decorate(u.selectionAdapter,s)),null!=u.selectionCssClass&&(u.selectionAdapter=c.Decorate(u.selectionAdapter,a)),u.selectionAdapter=c.Decorate(u.selectionAdapter,l)),// If the defaults were not previously applied from an element, it is
// possible for the language option to have not been resolved
u.language=this._resolveLanguage(u.language),// Always fall back to English since it will always be complete
u.language.push("en");for(var O=[],D=0;D<u.language.length;D++){var M=u.language[D];-1===O.indexOf(M)&&O.push(M)}return u.language=O,u.translations=this._processTranslations(u.language,u.debug),u},D.prototype.reset=function(){function t(e){return e.replace(/[^\u0000-\u007E]/g,// Used 'uni range + named function' from http://jsperf.com/diacritics/18
...
a.indexOf(l)>-1?r:null)},minimumInputLength:0,maximumInputLength:0,maximumSelectionLength:0,minimumResultsForSearch:0,selectOnClose:!1,scrollAfterSelect:!1,sorter:function(e){return e},templateResult:function(e){return e.text},templateSelection:function(e){return e.text},theme:"default",width:"resolve"}},D.prototype.applyFromElement=function(e,t){var n=e.language,i=this.defaults.language,r=t.prop("lang"),o=t.closest("[lang]").prop("lang"),s=Array.prototype.concat.call(this._resolveLanguage(r),this._resolveLanguage(n),this._resolveLanguage(i),this._resolveLanguage(o));return e.language=s,e},D.prototype._resolveLanguage=function(t){if(!t||e.isEmptyObject(t))return[];if(e.isPlainObject(t))return[t];n=Array.isArray(t)?t:[t];for(var n,i=[],r=0;r<n.length;r++)if(i.push(n[r]),"string"==typeof n[r]&&n[r].indexOf("-")>0){var o=n[r].split("-")[0];i.push(o)}return i},D.prototype._processTranslations=function(t,n){for(var i=new u,r=0;r<t.length;r++){var o=new u,s=t[r];if("string"==typeof s)try{// Try to load it with the original name
...
e.fn.select2.amd=t,n)},"function"==typeof define&&define.amd?define(["jquery"],r):ei?ei=function(e,t){return void 0===t&&(t="undefined"!=typeof window?l("6KOho"):l("6KOho")(e)),r(t),t}:r(jQuery),/*@__PURE__*/i(ei)(/*@__PURE__*/i(en)),window.$=window.jQuery=/*@__PURE__*/i(en),window.addEventListener("load",function(){(function(){document.querySelector(".deliverySlides")&&new V(".deliverySlides",{modules:[K,X,ee,et],loop:!0,centeredSlides:!0,effect:"creative",pagination:{el:".paginationBeliverySlides",clickable:!0},creativeEffect:{limitProgress:2,prev:{translate:["-100%",-60,-60]},next:{translate:["100%",-60,-60]}},breakpoints:{641:{slidesPerView:1.5,spaceBetween:10,creativeEffect:{limitProgress:2,prev:{translate:["-90%",-40,-40]},next:{translate:["90%",-40,-40]}}},769:{spaceBetween:40,slidesPerView:2,creativeEffect:{limitProgress:2,prev:{translate:["-90%",-40,-40]},next:{translate:["90%",-40,-40]}}}}}),document.querySelector(".aboutSlides")&&new V(".aboutSlides",{modules:[K,X,ee,et],slidesPerView:1,loop:!0,pagination:{el:".aboutSlides__pagination",clickable:!0},breakpoints:{481:{direction:"vertical"}}});let e=new V(".geographySlider",{modules:[K,X,ee,et],effect:"fade",loop:!0,observer:!0,autoplay:{delay:5e3,disableOnInteraction:!1},pagination:{el:".geographySlider__pagination",bulletClass:"swiper-pagination-bullet-custom",bulletActiveClass:"swiper-pagination-bullet-custom--active",renderBullet:function(e,t){return`<div class="${t}" data-index="${e}">
          ...
          </div>`},clickable:!0},on:{init:function(){this.el.style.setProperty("--delay",this.params.autoplay.delay),document.querySelectorAll(".swiper-pagination-bullet-custom line").forEach(e=>{e.setAttribute("x2","0")}),document.querySelector(".swiper-pagination-bullet-custom.swiper-pagination-bullet-custom--active line")?.setAttribute("x2","80");// _self.el.addEventListener('mouseenter', function() {
...
// });
},slideChange:function(){document.querySelectorAll(".swiper-pagination-bullet-custom line").forEach(e=>{e.setAttribute("x2","0")}),document.querySelector(".swiper-pagination-bullet-custom.swiper-pagination-bullet-custom--active line")?.setAttribute("x2","80")}}}),t=document.querySelector(".header");window.innerWidth>1366&&/*@__PURE__*/i(d)("#fullpage",{navigation:!1,onLeave:function(n,i,r,o,s){!0==i.isLast?t.classList.add("close"):document.querySelector(".header.close")&&t.classList.remove("close"),document.querySelector(".fp-viewing-1")&&document.querySelector(".geographySlider")&&e.slideToLoop(0,0),document.querySelector(".fp-viewing-3")&&document.querySelector(".geographySlider")&&e.slideToLoop(0,0)}})})(),document.querySelectorAll('a[href^="#"]').forEach(e=>{e.addEventListener("click",function(e){e.preventDefault(),document.querySelector(this.getAttribute("href")).scrollIntoView({behavior:"smooth"})})}),new c,new u;var e,t,n=document.querySelector(".containerMin");let r=document.querySelectorAll(".geographySlider__box"),o=document.querySelectorAll(".geographySlider__nav");function s(e){if(!e.id)return e.text;var t=/*@__PURE__*/i(en)(e.element).data("image");return /*@__PURE__*/i(en)('<img src="'+t+'" class="w-[24px] h-[24px] mr-[8px] object-contain pointer-events-none" /> <div class="leading-7 text-left pointer-events-none">'+e.text+"</div>")}n&&(e=n.getBoundingClientRect(),t=window.innerWidth>768?e.left+50:window.innerWidth>375?e.left+30:e.left+12),r?.forEach(function(e){e.style.left=""+t+"px"}),o?.forEach(function(e){e.style.left=""+t+"px"}),window.innerWidth<=992&&(r?.forEach(function(e){e.style.right=""+t+"px"}),o?.forEach(function(e){e.style.right=""+t+"px"})),window.addEventListener("resize",function(){r?.forEach(function(e){e.style.left=""+t+"px"}),o?.forEach(function(e){e.style.left=""+t+"px"}),window.innerWidth<=992&&(r?.forEach(function(e){e.style.right=""+t+"px"}),o?.forEach(function(e){e.style.right=""+t+"px"}))}),window.innerWidth<640&&(/*@__PURE__*/i(en)(".select").select2({minimumResultsForSearch:1/0,templateResult:s,templateSelection:s}),/*@__PURE__*/i(en)(".select").on("select2:select",function(e){let t=e.target.value;console.log(t),document.querySelectorAll(".tab-content").forEach(function(e){e.getAttribute("id")==t&&(document.querySelector(".tab-content.current").classList.remove("current"),e.classList.add("current"))})})),"Главная"==document.title?(/*@__PURE__*/i(en)("#index").addClass("active"),/*@__PURE__*/i(en)("#indexFooter").addClass("active"),/*@__PURE__*/i(en)("#indexMobile").addClass("active")):"О компании"==document.title&&(/*@__PURE__*/i(en)("#about").addClass("active"),/*@__PURE__*/i(en)("#aboutFooter").addClass("active"),/*@__PURE__*/i(en)("#aboutMobile").addClass("active"))});//# sourceMappingURL=about.3cbb2e3a.js.map

//# sourceMappingURL=about.3cbb2e3a.js.map
